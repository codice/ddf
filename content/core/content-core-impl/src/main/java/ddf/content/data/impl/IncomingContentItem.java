...
public class IncomingContentItem implements ContentItem
{
     ...
     * initially be <code>null</code> because the {@link ContentFramework} will
     * assign its GUID.
     * 
    ...
    public IncomingContentItem( String id, InputStream stream, String mimeTypeRawData, String filename )
    {
