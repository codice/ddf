...
public class CreateResponseImpl extends ResponseImpl<CreateRequest> implements CreateResponse
{
    ...
    /**
     * Instantiates a CreateResponseImpl object with {@link CreateResponse} object.
     ...
     * 
     * @param request the original {@link CreateRequest} that initiated this response
     * @param contentItem the {@link ContentItem} created
     */
    ...
    /**
     * Instantiates a CreateResponseImpl object with {@link ContentItem} created and
     ...
     */
    public CreateResponseImpl( CreateRequest request, ContentItem contentItem, Map<String,String> responseProperties )
    {
     ...
     */
    public CreateResponseImpl( CreateRequest request, ContentItem contentItem, Map<String,String> responseProperties, Map<String,Serializable> properties )
    {
