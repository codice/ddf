...
public class MockMetacardType extends MetacardTypeImpl {
    ...
    public MockMetacardType() {
        ...
        descriptors
                .add(new AttributeDescriptorImpl(AttributeFormat.DATE.toString(), true, true, false,
        ...
        descriptors.add(new AttributeDescriptorImpl(AttributeFormat.GEOMETRY.toString(), true, true,
                false, true, BasicTypes.GEO_TYPE));
        descriptors.add(new AttributeDescriptorImpl(AttributeFormat.INTEGER.toString(), true, true,
                false, true, BasicTypes.INTEGER_TYPE));
        descriptors
                .add(new AttributeDescriptorImpl(AttributeFormat.LONG.toString(), true, true, false,
        ...
        descriptors
                .add(new AttributeDescriptorImpl(AttributeFormat.XML.toString(), true, true, false,
                        true, BasicTypes.XML_TYPE));
