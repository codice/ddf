...
public class TestKmlStyleMap {
    ...
    public void testGetStyleForMetacardStringAttribute() {
        ...
        mapper.addMapEntry(new KmlStyleMapEntryImpl(Metacard.CONTENT_TYPE,
                MockMetacard.DEFAULT_TYPE, DEFAULT_STYLE_URL));
    ...
    public void testGetStyleForMetacardBooleanAttribute() {
        ...
        KmlStyleMap mapper = new KmlStyleMap();
        mapper.addMapEntry(new KmlStyleMapEntryImpl(AttributeFormat.BOOLEAN.toString(), String
                .valueOf(true), DEFAULT_STYLE_URL));
        assertThat(mapper.getStyleForMetacard(metacard), is(DEFAULT_STYLE_URL));
    }
    ...
    public void testGetStyleForMetacardXmlAttribute() {
        ...
        mapper.addMapEntry(new KmlStyleMapEntryImpl(Metacard.METADATA,
                MockMetacard.DEFAULT_METADATA, DEFAULT_STYLE_URL));
        assertThat(mapper.getStyleForMetacard(metacard), is(DEFAULT_STYLE_URL));
    }
    ...
    public void testGetStyleForMetacardShortAttribute() {
        ...
        KmlStyleMap mapper = new KmlStyleMap();
        mapper.addMapEntry(new KmlStyleMapEntryImpl(AttributeFormat.SHORT.toString(), String
                .valueOf(testShort), DEFAULT_STYLE_URL));
        assertThat(mapper.getStyleForMetacard(metacard), is(DEFAULT_STYLE_URL));
    }
    ...
    public void testGetStyleForMetacardIntegerAttribute() {
        ...
        KmlStyleMap mapper = new KmlStyleMap();
        mapper.addMapEntry(new KmlStyleMapEntryImpl(AttributeFormat.INTEGER.toString(), String
                .valueOf(testInteger), DEFAULT_STYLE_URL));
        assertThat(mapper.getStyleForMetacard(metacard), is(DEFAULT_STYLE_URL));
    }
    ...
    public void testGetStyleForMetacardLongAttribute() {
        ...
        KmlStyleMap mapper = new KmlStyleMap();
        mapper.addMapEntry(new KmlStyleMapEntryImpl(AttributeFormat.LONG.toString(), String
                .valueOf(testLong), DEFAULT_STYLE_URL));
        assertThat(mapper.getStyleForMetacard(metacard), is(DEFAULT_STYLE_URL));
    }
    ...
    public void testGetStyleForMetacardFloatAttribute() {
        ...
        KmlStyleMap mapper = new KmlStyleMap();
        mapper.addMapEntry(new KmlStyleMapEntryImpl(AttributeFormat.FLOAT.toString(), String
                .valueOf(testFloat), DEFAULT_STYLE_URL));
        assertThat(mapper.getStyleForMetacard(metacard), is(DEFAULT_STYLE_URL));
    }
    ...
    public void testGetStyleForMetacardDoubleAttribute() {
        ...
        KmlStyleMap mapper = new KmlStyleMap();
        mapper.addMapEntry(new KmlStyleMapEntryImpl(AttributeFormat.DOUBLE.toString(), String
                .valueOf(testDouble), DEFAULT_STYLE_URL));
        assertThat(mapper.getStyleForMetacard(metacard), is(DEFAULT_STYLE_URL));
    }
    ...
    public void testGetStyleForMetacardBySourceId() {
        ...
        mapper.addMapEntry(new KmlStyleMapEntryImpl(Metacard.SOURCE_ID,
                MockMetacard.DEFAULT_SOURCE_ID, DEFAULT_STYLE_URL));
        assertThat(mapper.getStyleForMetacard(metacard), is(DEFAULT_STYLE_URL));
    }
