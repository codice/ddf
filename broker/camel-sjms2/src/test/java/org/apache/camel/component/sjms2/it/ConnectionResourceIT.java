 ...
 */
package org.apache.camel.component.sjms2.it;
...
public class ConnectionResourceIT extends JmsTestSupport {
    ...
    /**
     * Test method for
     * {@link org.apache.commons.pool.ObjectPool#returnObject(Object)}
     * .
     *
     * @throws Exception
     */
    ...
    public void testCreateConnections() throws Exception {
        ...
        Assert.assertNotNull(connection.createSession(false, Session.AUTO_ACKNOWLEDGE));
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                ...
                from("seda:start").to(
                        "sjms:queue:in.foo?namedReplyTo=out.bar&exchangePattern=InOut&producerCount=5")
                        .to("mock:result");

                from("sjms:queue:in.foo?exchangePattern=InOut&consumerCount=20").log(
                        "Using ${threadName} to process ${body}")
