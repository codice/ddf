 ...
 */
package org.apache.camel.component.sjms2.bugfixes;
...
public class CAMEL6820Test extends JmsTestSupport {
    ...
    public void testCamelGenericFileConverterMessage() throws Exception {
        ...
        // Make sure the Sjms2Component is available
    ...
    protected RouteBuilder createRouteBuilder() throws Exception {
        return new RouteBuilder() {
            ...
            public void configure() throws Exception {
                from(FILE_INPUT_URI).convertBodyTo(InputStream.class)
                        .to(SJMS_QUEUE_URI);

                from(SJMS_QUEUE_URI).convertBodyTo(String.class)
                        .to(MOCK_RESULT_URI);
            }
        };
    }
