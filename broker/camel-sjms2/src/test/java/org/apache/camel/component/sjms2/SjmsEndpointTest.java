...
public class SjmsEndpointTest extends CamelTestSupport {
    ...
    public void testDefaults() throws Exception {
        ...
        Assert.assertEquals(sjms.getEndpointUri(), "sjms://test");
    ...
    public void testQueueEndpoint() throws Exception {
        ...
        Assert.assertEquals(sjms.getEndpointUri(), "sjms://queue:test");
        Assert.assertTrue(sjms instanceof Sjms2Endpoint);
    }

    @Test
    public void testJndiStyleEndpointName() throws Exception {
        Sjms2Endpoint sjms = context.getEndpoint("sjms:/jms/test/hov.t1.dev:topic",
                Sjms2Endpoint.class);
        Assert.assertNotNull(sjms);
        Assert.assertFalse(sjms.isTopic());
        Assert.assertEquals("/jms/test/hov.t1.dev:topic", sjms.getDestinationName());
    }
    ...
    public void testSetTransacted() throws Exception {
        ...
        Assert.assertTrue(qe.isTransacted());
    }
    ...
    public void testAsyncProducer() throws Exception {
        ...
        Assert.assertTrue(endpoint instanceof Sjms2Endpoint);
        Sjms2Endpoint qe = (Sjms2Endpoint) endpoint;
        Assert.assertTrue(qe.isSynchronous());
    }
    ...
    public void testNamedReplyTo() throws Exception {
        ...
        Assert.assertTrue(endpoint instanceof Sjms2Endpoint);
        Sjms2Endpoint qe = (Sjms2Endpoint) endpoint;
        Assert.assertEquals(qe.getNamedReplyTo(), namedReplyTo);
        Assert.assertEquals(qe.createExchange()
    ...
    public void testDefaultExchangePattern() throws Exception {
        try {
            Sjms2Endpoint sjms = (Sjms2Endpoint) context.getEndpoint("sjms:queue:test");
            Assert.assertNotNull(sjms);
            Assert.assertEquals(ExchangePattern.InOnly, sjms.getExchangePattern());
    ...
    public void testInOnlyExchangePattern() throws Exception {
        try {
            Endpoint sjms = context.getEndpoint(
                    "sjms:queue:test?exchangePattern=" + ExchangePattern.InOnly);
            Assert.assertNotNull(sjms);
            Assert.assertTrue(sjms.createExchange()
                    .getPattern()
    ...
    public void testInOutExchangePattern() throws Exception {
        try {
            Endpoint sjms = context.getEndpoint(
                    "sjms:queue:test?exchangePattern=" + ExchangePattern.InOut);
            Assert.assertNotNull(sjms);
            Assert.assertTrue(sjms.createExchange()
                    .getPattern()
                    .equals(ExchangePattern.InOut));
        } catch (Exception e) {
            Assert.fail("Exception thrown: " + e.getLocalizedMessage());
        }
    }
    ...
    public void testNamedReplyToAndMEPMatch() throws Exception {
        ...
        Endpoint endpoint = context.getEndpoint(
                "sjms:queue:test?namedReplyTo=" + namedReplyTo + "&exchangePattern="
    ...
    public void testNamedReplyToAndMEPMismatch() throws Exception {
        context.getEndpoint("sjms:queue:test?namedReplyTo=reply.to.queue&exchangePattern="
    ...
    public void testTransactedBatchCountDefault() throws Exception {
        ...
        Assert.assertTrue(endpoint instanceof Sjms2Endpoint);
        Sjms2Endpoint qe = (Sjms2Endpoint) endpoint;
        Assert.assertTrue(qe.getTransactionBatchCount() == -1);
    }

    @Test
    public void testTransactedBatchCountModified() throws Exception {
        Endpoint endpoint = context.getEndpoint(
                "sjms:queue:test?transacted=true&transactionBatchCount=10");
        Assert.assertNotNull(endpoint);
        Assert.assertTrue(endpoint instanceof Sjms2Endpoint);
        Sjms2Endpoint qe = (Sjms2Endpoint) endpoint;
        Assert.assertTrue(qe.getTransactionBatchCount() == 10);
    }
    ...
    public void testTransactedBatchTimeoutDefault() throws Exception {
        ...
        Assert.assertTrue(endpoint instanceof Sjms2Endpoint);
        Sjms2Endpoint qe = (Sjms2Endpoint) endpoint;
        Assert.assertTrue(qe.getTransactionBatchTimeout() == 5000);
    }

    @Test
    public void testTransactedBatchTimeoutModified() throws Exception {
        Endpoint endpoint = context.getEndpoint(
                "sjms:queue:test?transacted=true&transactionBatchTimeout=3000");
        Assert.assertNotNull(endpoint);
        Assert.assertTrue(endpoint instanceof Sjms2Endpoint);
        Sjms2Endpoint qe = (Sjms2Endpoint) endpoint;
        Assert.assertTrue(qe.getTransactionBatchTimeout() == 3000);
    }
