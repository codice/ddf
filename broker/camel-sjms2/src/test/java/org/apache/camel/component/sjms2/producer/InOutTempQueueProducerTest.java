...
public class InOutTempQueueProducerTest extends JmsTestSupport {
    ...
    public void testInOutQueueProducer() throws Exception {
        ...
        Object responseObject = template.requestBody(
                "sjms:queue:" + queueName + "?exchangePattern=InOut", requestText);
    ...
    public void testInOutQueueProducerWithCorrelationId() throws Exception {
        ...
        String correlationId = UUID.randomUUID()
                .toString()
                .replace("-", "");
        Exchange exchange = template.request("sjms:queue:" + queueName + "?exchangePattern=InOut",
                new Processor() {
