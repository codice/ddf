...
public class Jms2TestSupport extends CamelTestSupport {
    ...
    protected void doPreSetup() throws Exception {
        ...
        TestSupport.deleteDirectory("target/data");
    ...
    protected void configureBroker(EmbeddedJMS broker) throws Exception {
        Configuration configuration = new ConfigurationImpl().setPersistenceEnabled(false)
                ...
                .addAcceptorConfiguration("connector",
                        brokerUri + "?protocols=CORE,AMQP,HORNETQ,OPENWIRE")
        ...
        ConnectionFactoryConfiguration cfConfig = new ConnectionFactoryConfigurationImpl().setName(
                "cf")
        ...
        JMSQueueConfiguration queueConfig = new JMSQueueConfigurationImpl().setName("queue1")
                .setDurable(false)
    ...
    protected ConnectionFactory getConnectionFactory() throws Exception {
        String protocol = System.getProperty("protocol", "CORE")
                .toUpperCase();
    ...
    public QueueQueryResult getQueueQueryResult(String queueQuery) throws Exception {
        return broker.getActiveMQServer()
                .queueQuery(new SimpleString(queueQuery));
    }
