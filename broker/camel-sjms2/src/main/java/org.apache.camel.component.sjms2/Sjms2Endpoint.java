...
import org.apache.camel.component.sjms2.producer.InOnlyProducer;
import org.apache.camel.component.sjms2.producer.InOutProducer;
 ...
 */
@UriEndpoint(scheme = "sjms2", title = "Simple JMS", syntax = "sjms:destinationType:destinationName", consumerClass = Sjms2Consumer.class, label = "messaging")
public class Sjms2Endpoint extends DefaultEndpoint
    ...
    private DestinationCreationStrategy destinationCreationStrategy =
            new DefaultDestinationCreationStrategy();
    ...
    public Consumer createConsumer(Processor processor) throws Exception {
        Sjms2Consumer answer = new Sjms2Consumer(this, processor);
    ...
    /**
     * Creates the {@link JmsBinding} to use.
     */
    protected JmsBinding createBinding() {
        return new JmsBinding(isMapJmsMessage(),
                isAllowNullBody(),
    ...
    public void setConnectionResource(String connectionResource) {
        this.connectionResource = EndpointHelper.resolveReferenceParameter(getCamelContext(),
                connectionResource,
    ...
    public String getDurableSubscriptionId() {
        return durableSubscriptionId == null ? subscriptionId : durableSubscriptionId;
    }

    /**
     * Sets the durable subscription Id required for durable topics.
     *
     * @deprecated use {@link Sjms2Endpoint#setSubscriptionId(String)}
     */
    @Deprecated
    ...
    public String getSubscriptionId() {
        return subscriptionId == null ? durableSubscriptionId : subscriptionId;
    }

    /**
     * Sets the subscription Id required for durable topics.
     */
    ...
    public void setConnectionFactory(String connectionFactory) {
        this.connectionFactory = EndpointHelper.resolveReferenceParameter(getCamelContext(),
                connectionFactory,
