 ...
 */
public class InOnlyProducer extends Sjms2Producer {
    ...
    public MessageProducerResources doCreateProducerModel() throws Exception {
        ...
        try {
            ...
            if (isEndpointTransacted()) {
                commitStrategy = getCommitStrategy() == null ?
        ...
        try {
            ...
            if (exchange.getIn()
                ...
                if (exchange.getIn()
                    ...
                    Message message = getEndpoint().getBinding()
