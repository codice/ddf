...
public class UndeliveredMessagesTest {
    ...
    private CompositeData[] createCompositeData(Object itemValue) throws OpenDataException {
        ...
        CompositeType compositeType = new CompositeType("typeName",
                "description",
                keys,
    ...
    private void validateCompositeData(List<CompositeData> undeliveredMessages) {
        ...
        assertThat(undeliveredMessages.get(0)
                .getCompositeType(), is(notNullValue()));
        assertThat(undeliveredMessages.get(0)
                .getCompositeType()
                .containsKey("itemName"), is(true));
        assertThat(undeliveredMessages.get(0)
                .getCompositeType()
                .containsKey("body"), is(true));
        assertThat(undeliveredMessages.get(0)
                .getCompositeType()
                .getDescription("itemName"), is("itemDescription"));
        assertThat(undeliveredMessages.get(0)
                .getCompositeType()
                .getDescription("body"), is("messageBodyDescription"));
        assertThat(undeliveredMessages.get(0)
                .getCompositeType()
                .getDescription(), is("description"));

        assertThat(undeliveredMessages.get(0)
                .get("itemName"), is("itemValue"));
    }
}
