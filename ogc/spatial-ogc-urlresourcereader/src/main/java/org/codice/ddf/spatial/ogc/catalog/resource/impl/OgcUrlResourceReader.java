 ...
 */
public class OgcUrlResourceReader extends URLResourceReader implements ResourceReader {
    ...
    private static final String TITLE = "OGC URL Resource Reader";

    // private static final String DESCRIPTION = "Retrieves a file from a remote file system.";
    private String organization = "OGC";
    ...
    /**
     * Override organization to distinguish it from DDF.
     * @return configured organization name.
     */
    @Override
    ...
    public ResourceResponse retrieveResource(URI resourceURI, Map<String, Serializable> properties)
        ...
        LOGGER.trace(OgcUrlResourceReader.class.getName() + ": Entering retrieveResource");
        ...
        if (resourceURI.getScheme().equals(URL_HTTP_SCHEME)
            ...
            ResourceNotFoundException ce = new ResourceNotFoundException("Resource qualifier ( "
                    + resourceURI.getScheme() + " ) not valid. " + OgcUrlResourceReader.TITLE
    ...
    private ResourceResponse doRetrieveProduct(URI resourceURI, String productName)
        ...
        try {           
            ...
            if (mimeType.toLowerCase().contains("text/html")) {
                ...
                is = new ByteArrayInputStream(strBuilder.toString().getBytes());
            } else {
    ...
    /**
     * This method exists to provide a way to mock the URLConnection for
     * unit testing (See ResourceReaderTest.java for example usage scenarios).
     */
