...
/**
 * Custom exception for handling situations where Schematron Validation Service cannot
 * initialize correctly. This can happen if an invalid sch file is specified during initialization.
 * 
 * @author rodgersh
 */
