...
public class TestGeoJsonExtensible {
	...
	public void testExtensibleGeoJsonA() throws IOException, CatalogTransformerException{
	    ...
	    ByteArrayInputStream geoJsonInput = new ByteArrayInputStream(sampleJsonExtensibleA().getBytes());
	    ...
	    assertEquals(SAMPLE_A_MAX_FREQUENCY, (Long)metacard.getAttribute("max-frequency").getValue(), 0);
	    assertTrue(metacard.getAttribute("min-frequency").getValue() instanceof Long);
	    assertEquals(SAMPLE_A_MIN_FREQUENCY, (Long)metacard.getAttribute("min-frequency").getValue(), 0);
	...
	public void testExtensibleGeoJsonB() throws IOException, CatalogTransformerException{
	    ...
	    ByteArrayInputStream geoJsonInput = new ByteArrayInputStream(sampleJsonExtensibleB().getBytes());
	    Metacard metacard = new GeoJsonInputTransformer(mtr).transform(geoJsonInput);
	    
	    assertEquals(DEFAULT_TITLE, metacard.getTitle());
	    assertEquals(DEFAULT_ID, metacard.getId());
	    assertTrue(metacard.getAttribute(COLUMNS_ATTRIBUTE_KEY).getValue() instanceof Integer);
	    assertTrue(DEFAULT_COLUMNS == (Integer)metacard.getAttribute(COLUMNS_ATTRIBUTE_KEY).getValue());
	    ...
	    assertEquals(DEFAULT_DESCRIPTION, (String)metacard.getAttribute(DESCRIPTION_ATTRIBUTE_KEY).getValue());
	    assertEquals(SAMPLE_B_METACARD_TYPE_NAME, metacard.getMetacardType().getName());
	    assertTrue(metacard.getAttribute(PRECISE_LENGTH_METERS_ATTRIBUTE_KEY).getValue() instanceof Double);
	    assertEquals(Double.MAX_VALUE, (Double)metacard.getAttribute(PRECISE_LENGTH_METERS_ATTRIBUTE_KEY).getValue(), 0);
	    ...
	    assertTrue(metacard.getAttribute(PRECISE_HEIGHT_METERS_ATTRIBUTE_KEY).getValue() instanceof Float);
	    assertEquals(Float.MAX_VALUE, (Float)metacard.getAttribute(PRECISE_HEIGHT_METERS_ATTRIBUTE_KEY).getValue(), 0);
	    assertTrue(metacard.getAttribute(NUMBER_REVIEWERS_ATTRIBUTE_KEY).getValue() instanceof Short);
	    assertEquals(Short.MAX_VALUE, (Short)metacard.getAttribute(NUMBER_REVIEWERS_ATTRIBUTE_KEY).getValue(), 0);
	...
	@Test
	public void testExtensibleGeoJsonB_NonParseableField() throws IOException, CatalogTransformerException{
	    MetacardTypeRegistry mtr = prepareMetacardTypeRegistry();
	    
	    ByteArrayInputStream geoJsonInput = new ByteArrayInputStream(sampleJsonExtensibleB_WithBadField().getBytes());
	    Metacard metacard = new GeoJsonInputTransformer(mtr).transform(geoJsonInput);
	...
	@Test
	public void testExtensibleGeoJson_NoMetacardType() throws IOException, CatalogTransformerException{
	    MetacardTypeRegistry mtr = prepareMetacardTypeRegistry();
	    
	    ByteArrayInputStream geoJsonInput = new ByteArrayInputStream(sampleJsonExtensibleA_NoMetacardType().getBytes());
	    Metacard metacard = new GeoJsonInputTransformer(mtr).transform(geoJsonInput);
	    
	    //since no metacard type was specified only the Basic Metacard Type attributes should be available.  These are defined in BasicTypes.BASIC_METACARD 
	    //none of the custom attributes defined in SampleMetacardTypeA will be added to the metacard.
	    assertEquals(DEFAULT_TITLE, metacard.getTitle());
	    assertEquals(DEFAULT_ID, metacard.getId());
	...
	public void testExtensibleGeoJson_UnregisteredMetacardType() throws IOException, CatalogTransformerException{
	    MetacardTypeRegistry mtr = prepareMetacardTypeRegistry();
	    
	    ByteArrayInputStream geoJsonInput = new ByteArrayInputStream(sampleJsonExtensibleA_UnregisteredMetacardType().getBytes());
	    Metacard metacard = new GeoJsonInputTransformer(mtr).transform(geoJsonInput);
	}
	
	@Test
	public void testBasicMetacardType() throws IOException, CatalogTransformerException, ParseException{
	    MetacardTypeRegistry mtr = prepareMetacardTypeRegistry();
	...
	@Test
	public void testBasicMetacardType_NoMetacardType() throws IOException, CatalogTransformerException, ParseException {
	    MetacardTypeRegistry mtr = prepareMetacardTypeRegistry();
	    ByteArrayInputStream geoJsonInput = new ByteArrayInputStream(sampleBasicMetacard_NoMetacard().getBytes());
	    Metacard metacard = new GeoJsonInputTransformer(mtr).transform(geoJsonInput);
	...
	private static final String sampleJsonExtensibleB() {
		return "{" + 
				...
				"        \"id\":\"myId\"," +
				"        \"reviewed\":\"true\"," +
				"        \"precise-length-meters\":\"" + Double.MAX_VALUE + "\"," +
