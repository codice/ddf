...
/**
 * Given a {@link Metacard}, this class can be used to return the contents of the
 * Metacard attributes. Supported formats are String and byte[]
 * 
...
public class AttributeMetacardTransformer implements MetacardTransformer {
	 ...
	 * 
	 * @param attributeName
	 *            The name of the attribute that will be used to retrieve the value within the {@link Metacard}
	 * @param id
	...
	public BinaryContent transform(Metacard metacard, Map<String, Serializable> arguments)
		...
		if(LOGGER.isDebugEnabled()) {
			LOGGER.debug("Attempting transformation of [" + metacard + "] with transformer [" + this + "]") ;
		}
		...
		if (attribute != null && attribute.getValue() != null) {
			...
			if (String.class.isAssignableFrom(attribute.getValue().getClass())) {
				return new BinaryContentImpl(new ByteArrayInputStream(attribute.getValue().toString().getBytes()),
						mimeType);
			}
	...
	public String toString() {
		return MetacardTransformer.class.getName() + " {Impl=" + this.getClass().getName() + ", attributeName="
				+ attributeName + ", id=" + id + ", MIME Type=" + mimeType + "}";
	}
}
