...
/**
 * Enum for the different notice/alert priority levels. The priority ranges from critical (something
 * important has failed) to low (simple notice that something occurred)
 */
