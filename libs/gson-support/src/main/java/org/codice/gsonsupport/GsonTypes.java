 ...
 *
 * <p><em>Note: This File has been copied from Gson's <a
 * href="https://github.com/google/gson/blob/master/gson/src/main/java/com/google/gson/internal/$Gson$Types.java"{@code
 * $Gson$Types}</a> class with the only changes being
 *
 * <ul>
 *   <li>Inlining the {@link #checkNotNull(Object)} and {@link #checkArgument(boolean)} methods from
 *       the {@code $Gson$Preconditions} class to reduce complexity
 *   <li>Moving to this package
 *   <li>Formatting to match Codice style
 * </ul>
 *
 * The import was required because the source class resides in an `internal` package and was
 * therefore not exported by the OSGi bundle.</em>
 *
 * @author Bob Lee
 * @author Jesse Wilson
 */
