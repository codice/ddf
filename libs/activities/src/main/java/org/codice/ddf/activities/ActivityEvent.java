...
public class ActivityEvent extends HashMap<String, Object> {
   ...
   *
   * @param operations Map of operations where the key is the operation name and the value is a url
   *     to the operation
   */
   ...
   *
   * @return progress Integer value representation of the progress, ranging from 0 to 100, or -1
   *     when progress is unknown or not applicable
   */
   ...
   *
   * @param progress Integer value representation of the progress, ranging from 0 to 100, or -1 when
   *     progress is unknown or not applicable
   */
   ...
   *
   * @return Type of the {@code ActivityEvent}, must follow the enumerated ActivityType values.
   */
   ...
   *
   * @param id This id should be unique and used across the entire lifecycle of the {@code
   *     ActivityEvent}.
   */
   ...
   *
   * @param sessionId This session id should be unique and used across the entire lifecycle of the
   *     {@code ActivityEvent}.
   */
   ...
   *
   * @param message The new message associated with the {@code ActivityEvent}
   */
   ...
   *
   * @param title The new title associated with the {@code ActivityEvent}
   */
   ...
   *
   * @param category A human-readable category that describes the event that is occuring. Example:
   *     'Product Retrieval'.
   */
   ...
   *     00:00:00 GMT and the point at which the event that triggered this {@code ActivityEvent}
   *     occurred.
   */
  ...
  /**
   * Returns a <code>Date</code> depicting the time at which the event that triggered this {@code
   * ActivityEvent} occurred.
   *
   * @return A <code>Date</code> the point at which the event that triggered this {@code
   *     ActivityEvent} occurred.
   */
   ...
   * ActivityEvent} occurred.
   *
   * @param timestamp A <code>Date</code> representing the point at which the event that triggered
   ...
   *
   * @param userId The new userId to whom the {@code ActivityEvent} should be addressed.
   */
   ...
   *
   * @param bytesRead The new bytes read associated with the {@code ActivityEvent}.
   */
  ...
  /**
   * Status enumerations for an activity. Describes the various states an activity can be in. <br>
   * <br>
   * <b>STARTED</b> - Initial status, the activity is in the process of starting up and is not
   * RUNNING yet. <br>
   * <b>RUNNING</b> - Main state used to describe that the activity is currently active and
   * performing the activity. <br>
   * <b>FINISHED</b> - The activity has finished its processing and will not send any more statuses.
   * <br>
   * <b>STOPPED</b> - The activity has stopped running before finishing and cannot be resumed. <br>
   * <b>PAUSED</b> - The activity has been paused before finishing and can be resumed. <br>
   * <b>FAILED</b> - The activity suffered a failure before finishing and cannot be resumed.
   */
