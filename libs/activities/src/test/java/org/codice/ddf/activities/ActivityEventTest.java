...
public class ActivityEventTest {
  ...
  public void testCreateActivityEvent() {
    ...
    cal.setTimeInMillis(
        ISODateTimeFormat.dateTime()
            .parseDateTime(event.get(ActivityEvent.TIMESTAMP_KEY).toString())
            .toDate()
            .getTime());
  ...
  /**
   * Guest user will have empty string as their user ID - verify can create an ActivityEvent with an
