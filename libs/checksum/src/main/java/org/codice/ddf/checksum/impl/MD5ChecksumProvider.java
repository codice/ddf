...
public class MD5ChecksumProvider extends BaseChecksumProvider implements ChecksumProvider {
    ...
    public  String calculateChecksum(InputStream inputStream) {
        ...
        try {
            ...
            LOGGER.error("Error obtaining MessageDigest using algorithm:" + DIGEST_ALGORITHM, e);
        } catch (IOException e) {
