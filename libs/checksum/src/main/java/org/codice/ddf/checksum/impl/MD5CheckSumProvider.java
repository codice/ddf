...
public class MD5CheckSumProvider extends AbstractCheckSumProvider implements CheckSumProvider {

    private static final String DIGEST_ALGORITHM = "MD5";
    private static final XLogger LOGGER = new XLogger(LoggerFactory.getLogger(MD5CheckSumProvider.class));
    ...
    public  String calculateCheckSum(InputStream inputStream) {
        ...
        try {
            ...
            LOGGER.error("Error obtaining MessageDigest using algorithm:" + DIGEST_ALGORITHM);
        } catch (IOException e) {
