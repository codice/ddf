...
/**
 * Serializable Notification that is persisted to disk by @FileSystemPersistenceProvider
...
public class MockNotification extends HashMap<String, String> {
     ...
     */
    public MockNotification(String application, String title, String message, Long timestamp) {
     ...
     *                  generated.
     */
    public MockNotification(String application, String title, String message, String timestamp) {
