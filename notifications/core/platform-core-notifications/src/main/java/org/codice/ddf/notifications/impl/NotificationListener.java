...
public class NotificationListener implements EventHandler {
    ...
    public void handleEvent(Event event) throws IllegalArgumentException {
        ...
        item.addProperty(PersistentNotification.NOTIFICATION_KEY_USER_ID, userId);
        item.addProperty(PersistentNotification.NOTIFICATION_KEY_TIMESTAMP, timestamp);
        item.addProperty(PersistentNotification.NOTIFICATION_KEY_APPLICATION, application);
        item.addProperty(PersistentNotification.NOTIFICATION_KEY_TITLE,  title);
        item.addProperty(PersistentNotification.NOTIFICATION_KEY_MESSAGE, message);
//        Map<String, Object> item = new HashMap<String, Object>();
//        item.put(PersistentNotification.NOTIFICATION_KEY_USER_ID, userId);
//        item.put(PersistentNotification.NOTIFICATION_KEY_TIMESTAMP, timestamp);
//        item.put(PersistentNotification.NOTIFICATION_KEY_APPLICATION, application);
//        item.put(PersistentNotification.NOTIFICATION_KEY_TITLE,  title);
//        item.put(PersistentNotification.NOTIFICATION_KEY_MESSAGE, message);
        try {
