...
public class GetRecordsRequest extends CswRequest {
    ...
    /**
     * Should not set default values for these fields.  Otherwise those values will be used
     * by the endpoint GET requests, when the caller fails to specify a parameter.
     */
    ...
    public GetRecordsType get_2_0_2_RecordsType() throws CswException {
        ...
        if (getElementName() != null && getElementSetName() != null) {
            LOGGER.warn("CSW getRecords request received with mutually exclusive ElementName and SetElementName set");
        ...
        if (getElementSetName() != null) {
            try {
                ...
                LOGGER.warn("Failed to find \"{}\" as a valid elementSetType, Exception {}", getElementSetName(), iae);
        ...
        JAXBElement<QueryType> jaxbQuery = new JAXBElement<QueryType>(new QName(
                CswConstants.CSW_OUTPUT_SCHEMA), QueryType.class, query);
