...
public class ProxyFilterChain implements FilterChain
{
    ...
    public void doFilter( ServletRequest servletRequest, ServletResponse servletResponse ) throws IOException, ServletException
    {
        ...
        if ( iterator.hasNext() )
        {
            ...
            LOGGER.debug( "Calling " + filter.getClass().getName() + ".doFilter(" + servletRequest + ", " + servletResponse + ", " + this + ")" );
            filter.doFilter( servletRequest, servletResponse, this );
        }
        else
        {
            LOGGER.debug( "Calling " + filterChain.getClass().getName() + ".doFilter(" + servletRequest + ", " + servletResponse + ")" );
