...
/**
 * Implementation of the SecurityAssertion interface. This class wraps a
 * SecurityToken.
 * 
 * @author tustisos
 * 
...
public class SecurityAssertionImpl implements SecurityAssertion
{
     ...
     * 
     * @see
     * ddf.security.common.assertion.SecurityAssertion#getAttibuteStatements()
     */
    @Override
     ...
     * 
     * @see
     * ddf.security.common.assertion.SecurityAssertion#getAuthzDecisionStatements
     * ()
     */
    @Override
