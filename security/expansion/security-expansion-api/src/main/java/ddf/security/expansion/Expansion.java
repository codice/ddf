...
public interface Expansion
{
     ...
     *
     * @param map  The map corresponding to the set of security attributes and their values to be expanded
     ...
     *
     * @param key  The key corresponding to the set of security values to be expanded
