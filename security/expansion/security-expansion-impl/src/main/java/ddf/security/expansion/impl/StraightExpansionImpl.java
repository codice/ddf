...
public class StraightExpansionImpl extends AbstractExpansion
{
    ...
    /**
     * Performs an expansion using straight string equality and substitution for both parts of the rule. The first
     * element is the string that must match the entire original string, the second element is the complete replacement
     * string to be substituted for the original.
     * @param original  The original string to be expanded
     * @param rule  Two values specifying the expression to search for and the string to replace it with
