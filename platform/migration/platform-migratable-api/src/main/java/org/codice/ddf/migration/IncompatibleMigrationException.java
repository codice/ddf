...
/**
 * Exception that indicates an incompatible migration was attempted.
 * <p>
 * <b>
 ...
 * </p>
 */
public class IncompatibleMigrationException extends ImportMigrationException {
    private static final String MESSAGE_PREFIX = "incompatibility error";
     ...
     */
    public IncompatibleMigrationException(String message) {
     ...
     */
    public IncompatibleMigrationException(String message, Throwable cause) {
