...
/**
 * The <code>BiThrowingConsumer</code> interface expands on the {@link java.util.function.BiConsumer}
...
public interface BiThrowingConsumer<T, U, E extends Throwable> {
    ...
    /**
     * Returns a composed {@code BiThrowingConsumer} that performs, in sequence, this
     ...
     * @return a composed {@code BiThrowingConsumer} that performs in sequence this
