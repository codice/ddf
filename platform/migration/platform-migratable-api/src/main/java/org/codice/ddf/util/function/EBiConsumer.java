...
/**
 * The <code>EBiConsumer</code> interface expands on the {@link java.util.function.BiConsumer}
...
public interface EBiConsumer<T, U, E extends Throwable> {
     ...
     * @throws E                        if an error occurs
     */
    public default EBiConsumer<T, U, E> andThen(EBiConsumer<? super T, ? super U, E> after)
            throws E {
