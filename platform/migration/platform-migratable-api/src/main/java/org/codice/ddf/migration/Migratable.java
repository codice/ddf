 ...
 * a new system. The information exported will allow a new system to be automatically configured (cloned)
 * like the exported system. Only bundle or feature specific settings need be handled. All configurations
...
public interface Migratable extends Describable {
     ...
     * it back to the {@link #doIncompatibleImport} method if the exported version string doesn't match
     * the one provided by this method when importing the data for this migratable.
     * <p>
