...
public class JsonUtilsTest {
    ...
    public void testConvertToMap() throws Exception {
        Assert.assertThat(JsonUtils.convertToMap(JsonUtilsTest.JSON_MAP),
    ...
    public void testGetMapFrom() throws Exception {
        Assert.assertThat(JsonUtils.getMapFrom(JsonUtilsTest.JSON_DEEP_MAP, "map"),
                Matchers.equalTo(JsonUtilsTest.JSON_MAP));
    }

    @Test
    public void testGetMapFromWhenNotDefined() throws Exception {
        Assert.assertThat(JsonUtils.getMapFrom(JsonUtilsTest.JSON_DEEP_MAP, "map2"),
                Matchers.equalTo(new HashMap<>()));
    }

    @Test
    public void testGetMapFromWithNullKey() throws Exception {
        Assert.assertThat(JsonUtils.getMapFrom(JsonUtilsTest.JSON_DEEP_MAP, null),
                Matchers.equalTo(new HashMap<>()));
    }
    ...
    public void testGetListFrom() throws Exception {
        Assert.assertThat(JsonUtils.getListFrom(JsonUtilsTest.JSON_DEEP_MAP, "list"),
                Matchers.equalTo(JsonUtilsTest.JSON_LIST));
    }

    @Test
    public void testGetListFromWhenNotDefined() throws Exception {
        Assert.assertThat(JsonUtils.getListFrom(JsonUtilsTest.JSON_DEEP_MAP, "list2"),
                Matchers.equalTo(new ArrayList<>()));
    }

    @Test
    public void testGetListFromWithNullKey() throws Exception {
        Assert.assertThat(JsonUtils.getListFrom(JsonUtilsTest.JSON_DEEP_MAP, null),
                Matchers.equalTo(new ArrayList<>()));
    }
    ...
    public void testGetStringFromWhenRequired() throws Exception {
        Assert.assertThat(JsonUtils.getStringFrom(JsonUtilsTest.JSON_MAP, "string", true),
                Matchers.equalTo(JsonUtilsTest.JSON_STRING));
    }

    @Test
    public void testGetStringFromWhenNotRequired() throws Exception {
        Assert.assertThat(JsonUtils.getStringFrom(JsonUtilsTest.JSON_MAP, "string", false),
                Matchers.equalTo(JsonUtilsTest.JSON_STRING));
    }
    ...
    public void testGetStringFromWhenNotRequiredAndNotDefined() throws Exception {
        Assert.assertThat(JsonUtils.getStringFrom(JsonUtilsTest.JSON_MAP, "string2", false),
                Matchers.nullValue());
    }
    ...
    public void testGetStringFromWhenNotRequiredAndWithNullKey() throws Exception {
        Assert.assertThat(JsonUtils.getStringFrom(JsonUtilsTest.JSON_MAP, null, false),
                Matchers.nullValue());
    }
    ...
    public void testGetLongFromWhenRequired() throws Exception {
        Assert.assertThat(JsonUtils.getLongFrom(JsonUtilsTest.JSON_MAP, "long", true),
                Matchers.equalTo(JsonUtilsTest.JSON_LONG));
    }

    @Test
    public void testGetLongFromWhenNotRequired() throws Exception {
        Assert.assertThat(JsonUtils.getLongFrom(JsonUtilsTest.JSON_MAP, "long", false),
                Matchers.equalTo(JsonUtilsTest.JSON_LONG));
    }
    ...
    public void testGetLongFromWhenNotRequiredAndNotDefined() throws Exception {
        Assert.assertThat(JsonUtils.getLongFrom(JsonUtilsTest.JSON_MAP, "long2", false),
                Matchers.nullValue());
    }
    ...
    public void testGetLongFromWhenNotRequiredAndWithNullKey() throws Exception {
        Assert.assertThat(JsonUtils.getLongFrom(JsonUtilsTest.JSON_MAP, null, false),
                Matchers.nullValue());
    }
    ...
    public void testGetLongFromWhenRequiredAndValueIsInt() throws Exception {
        Assert.assertThat(JsonUtils.getLongFrom(JsonUtilsTest.JSON_MAP, "int", true),
    ...
    public void testGetLongFromWhenNotRequiredAndValueIsInt() throws Exception {
        Assert.assertThat(JsonUtils.getLongFrom(JsonUtilsTest.JSON_MAP, "int", false),
                Matchers.equalTo(JsonUtilsTest.JSON_INT.longValue()));
    }

    @Test
    public void testGetBooleanFromWhenRequired() throws Exception {
        Assert.assertThat(JsonUtils.getBooleanFrom(JsonUtilsTest.JSON_MAP, "bool", true),
                Matchers.equalTo(JsonUtilsTest.JSON_BOOL));
    }

    @Test
    public void testGetBooleanFromWhenNotRequired() throws Exception {
        Assert.assertThat(JsonUtils.getBooleanFrom(JsonUtilsTest.JSON_MAP, "bool", false),
                Matchers.equalTo(JsonUtilsTest.JSON_BOOL));
    }
    ...
    public void testGetBooleanFromWhenNotRequiredAndNotDefined() throws Exception {
        Assert.assertThat(JsonUtils.getBooleanFrom(JsonUtilsTest.JSON_MAP, "bool2", false),
    ...
    public void testGetBooleanFromWhenNotRequiredAndWithNullKey() throws Exception {
        Assert.assertThat(JsonUtils.getBooleanFrom(JsonUtilsTest.JSON_MAP, null, false),
                Matchers.equalTo(false));
    }
