...
public class XmlParserTest {
  ...
  public void setUp() throws Exception {
    ...
    configurator = parser.configureParser(ctxPath, XmlParserTest.class.getClassLoader());
  ...
  public void testConfigureParser() {
    assertTrue(configurator.getContextPath().contains(MotherElement.class.getPackage().getName()));
    assertEquals(XmlParserTest.class.getClassLoader(), configurator.getClassLoader());
  }
  ...
  public void testMarshalNode() throws Exception {
    ...
    assertEquals(
        mother.getAge().toString(),
        doc.getDocumentElement().getAttributes().getNamedItem("age").getNodeValue());
    assertEquals(
        mother.getFirstname(),
        doc.getDocumentElement().getAttributes().getNamedItem("firstname").getNodeValue());
    assertEquals(
        mother.getLastname(),
        doc.getDocumentElement().getAttributes().getNamedItem("lastname").getNodeValue());

    // check the child nodes
    assertEquals(mother.getChild().size(), doc.getFirstChild().getChildNodes().getLength());

    // first child
    assertEquals(3, doc.getDocumentElement().getChildNodes().item(0).getAttributes().getLength());
    assertEquals(
        mother.getChild().get(0).getFirstname(),
        doc.getDocumentElement()
            ...
            .getNodeValue());
    assertEquals(
        mother.getChild().get(0).getLastname(),
        doc.getDocumentElement()
            .getChildNodes()
            .item(0)
            .getAttributes()
            ...
            .getNodeValue());
    assertEquals(
        mother.getChild().get(0).getAge().toString(),
        doc.getDocumentElement()
            .getChildNodes()
            .item(0)
            .getAttributes()
    ...
    // second child
    assertEquals(3, doc.getDocumentElement().getChildNodes().item(1).getAttributes().getLength());
    assertEquals(
        mother.getChild().get(1).getFirstname(),
        doc.getDocumentElement()
            .getChildNodes()
            .item(1)
            .getAttributes()
            ...
            .getNodeValue());
    assertEquals(
        mother.getChild().get(1).getLastname(),
        doc.getDocumentElement()
            .getChildNodes()
            .item(1)
            .getAttributes()
            ...
            .getNodeValue());
    assertEquals(
        mother.getChild().get(1).getAge().toString(),
        doc.getDocumentElement()
            .getChildNodes()
            .item(1)
            .getAttributes()
  ...
  public void testUnmarshalSource() throws Exception {
    ...
    JAXBElement<MotherElement> motherElementJAXBElement =
        new JAXBElement(new QName("mother"), MotherElement.class, mother);
  ...
  public void testCacheKey() throws Exception {
    XmlParser.CacheKey cacheKey1 =
        new XmlParser.CacheKey("hello:world", XmlParserTest.class.getClassLoader());
    XmlParser.CacheKey cacheKey2 =
        new XmlParser.CacheKey("here:now", XmlParserTest.class.getClassLoader());
    XmlParser.CacheKey cacheKey3 =
        new XmlParser.CacheKey("hello:world", XmlParserTest.class.getClassLoader());
