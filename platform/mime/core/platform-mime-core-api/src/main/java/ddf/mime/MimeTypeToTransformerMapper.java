...
public interface MimeTypeToTransformerMapper {
   ...
   * @param mimeType {@link MimeType} object
   * @return all OSGi Services that match the mimeType and clazz criteria. Passing a <code>null
   *     </code> {@link MimeType} will return all the matching services of the service type
