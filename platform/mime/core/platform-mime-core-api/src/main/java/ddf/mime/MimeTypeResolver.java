...
public interface MimeTypeResolver {
  ...
  /**
   * Gets the schema (if one exists) of the MimeTypeResolver. The schema is set only for xml mime
   * types, e.g., text/xml, and reflects the namespace of the root element.
   *
   * @return the name of the MimeTypeResolver
   */
   ...
   * meaning the MimeTypeResolver is invoked earlier.
   *
   ...
   * a file extension of .nitf would be returned. The mapping of file extensions to mime types is
   * part of the configuration of a MimeTypeResolver.
   *
