 ...
 */
public class SystemConfigurationMigrator {

    private static final Logger LOGGER = LoggerFactory.getLogger(SystemConfigurationMigrator.class);
    ...
    public SystemConfigurationMigrator(Path ddfHome) throws MigrationException {
