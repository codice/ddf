...
public class ManagedServiceFactoryConfigurationFileTest {
    ...
    public void testCreateConfig() throws Exception {
        ...
        when(mockConfigAdmin.createFactoryConfiguration(FACTORY_PID, null)).thenReturn(mockConfiguration);
        ConfigurationFile configFile = new  ManagedServiceFactoryConfigurationFile(mockPath, properties,
                mockConfigAdmin);
    ...
    public void testCreateConfigGetConfigurationFails() throws Exception {
        ...
        Path mockPath = getMockPath();
        ConfigurationAdmin mockConfigAdmin = getMockConfigurationAdmin();
        when(mockConfigAdmin.createFactoryConfiguration(FACTORY_PID, null)).thenThrow(new IOException());
        ConfigurationFile configFile = new  ManagedServiceFactoryConfigurationFile(mockPath, properties,
                mockConfigAdmin);
