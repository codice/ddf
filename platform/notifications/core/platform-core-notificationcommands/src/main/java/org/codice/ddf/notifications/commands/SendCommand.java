...
public class SendCommand implements Action {
    ...
    @Option(name = "Application", required = false, aliases = {
            "-a"}, multiValued = false, description = "The name of application that sent the notification.")
    String application = DEFAULT_NOTIFICATION_APPLICATION;

    @Option(name = "Title", required = false, aliases = {
            "-t"}, multiValued = false, description = "The title of the notification.")
    String title = DEFAULT_NOTIFICATION_TITLE;

    @Option(name = "Message", required = false, aliases = {
            "-m"}, multiValued = false, description = "The detailed message to be sent in the notification.")
    String message = DEFAULT_NOTIFICATION_MESSAGE;

    @Option(name = "Wait Time", required = false, aliases = {
            "-w"}, multiValued = false, description = "FOR TESTING ONLY: The amount of seconds to wait between sending each notification.")
