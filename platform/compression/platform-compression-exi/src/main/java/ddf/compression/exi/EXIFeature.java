...
/**
 * Controls EXI compression of CXF-based messages. Attaching this feature to a cxf endpoint
 * (jaxws:endpoint or jaxrs:server) will allow the server to send responses back in an exi-encoded
 * format.
 */
@NoJSR250Annotations
