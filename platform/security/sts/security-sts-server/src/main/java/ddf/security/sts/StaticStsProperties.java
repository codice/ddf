...
/**
 * A customized static implementation of the STSPropertiesMBean. The StaticSTSProperties
 * doesn't allow custom resolution of the properties (i.e. System Property replacement), and was
 * extended to support such features.
 */
