...
public class TestAttributeQueryClaimsHandler {
    ...
    public void setUp() throws IOException {
        ...
        spyAttributeQueryClaimsHandler.setAttributeMapLocation(getClass().getClassLoader()
    ...
    public void testRetrieveClaimValues() throws Exception {
        ...
        assertThat((String) processedClaimCollection.get(0)
                .getValues()
        ...
        assertThat((String) processedClaimCollection.get(1)
                .getValues()
        ...
        assertThat((String) processedClaimCollection.get(2)
                .getValues()
