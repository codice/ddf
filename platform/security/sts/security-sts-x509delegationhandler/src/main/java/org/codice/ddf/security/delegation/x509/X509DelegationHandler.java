...
public class X509DelegationHandler implements TokenDelegationHandler {
  ...
  private static final org.slf4j.Logger LOGGER =
      LoggerFactory.getLogger(X509DelegationHandler.class);
  ...
  */
  /**
   * Set whether to perform a check that the received AppliesTo address is contained in the token as
   * one of the AudienceRestriction URIs. The default is false.
   *
