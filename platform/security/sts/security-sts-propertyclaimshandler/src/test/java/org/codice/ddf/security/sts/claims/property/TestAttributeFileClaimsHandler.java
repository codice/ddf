...
public class TestAttributeFileClaimsHandler {
  ...
  public void setup() throws IOException {
    ...
    InputStream resourceAsStream =
        TestAttributeFileClaimsHandler.class.getResourceAsStream("/users.attributes");
  ...
  public void testRetrieveClaimValuesAdmin() {
    ProcessedClaimCollection processedClaims =
        attributeFileClaimsHandler.retrieveClaimValues(claimCollection, adminClaimsParameters);
  ...
  public void testRetrieveClaimValuesLocalhost() {
    ProcessedClaimCollection processedClaims =
        attributeFileClaimsHandler.retrieveClaimValues(claimCollection, localhostClaimsParameters);
  ...
  public void testRetrieveClaimValuesRegex() {
    ProcessedClaimCollection processedClaims =
        attributeFileClaimsHandler.retrieveClaimValues(claimCollection, regexClaimsParameters);
  ...
  public void testNoMatchRetrieveClaimValues() {
    ProcessedClaimCollection processedClaims =
        attributeFileClaimsHandler.retrieveClaimValues(claimCollection, unknownClaimsParameters);
    assertThat(processedClaims.size(), is(0));
  }
  ...
  public void testRetrieveClaimsValuesNullPrincipal() {
    ...
    ProcessedClaimCollection processedClaims =
        attributeFileClaimsHandler.retrieveClaimValues(claimCollection, claimsParameters);
