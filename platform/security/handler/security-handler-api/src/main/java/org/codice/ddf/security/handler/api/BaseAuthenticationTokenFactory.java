...
public class BaseAuthenticationTokenFactory {

  private static final Logger LOGGER =
      LoggerFactory.getLogger(BaseAuthenticationTokenFactory.class);
    ...
    try {
      merlin =
          new Merlin(
              ...
              BaseAuthenticationTokenFactory.class.getClassLoader(),
              null);
  ...
  /**
   * Creates a {@link BaseAuthenticationToken} from a given username and password. Uses a {@link
   ...
   */
  public BaseAuthenticationToken fromUsernamePassword(String username, String password) {
  ...
  /**
   * Creates a {@link BaseAuthenticationToken} from a given list of certificates. Uses a {@link
   ...
   */
  public BaseAuthenticationToken fromCertificates(X509Certificate[] certs) {
    ...
    return new BaseAuthenticationToken(certs[0].getSubjectDN(), binarySecurity.toString());
  }
