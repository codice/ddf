...
public class RegexExpansion extends AbstractExpansion {
   ...
   * is a regular expression identifying what to find in the original string, the second element is
   * a regular expression indicating what is to be replaced (may contain substitution groups, etc.)
   *
   * @param original The original string to be expanded
   * @param rule Two values specifying the expression to search for and the expression to replace it
   *     with
