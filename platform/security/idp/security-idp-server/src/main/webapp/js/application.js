...
define(['marionette',
...
], function (Marionette, Backbone, Login, appHeaderTemplate, headerTemplate, footerTemplate, $, ich) {
    'use strict';
    ...
    Application.App.addInitializer(function () {
        if (Application.App.props.ui.header && Application.App.props.ui.header !== '') {
            $('html').addClass('has-header');
        }
        Application.App.header.show(new Marionette.ItemView({
    ...
    Application.App.addInitializer(function () {
        if (Application.App.props.ui.footer && Application.App.props.ui.footer !== '') {
            $('html').addClass('has-footer');
        }
        Application.App.footer.show(new Marionette.ItemView({
