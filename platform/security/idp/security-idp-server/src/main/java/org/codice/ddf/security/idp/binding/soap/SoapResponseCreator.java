...
public class SoapResponseCreator extends ResponseCreatorImpl implements ResponseCreator {
    ...
    public SoapResponseCreator(SystemCrypto systemCrypto,
    ...
    public Response getSamlpResponse(String relayState, AuthnRequest authnRequest,
        ...
        String submitFormUpdated = responseTemplate.replace("{{" + Idp.SAML_RESPONSE + "}}",
                assertionResponse);
        ...
        submitFormUpdated = submitFormUpdated.replace("{{" + Idp.ECP_RESPONSE + "}}",
                ecpResponse);
        submitFormUpdated = submitFormUpdated.replace("{{" + Idp.ECP_RELAY_STATE + "}}",
                ecpRelayState);
        submitFormUpdated = submitFormUpdated.replace("{{" + Idp.ECP_REQUEST_AUTHENTICATED + "}}",
                ecpRequestAuthenticated);
