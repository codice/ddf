...
public class AuthenticationEndpointTest {
    ...
    public void setup() throws SecurityServiceException, URISyntaxException {
        ...
        when(session.getAttribute(SecurityConstants.SAML_ASSERTION)).thenReturn(mock(
                SecurityTokenHolder.class));
    ...
    private void mockUser(String username, String password, String realm)
        ...
        when(securityManager.getSubject(argThat(new UsernamePasswordTokenMatcher(token)))).thenReturn(
                subject);
    }
    ...
    private class UsernamePasswordTokenMatcher extends ArgumentMatcher<UPAuthenticationToken> {
        ...
        public boolean matches(Object object) {
            if (object instanceof UPAuthenticationToken) {
                ...
                return left.getUsername()
                        .equals(right.getUsername()) && left.getPassword()
                        .equals(right.getPassword()) && left.getRealm()
                        .equals(right.getRealm());
            }
