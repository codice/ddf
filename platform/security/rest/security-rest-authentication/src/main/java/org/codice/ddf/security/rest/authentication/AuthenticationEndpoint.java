...
public class AuthenticationEndpoint {
    ...
    public AuthenticationEndpoint(ContextPolicyManager policyManager,
            SecurityManager securityManager, SessionFactory sessionFactory) {
    ...
    public Response login(@Context HttpServletRequest request,
            ...
            @FormParam("prevurl") String prevurl) throws SecurityServiceException {
        ...
        UPAuthenticationToken authenticationToken = new UPAuthenticationToken(username,
                password,
                realm);
