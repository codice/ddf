...
public class RequestBuilder extends AbstractSAMLObjectBuilder<Request> {
    ...
    public Request buildObject() {
        return new RequestImpl(SAMLConstants.PAOS_NS, Request.DEFAULT_ELEMENT_LOCAL_NAME,
                SAMLConstants.PAOS_PREFIX);
    }

    @Nonnull
    @Override
    public Request buildObject(@Nullable String uri, @Nonnull @NotEmpty String localName,
