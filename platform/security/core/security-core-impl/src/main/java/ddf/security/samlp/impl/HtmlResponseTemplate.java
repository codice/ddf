...
public class HtmlResponseTemplate {
    ...
    static {
        try (
                InputStream submitFormStream = HtmlResponseTemplate.class.getResourceAsStream(
                        "/templates/submitFormTemplate.html");
                InputStream redirectPageStream = HtmlResponseTemplate.class.getResourceAsStream(
                        "/templates/redirectTemplate.html")
        ) {
     ...
     * Will turn any null Strings into blank Strings.
     *
     ...
     */
    public static String getPostPage(String targetUrl, SamlProtocol.Type type, String samlValue,
            String relayState) {
        return String.format(submitTemplate,
                elvis(targetUrl, ""),
