...
public class CertificateAuthority {
    ...
    //TODO: PEM encoded security objects should be injected - either loaded from a file, a bean or some other mechanism.
    ...
    // Make sure Bouncy Castle is registered as a security provider with the JCA.
    static {
