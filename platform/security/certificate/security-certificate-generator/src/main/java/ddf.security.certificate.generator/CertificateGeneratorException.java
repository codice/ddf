...
/**
 * This class and its nested classes represent the exceptions used by the certificate
 * generator package. The individual exceptions are static inner classes
 * encapsulated within the base class. The general strategy is to wrap the sundry
 * errors generated by the Java and Bouncy Castle cryptography/PKIX/JCA provider
 * classes and present a unified set of exceptions to client code.
 */
...
public class CertificateGeneratorException extends CertificateException {
    ...
    public static class InvalidSerialNumber extends CertificateGeneratorException {
        public InvalidSerialNumber(String msg) {
            super(msg);
        }
    }
}
