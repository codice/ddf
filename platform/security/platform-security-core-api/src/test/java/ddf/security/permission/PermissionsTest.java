...
public class PermissionsTest {
    ...
    public void testParsePermissions() throws Exception {
        ...
        assertThat(map.get("valid")
                .iterator()
                .next(), equalTo("permission"));
    ...
    public void testGetPermissions() throws Exception {
        ...
        Map<String, Set<String>> map = Permissions.parsePermissionsFromString("name=value1,value2",
                "name2=value3");
        permStrings = Permissions.getPermissionsAsStrings(map);
        assertThat(permStrings.contains("name=value1,value2") || permStrings.contains(
                "name=value2,value1"), is(true));
