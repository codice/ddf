...
public class SamlProtocolTest {
    ...
    public void testCreateIdpMetadata() {
        EntityDescriptor entityDescriptor = SamlProtocol.createIdpMetadata("myid",
                "mysigningcert",
                "myencryptioncert",
    ...
    public void testCreateSpMetadata() {
        EntityDescriptor entityDescriptor = SamlProtocol.createSpMetadata("myid",
                "mysigningcert",
                "myencryptioncert",
                "logoutlocation",
                "redirectlocation",
    ...
    public void testCreateAttributeQueryWithoutDestination() {
        AttributeQuery attributeQuery = SamlProtocol.createAttributeQuery(SamlProtocol.createIssuer(
                "myissuer"), SamlProtocol.createSubject(SamlProtocol.createNameID("mynameid")));
        assertEquals("myissuer",
                attributeQuery.getIssuer()
                        .getValue());
        assertEquals("mynameid",
    ...
    public void testCreateLogoutRequest() {
        LogoutRequest logoutRequest = SamlProtocol.createLogoutRequest(SamlProtocol.createIssuer(
                "myissuer"), SamlProtocol.createNameID("mynameid"), "myid");
        assertEquals("myissuer",
    ...
    public void testCreateLogoutResponse() {
        LogoutResponse logoutResponse = SamlProtocol.createLogoutResponse(SamlProtocol.createIssuer(
                "myissuer"), SamlProtocol.createStatus("mystatus"), "inResponseTo", "myid");
        assertEquals("myissuer",
    ...
    public void testCreateLogoutResponseWithoutInResponseTo() {
        LogoutResponse logoutResponse = SamlProtocol.createLogoutResponse(SamlProtocol.createIssuer(
                "myissuer"), SamlProtocol.createStatus("mystatus"), "myid");
        assertEquals("myissuer",
                logoutResponse.getIssuer()
                        .getValue());
        assertEquals("mystatus",
