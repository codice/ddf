...
public interface STSClientConfiguration {
   ...
   *
   * @param address String-based URL of the STS endpoint with no "WSDL" on the end.
   */
   ...
   *
   * <p>Default is <b>{http://docs.oasis-open.org/ws-sx/ws-trust/200512/}STS_Port</b>
   *
   ...
   *
   * <p>Default is <b>{http://docs.oasis-open.org/ws-sx/ws-trust/200512/} SecurityTokenService</b>
   *
   ...
   *
   * <p>The user's name for signature. It is used as the alias name in the keystore to get the
   * user's cert and private key for signature.
   *
   * @return username
   */
   ...
   * Per <a href="http://cxf.apache.org/docs/ws-securitypolicy.html">WS-Security Policy</a>:
   *
   * <p>Location of the crypto property configuration to use for signature.
   *
   ...
   * Per <a href="http://cxf.apache.org/docs/ws-securitypolicy.html">WS-Security Policy</a>:
   *
   * <p>The user's name for encryption. It is used as the alias name in the keystore to get the
   ...
   * Per <a href="http://cxf.apache.org/docs/ws-securitypolicy.html">WS-Security Policy</a>:
   *
   * <p>Location of the crypto property configuration to use for encryption.
   *
   * @return Location of the property file.
   */
   ...
   * Per <a href="http://cxf.apache.org/docs/ws-securitypolicy.html">WS-Security Policy</a>:
   *
   * <p>The alias name in the keystore to get the user's public key to send to the STS for the
   ...
   * Per <a href="http://cxf.apache.org/docs/ws-securitypolicy.html">WS-Security Policy</a>:
   *
   * <p>Location of the crypto property configuration used by the STSClient to send/process any
  ...
  /**
   * Retrieves the assertion type that should be requested from the STS. Default value:
  ...
  /**
   * Sets the assertion type that should be requested from the STS. Default value:
   * http://docs.oasis-open.org/wss/oasis-wss-saml-token-profile-1.1#SAMLV2.0
   *
   * @param assertionType
   */
  ...
  /**
   * Retrieves the key type that should be used when communicating with the STS. Default value:
  ...
  /**
   * Sets the key type that should be used when communicating with the STS. Default value:
   * http://docs.oasis-open.org/ws-sx/ws-trust/200512/PublicKey
   *
   * @param keyType
   */
  ...
  /**
   * Retrieves the size of the key that should be used. Default value: 256
   *
   * @return key size
   */
  ...
  /**
   * Sets the size of the key that should be used. Default value: 256
   *
   * @param keySize
   */
  ...
  /**
   * Flags whether or not to supply a key in the request. Default value: true
   *
  ...
  /**
   * Sets whether or not to supply a key in the request. Default value: true
   *
   * @param useKey
   */
