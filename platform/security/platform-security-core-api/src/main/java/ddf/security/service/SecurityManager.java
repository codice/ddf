...
public interface SecurityManager {
  ...
  /**
   * Exchanges an authentication token for a subject. The {@link Subject} contains a security
   * assertion which can be used to obtain information about the current credentials.
   *
   ...
   * @throws SecurityServiceException if an error occurs during the authentication process
   */
