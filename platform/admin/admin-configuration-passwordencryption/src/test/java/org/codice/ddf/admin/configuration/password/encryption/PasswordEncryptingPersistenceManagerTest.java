...
public class PasswordEncryptingPersistenceManagerTest {
  ...
  public void setup() throws IOException {
    ...
    passwordEncryptingPersistenceManager =
        new PasswordEncryptingPersistenceManager(
            persistenceManager, encryptionService, configurationAdmin);
    ...
    Enumeration enumeration =
        Collections.enumeration(Arrays.asList(encrypted, noPassword, nullPassword));
    ...
    when(objectClassDefinition.getAttributeDefinitions(ObjectClassDefinition.ALL))
        .thenReturn(attributeDefinitions);
    when(configurationAdmin.getObjectClassDefinition(anyString()))
        .thenReturn(objectClassDefinition);
  }
