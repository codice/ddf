...
/**
 * Abstract Profile Command retrieves the {@link ApplicationService}, {@link FeaturesService}, and
 * {@link BundleService}. Provides console styling and common functions for profile commands
 */
public abstract class AbstractProfileCommand implements Action {

  protected static final String PROFILE_EXTENSION = ".json";

  @Reference protected ApplicationService applicationService;

  @Reference protected FeaturesService featuresService;

  @Reference protected BundleService bundleService;
  ...
  /**
   * Execute profile command operations. This should be extended to provide functionality for any of
  ...
  /**
   * Console output styling for a successful operation for a given item formatted as <code>
   * Message: item</code> Note: <code>:</code> will not be added to the message automatically
  ...
  public void printItemStatusFailure(String message, String item) {
    console.print(ansi().fgBlue().a(message).fgRed().a(item).newline().reset());
  }
  ...
  public void printError(String message) {
    console.print(ansi().fgRed().a(message).newline().reset());
  }
  ...
  public void printSuccess(String message) {
    console.print(ansi().fgGreen().a(message).newline().reset());
  }
}
