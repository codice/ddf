...
/**
 * Implementation of an ApplicationNode. This Node is used to help form a hierarchy tree for
...
public class ApplicationNodeImpl implements ApplicationNode, Comparable<ApplicationNode> {
   ...
   *
   * @param parent Application Node that this application depends on.
   */
