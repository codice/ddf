...
public class ApplicationServiceException extends Exception {
  ...
  /**
   * Instantiates a new Application Service Exception with the provided message and {@link
   * Throwable}.
   *
   * @param message the message
  ...
  /**
   * Instantiates a new Application Service Exception with the provided {@link Throwable}.
   *
   * @param throwable the throwable
   */
