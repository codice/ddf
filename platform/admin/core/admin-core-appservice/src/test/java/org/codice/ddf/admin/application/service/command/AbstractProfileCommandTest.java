...
public class AbstractProfileCommandTest {
    ...
    public void testApplicationServiceFailure() throws Exception {
        doThrow(ApplicationServiceException.class).when(applicationService).startApplication(anyString());
    ...
    private AbstractProfileCommand getCommand(ApplicationService applicationService,
                                              FeaturesService featuresService, BundleService bundleService) {
        AbstractProfileCommand command = new AbstractProfileCommand() {

            @Override
            protected void doExecute(ApplicationService applicationService, FeaturesService featuresService, BundleService bundleService) throws Exception {
