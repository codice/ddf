...
public class ApplicationConfigurationPluginTest {
  ...
  /**
   * Will test the abstractconfigurationplugin by creating a new class that extends it, setting
   * values to it and then testing that they are all constructed correctly.
   */
  @Test
