...
public class ZipFileApplicationDetailsTest {
  ...
  /**
   * Tests the {@link ZipFileApplicationDetails#ZipFileApplicationDetails(String, String)}
   * constructor, and the getters related to it
   */
  @Test
  public void testConstructor() {
    ZipFileApplicationDetails testZipFile =
        new ZipFileApplicationDetails(TEST_NAME_1, TEST_VERSION_1);
