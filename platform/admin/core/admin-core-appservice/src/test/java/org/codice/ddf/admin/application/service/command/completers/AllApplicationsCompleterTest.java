...
public class AllApplicationsCompleterTest {
  ...
  /**
   * Tests the {@link AllApplicationsCompleter#complete(String, int, List)} method, and the {@link
   * AllApplicationsCompleter#AllApplicationsCompleter(ApplicationService)} constructor
   */
  @Test
  public void testAllApplicationsCompleter() {
    ...
    assertThat(
        ...
        applicationsCompleter.complete(null, commandLine, new ArrayList<>()),
        is(not(-1)));
  }

  /**
   * Tests the {@link AllApplicationsCompleter#complete(String, int, List)} method for the case
