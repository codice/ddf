...
public class AdminConsoleServiceTest {
    ...
    /**
     * Tests the {@link AdminConsoleService#init()} method for the case where
    ...
    /**
     * Tests the {@link AdminConsoleService#destroy()} method for the case
    ...
    /**
     * Tests the {@link AdminConsoleService#setModuleList(List)}
     * and {@link AdminConsoleService#getModuleList()} methods
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * Tests the {@link AdminConsoleService#createFactoryConfiguration(String)} and
     * {@link AdminConsoleService#createFactoryConfigurationForLocation(String, String)} methods
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * Tests the {@link AdminConsoleService#delete(String)} and
     * {@link AdminConsoleService#deleteForLocation(String, String)} methods
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * Tests the {@link AdminConsoleService#getFactoryPid(String)} and
     * {@link AdminConsoleService#getFactoryPidForLocation(String, String)} methods
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * Tests the {@link AdminConsoleService#getProperties(String)} and
     * {@link AdminConsoleService#getPropertiesForLocation(String, String)} methods
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * Tests the {@link AdminConsoleService#getPropertiesForLocation(String, String)} method
     * for the case where the argument is null
     *
     * @throws Exception
     */
    ...
    /**
     * Tests the {@link AdminConsoleService#setBundleLocation(String, String)}
    ...
    /**
     * Tests the {@link AdminConsoleService#update(String, Map)} and
     * {@link AdminConsoleService#updateForLocation(String, String, Map)} methods
     *
     * @throws Exception
     */
    @Test
    ...
    /**
     * Tests the {@link AdminConsoleService#update(String, Map)} and
     * {@link AdminConsoleService#updateForLocation(String, String, Map)} methods and
     ...
     * for the case where configurationAdminImpl.getConfiguration(servicePid) returns null
     *
     * @throws Exception
     */
    @Test(expected = IOException.class)
    ...
    /**
     * Tests the {@link AdminConsoleService#enableConfiguration(String)} method
     * for the case where configurationAdminImpl.getConfiguration(..) can't
    ...
    private AdminConsoleService getConfigAdmin()
        ...
        ConfigurationAdminImpl configurationAdminImpl = new ConfigurationAdminImpl(
                CONFIGURATION_ADMIN,
                new ArrayList<>()) {
            @Override
