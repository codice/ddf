...
public class AdminAlertImplTest {
    ...
    public void testGetAlerts() throws Exception {
        when(persistentStore.get(eq("alerts"),
                any())).thenReturn(Collections.singletonList(solrMap));
    ...
    public void textGetAlertsEscapedStrings() throws Exception {
        ...
        assertThat(alertList.size(), equalTo(1));
        assertThat(alertList.get(0)
                .get("xss-data"), equalTo("&lt;script&gt;alert(&#39;stuff&#39;)&lt;/script&gt;"));
    }
    ...
    public void testGetAlertsWithSingleDetail() throws Exception {
        ...
        assertThat(alertList.size(), equalTo(1));
        assertThat(alertList.get(0)
                .get(SystemNotice.SYSTEM_NOTICE_DETAILS_KEY), instanceOf(Collection.class));
    }
