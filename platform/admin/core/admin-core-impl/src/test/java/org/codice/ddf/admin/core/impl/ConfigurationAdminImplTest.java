...
public class ConfigurationAdminImplTest {
    ...
    private ConfigurationAdminImpl getConfigurationAdminImpl(ConfigurationAdmin testConfigAdmin,
    ...
    public void testEnableConfigurations() throws Exception {
        ...
        ConfigurationAdminImpl configurationAdminImpl = getConfigurationAdminImpl(testConfigAdmin,
                new ArrayList<>());
        ...
        ConfigurationStatus result =
                configurationAdminImpl.enableManagedServiceFactoryConfiguration(TEST_PID,
                        testConfig);
    ...
    public void testDisableConfiguration() throws Exception {
        ...
        ConfigurationStatus result =
                configurationAdminImpl.disableManagedServiceFactoryConfiguration(TEST_PID,
                        testConfig);
    ...
    /**
     * Tests the {@link ConfigurationAdminImpl#listServices(String, String)} method for the case
    ...
    /**
     * Tests the {@link ConfigurationAdminImpl#listServices(String, String)} and connected methods
    ...
    /**
     * Tests the {@link ConfigurationAdminImpl#listServices(String, String)} method
    ...
    public void testListServicesIOException() throws Exception {
        ...
        List<Service> result = configurationAdminImpl.
    ...
    /**
     * Tests the {@link ConfigurationAdminImpl#getBundle(BundleContext, String)} method
