...
public class AdminConsoleService extends StandardMBean implements AdminConsoleServiceMBean {
    ...
    /**
     * @see AdminConsoleServiceMBean#createFactoryConfigurationForLocation(java.lang.String, java.lang.String)
     */
            ...
            if (configs != null) {
                configs.forEach(config -> {
                    ...
                    Map<String, Object> configProps = (Map<String, Object>) config.get(
                            GuestClaimsHandlerExt.PROPERTIES_KEY);
    ...
    public ConfigurationStatus disableConfiguration(String servicePid) throws IOException {
        ...
        return configurationAdminImpl.disableManagedServiceFactoryConfiguration(servicePid,
                originalConfig);
    }
    ...
    public ConfigurationStatus enableConfiguration(String servicePid) throws IOException {
        ...
        return configurationAdminImpl.enableManagedServiceFactoryConfiguration(servicePid,
                disabledConfig);
    }
