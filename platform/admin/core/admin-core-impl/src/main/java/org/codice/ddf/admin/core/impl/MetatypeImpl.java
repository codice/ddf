...
public class MetatypeImpl extends HashMap<String, Object> implements Metatype {

    public MetatypeImpl(String id, String name, List<MetatypeAttribute> attributeDefinitions) {
        setId(id);
        setName(name);
