...
public class ConfigPidConfigurationPlugin implements ConfigurationPlugin {
   ...
   * Manager), this method is invoked prior to the {@link
   * org.osgi.service.cm.ManagedService#updated(Dictionary)} method to add a configuration PID to
   * the {@code Dictionary}. If the bean that is getting created/modified has a {@code
   * setConfigurationPid(java.lang.String)} method and the ManagedService/ManagedServiceFactory
   ...
   * @param properties The configuration properties. This argument must not contain the
