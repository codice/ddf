...
public class EncryptionPropertiesFileValidator extends CryptoPropertiesFileValidator {
    ...
    protected void validatePrivateKeyPassword(Properties properties) {
        ...
        if (StringUtils.isNotBlank(privateKeyPassword) && StringUtils
                .isNotBlank(defaultPrivateKeyPassword) && StringUtils
                .equals(privateKeyPassword, defaultPrivateKeyPassword)) {
