...
public interface ConfigurationStatus extends Map<String, String> {
  ...
  /**
   * Returns the updated configuration PID after the configuration has been either enabled or
   * disabled. This property is relevant only to managed service factory configurations.
   *
  ...
  /**
   * Returns the updated configuration PID after the configuration has been either enabled or
   * disabled. This property is relevant only to managed service configurations.
   *
   * @return configuration PID
   */
  ...
  /**
   * Returns the original configuration PID after the configuration has been either enabled or
   * disabled. This property is relevant only to managed service configurations.
   *
   * @return configuration PID
   */
