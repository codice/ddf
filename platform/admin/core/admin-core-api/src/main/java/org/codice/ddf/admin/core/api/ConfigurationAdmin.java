...
public interface ConfigurationAdmin {
  ...
  /**
   * Returns the {@link ObjectClassDefinition} associated with the given {@link Configuration}. The
  ...
  /**
   * Returns the complete Metatype with all available information for the provided {@link
   * Configuration}
   *
   ...
   * @throws IOException
   */
  ConfigurationStatus disableManagedServiceFactoryConfiguration(
      String servicePid, Configuration enabledConfig) throws IOException;
