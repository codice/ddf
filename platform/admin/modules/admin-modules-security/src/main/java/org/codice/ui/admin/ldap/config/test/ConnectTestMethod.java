...
import static org.codice.ui.admin.ldap.config.LdapConfiguration.LDAP_ENCRYPTION_METHODS;
...
import static org.codice.ui.admin.ldap.config.test.LdapTestingCommons.LdapConnectionResult.SUCCESSFUL_CONNECTION;
...
import static org.codice.ui.admin.ldap.config.test.LdapTestingCommons.getLdapConnection;
...
public class ConnectTestMethod extends TestMethod<LdapConfiguration> {
    ...
    public TestReport test(LdapConfiguration configuration) {
        ...
        LdapConnectionAttempt connectionAttempt = getLdapConnection(configuration);
