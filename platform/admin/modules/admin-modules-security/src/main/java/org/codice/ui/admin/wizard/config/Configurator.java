...
public class Configurator {
     ...
     * @param properties  the set of key:value pairs to save in the configuration
     ...
     * @param properties the set of key:value pairs to save in the new managed service's configuration
     * @return a lookup key that can be used to correlate this operation in the
     * final {@link ConfigReport}
     */
