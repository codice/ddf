...
import static org.codice.ui.admin.ldap.config.test.BindUserTestMethod.BIND_METHOD;
import static org.codice.ui.admin.ldap.config.test.BindUserTestMethod.BIND_USER_DN;
import static org.codice.ui.admin.ldap.config.test.BindUserTestMethod.BIND_USER_PASSWORD;
...
import static org.codice.ui.admin.ldap.config.test.LdapTestingCommons.LdapConnectionAttempt;
import static org.codice.ui.admin.ldap.config.test.LdapTestingCommons.LdapConnectionResult.BASE_GROUP_DN_NOT_FOUND;
import static org.codice.ui.admin.ldap.config.test.LdapTestingCommons.LdapConnectionResult.BASE_USER_DN_NOT_FOUND;
...
import static org.codice.ui.admin.ldap.config.test.LdapTestingCommons.LdapConnectionResult.FOUND_BASE_GROUP_DN;
import static org.codice.ui.admin.ldap.config.test.LdapTestingCommons.LdapConnectionResult.FOUND_BASE_USER_DN;
import static org.codice.ui.admin.ldap.config.test.LdapTestingCommons.LdapConnectionResult.FOUND_USER_NAME_ATTRIBUTE;
import static org.codice.ui.admin.ldap.config.test.LdapTestingCommons.LdapConnectionResult.NO_GROUPS_IN_BASE_GROUP_DN;
import static org.codice.ui.admin.ldap.config.test.LdapTestingCommons.LdapConnectionResult.NO_USERS_IN_BASE_USER_DN;
import static org.codice.ui.admin.ldap.config.test.LdapTestingCommons.LdapConnectionResult.SUCCESSFUL_BIND;
import static org.codice.ui.admin.ldap.config.test.LdapTestingCommons.LdapConnectionResult.USER_NAME_ATTRIBUTE_NOT_FOUND;
...
import static org.codice.ui.admin.ldap.config.test.LdapTestingCommons.getLdapQueryResults;
