...
public interface Result<T> {
   ...
   *
   * @return status indicating if the operation committed, rolled back, was skipped, or failed to
   *     process correctly
   */
  Status getStatus();

  /**
   * If an exception occurred during processing, this {@code Optional} will contain the exception
   * thrown.
   *
