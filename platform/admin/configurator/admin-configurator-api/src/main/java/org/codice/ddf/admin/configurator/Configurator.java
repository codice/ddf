 ...
 *
 * <p>In order to use, invoke the various {@code start}, {@code stop}, {@code create}, {@code
 * delete}, {@code update}, methods in the intended order of operation, then invoke one of the
 * {@code commit} methods to complete the transaction.
 *
...
public interface Configurator {
   ...
   * committed.
   *
   * <p>After commit is called, this {@code Configurator} should not be used again.
   *
   * <p>In the case of a successful commit, changes should be logged. {@code auditParams} are
