...
public interface ServiceActions {
   ...
   * @param keepIfNotPresent if true, any keys in the current config file that are not in the {@code
   *     configs} map will be left with their initial values; if false, they will be removed from
   *     the file
