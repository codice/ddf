...
public class SolrQueryFilterVisitorTest {
    ...
    public void setup() throws Exception {
        when(solrClient.request(any(), anyString())).thenReturn(namedList);
    ...
    public void testGreaterThan() throws Exception {
        ...
        assertThat(solrQuery.getQuery()
                .trim(), equalTo("property_txt:{ 9 TO * ]"));
    }
    ...
    public void testLessThan() throws Exception {
        ...
        SolrQuery solrQuery = (SolrQuery) filter.accept(solrVisitor, null);
        assertThat(solrQuery.getQuery()
                .trim(), equalTo("property_txt:[ * TO 9 }"));
    }
    ...
    public void testAnd() throws Exception {
        ...
        SolrQuery solrQuery = (SolrQuery) filter.accept(solrVisitor, null);
        assertThat(solrQuery.getQuery()
                .trim(), equalTo("( property_txt:\"val\" AND otherProp_txt:\"val2\" )"));
    }
    ...
    public void testOr() throws Exception {
        ...
        SolrQuery solrQuery = (SolrQuery) filter.accept(solrVisitor, null);
        assertThat(solrQuery.getQuery()
                .trim(), equalTo("( property_txt:\"val\" OR otherProp_txt:\"val2\" )"));
    }
