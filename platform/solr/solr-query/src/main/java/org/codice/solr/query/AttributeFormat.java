...
public enum AttributeFormat {
  ...
  /**
   * {@link Attribute}s of this {@link AttributeFormat} <b>must</b> have a value that implements the
   * {@link java.io.Serializable} interface. Additional processing ( {@link
   ...
   *
   * <p><b>NOTE:</b> In order for classes to be deserialized by a {@link Source}, that class must
   * exist on the classpath of that {@link Source}. This may require additional parameters to be set
