...
/**
 * Class that persists configuration properties using the Felix .config file format. Supports
 * correct runtime type serialization and supports arrays. Not for use with maps or complex data
 * structures.
 */
