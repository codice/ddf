 ...
 *
 * <p>All values are stored as strings. The returned {@link Dictionary} from {@link
 * #read(InputStream)} will always consist of string values that must be separately parsed or
 * processed by the caller, even if they weren't strings when handed to {@link #write(OutputStream,
 * Dictionary)}.
 *
 * <p>Not recommended for use with complex objects such as arrays or maps. Where possible, use
 * .config and {@link ConfigStrategy} instead.
 */
