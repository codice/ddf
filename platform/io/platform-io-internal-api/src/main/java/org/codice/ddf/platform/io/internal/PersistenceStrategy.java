 ...
 *
 * <p><b>This interface should not be used to obtain an arbitrary instance, as implementations may
 * greatly vary, and no data validation is performed to alert the consumer of the service what is or
 * is not supported.</b> Filter results using the {@link #STRATEGY_EXTENSION} service property.
 *
 * <p>This interface is for internal use only.
 *
...
public interface PersistenceStrategy {
  ...
  /**
   * Reads the configuration properties from an {@link InputStream}. The stream will <b>not</b> be
  ...
  /**
   * Writes the configuration properties to an {@link OutputStream}. The stream will <b>not</b> be
   * closed automatically.
   *
