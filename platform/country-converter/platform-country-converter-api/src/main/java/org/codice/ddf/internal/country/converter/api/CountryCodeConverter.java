...
public interface CountryCodeConverter {
  ...
  /**
   * Converts FIPS 10-4 into ISO 3166-1 alpha 3. If a FIPS 10-4 code maps to more than one ISO
   * 3166-1 alpha 3 code, all of them will be returned in a list of strings.
   *
   * @param fipsCountryCode a FIPS 10-4 country code
   * @return an ISO 3166-1 alpha-3 country code in a List<String> or an empty list if there isn't a
   *     valid conversion.
   */
  List<String> convertFipsToIso3(@Nullable String fipsCountryCode);

  /**
   * Converts ISO 3166-1 alpha 3 into FIPS 10-4. If an ISO 3166-1 alpha 3 code maps to more than one
   * FIPS 10-4 code, all of them will be returned in a list of strings.
   *
