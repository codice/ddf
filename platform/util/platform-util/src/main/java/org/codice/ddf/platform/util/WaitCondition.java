...
public class WaitCondition {
    ...
    /**
     * Waits until the value returned by the {@link Callable} returns true or the timeout expires.
     * The wait condition will be re-evaluated every polling interval. If the timeout expires or an
     * exception occurs while waiting, a ${@link TimeoutException}
     *
     * @param condition to wait for until it returns true.
     */
