...
public class PlatformUiConfigurationTest {
    ...
    public void testConfig() throws IOException {
        ...
        assertEquals("image",
                new String(Base64.decodeBase64((String) jsonObject.get(PlatformUiConfiguration.PRODUCT_IMAGE))));
        assertEquals("fav",
                new String(Base64.decodeBase64((String) jsonObject.get(PlatformUiConfiguration.FAV_ICON))));
    }
