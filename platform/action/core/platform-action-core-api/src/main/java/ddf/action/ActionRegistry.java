...
public interface ActionRegistry {
   ...
   *
   * @param subject object in which an {@link Action} can be applied
   * @return all {@link Action} objects that can be applied from the given input, otherwise an empty
   *     list if no actions can be applied.
   */
