...
public class MetricsEndpointTest extends XMLTestCase
{
    ...
    public void testGetMetricsGraphPositiveCase() throws Exception
    {
        ...
        MetricsEndpoint endpoint = new MetricsEndpoint();
        endpoint.setMetricsDir(TEST_DIR);
        Response response = endpoint.getMetricsData("uptime", "png", 
            "2013-03-25T06:00:00-07:00", "2013-03-25T07:10:00-07:00", null, 
    ...
    public void testGetMetricsGraphPositiveCaseWithDefaults() throws Exception
    {
        ...
        endpoint.setMetricsDir(TEST_DIR);
        Response response = endpoint.getMetricsData("uptime", "png", 
            null, null, null, null, null, uriInfo);
    ...
    @Test //(expected = MetricsEndpointException.class)
    ...
    {        
        ...
        try
        {
            endpoint.getMetricsData("uptime", "png", 
                "2013-03-25T06:00:00-07:00", "2013-03-25T07:10:00-07:00", "3600", 
                "my label", "my title", uriInfo);
            fail();
        }
    ...
    public void testGetMetricsDataAsXml() throws Exception
    {
        ...
        Response response = endpoint.getMetricsData("uptime", "xml", 
            null, null, Integer.toString(dateOffset), 
            "my label", "my title", uriInfo);
    ...
    public void testGetMetricsDataAsCsv() throws Exception
    {
        ...
        Response response = endpoint.getMetricsData("uptime", "csv", 
            null, null, Integer.toString(dateOffset), 
            "my label", "my title", uriInfo);
    ...
    public void testGetMetricsDataAsXls() throws Exception
    {
        ...
        Response response = endpoint.getMetricsData("uptime", "xls", 
            null, null, Integer.toString(dateOffset), 
            "my label", "my title", uriInfo);
        ...
        // Expect 7 rows: title + blank + column headers + 2 rows of samples + blank + totalQueryCount
    ...
    public void testGetMetricsDataAsPpt() throws Exception
    {
        ...
        Response response = endpoint.getMetricsData("uptime", "ppt", 
            null, null, Integer.toString(dateOffset), 
            "my label", "my title", uriInfo);
    ...
    public void testGetMetricsDataAsJson() throws Exception
    {
        ...
        Response response = endpoint.getMetricsData("uptime", "json", 
            null, null, Integer.toString(dateOffset), 
            "my label", "my title", uriInfo);
    ...
    public void testGetMetricsReportAsXls() throws Exception
    {
        ...
        Response response = endpoint.getMetricsReport("xls", 
            null, null, Integer.toString(dateOffset), uriInfo);
...
/*******************************************************************************/    
    ...
    private void verifyException(String format, Class exceptionClass) throws Exception
    {
        ...
        try
        {
            Response response = endpoint.getMetricsData("uptime", format, 
                null, null, "900", "my label", "my title", uriInfo);
            fail();
        }
        catch (MetricsEndpointException e)
        {            
