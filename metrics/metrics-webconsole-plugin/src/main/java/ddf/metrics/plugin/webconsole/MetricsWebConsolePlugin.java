 ...
 * display an each metrics collected data in various formats, including PNG graph, CSV, Excel spreadsheet,
...
public class MetricsWebConsolePlugin extends AbstractWebConsolePlugin
{
    ...
    /**
     * Renders the Metrics tab in the Admin GUI console. Retrieves the list of all metrics being collected
     * in the system by invoking the {@link MetricsEndpoint}, and then parsing this JSON response
     * to create the table in the Metrics tab that consists of the list of metric names and hyperlinks
     * for each format for each time range that a metric's data can be retrieved.
     */
        ...
        throws ServletException, IOException 
    {
        ...
        try
        {
            ...
            // String4 = hyperlink for metric data in specific format, e.g., http://host:port/.../catalogQueries.png?dateOffset=900
            Map<String,Map<String,Map<String,String>>> json = new TreeMap((Map<String,Map<String,Map<String,String>>>) parser.parse(metricsList, containerFactory));
            ...
            while (iter.hasNext())
            {
                ...
                Map<String,Map<String,String>> timeRangeData = (Map<String,Map<String,String>>) entry.getValue();
            ...
            while (iter.hasNext())
            {
                ...
                while (metricDataIter.hasNext())
                {
                    ...
                    // For each time range (for each metric), a list of display text and its associated hyperlink
                    ...
                    while (metricUrlsIter.hasNext())
                    {
                        ...
                        String metricUrlCell = "<a class=\"ui-state-default ui-corner-all\" href=\"" + metricUrl.getValue() + "\">" + 
                                               metricUrl.getKey() + "</a>&nbsp;";
            ...
            pw.println("</tr>");            
            addWeeklyReportUrls(pw, 4, metricsServiceUrl);
            ...
            pw.println("</tr>");            
            addMonthlyReportUrls(pw, 12, metricsServiceUrl);
            ...
            pw.println("</tr>");            
            addYearlyReportUrls(pw, 1, metricsServiceUrl);
