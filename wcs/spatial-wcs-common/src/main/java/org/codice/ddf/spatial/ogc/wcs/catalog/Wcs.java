...
public interface Wcs {
    ...
    WCSCapabilitiesType getCapabilities(@QueryParam("") GetCapabilitiesRequest request) throws
            WcsException;
    ...
    @Consumes({MediaType.TEXT_XML, MediaType.APPLICATION_XML})
    @Produces({MediaType.TEXT_XML, MediaType.APPLICATION_XML})
    CoverageDescription describeCoverage(@QueryParam("") DescribeCoverageRequest request) throws
            WcsException;
    ...
    @GET
    @Consumes({MediaType.TEXT_XML, MediaType.APPLICATION_XML})
    GetCoverageResponse getCoverage(@QueryParam("") GetCoverageRequest request) throws WcsException;
