...
public class TestMimeTypeToTransformerMapperImpl {
    ...
    /**
	 * We expect an empty services list to be returned when no bundleContext is
	 * provided
	 * 
	...
	/**
	 * We expect an empty services list to be returned when no services have
	 * been registered in the service registry
	 * 
	 * @throws MimeTypeParseException
	...
	public void testEmptyServiceList() throws MimeTypeParseException, InvalidSyntaxException {
		...
		MimeTypeToTransformerMapper matcher = new MimeTypeToTransformerMapperImpl(context);
		List<InputTransformer> matches = matcher.findMatches(InputTransformer.class, new MimeType(MediaType.APPLICATION_ATOM_XML));
	...
	/**
	 * We expect to receive all the services to be returned when the user does
	 * not provide any mime types
	 * 
	 * @throws MimeTypeParseException
	 * @throws InvalidSyntaxException 
	 */
	...
	/**
	 * We expect to receive all the services to be returned which is in this
	 * case an empty list.
	 * 
	 * @throws MimeTypeParseException
	 * @throws InvalidSyntaxException 
	 */
	@Test
	public void testNullMimeTypeWithEmptyServiceList() throws MimeTypeParseException, InvalidSyntaxException {
	...
	public void testNoMatch() throws MimeTypeParseException, InvalidSyntaxException {
		...
		when(context.getServiceReferences(isA(String.class), isNull(String.class))).thenReturn(refs);
		MimeTypeToTransformerMapper matcher = new MimeTypeToTransformerMapperImpl(context);
		List<InputTransformer> matches = matcher.findMatches(InputTransformer.class, new MimeType(MediaType.APPLICATION_XML));
	 ...
	 */
	@Test
	public void testNoMatch_InputTransformerBaseTypeAndId() throws MimeTypeParseException, InvalidSyntaxException {
	 ...
	 */
	@Test
	public void testBaseTypeMatch_IdMismatch() throws MimeTypeParseException, InvalidSyntaxException {
		...
		when(context.getServiceReferences(isA(String.class), isNull(String.class))).thenReturn(refs);
		MimeTypeToTransformerMapper matcher = new MimeTypeToTransformerMapperImpl(context);
		List<InputTransformer> matches = matcher.findMatches(InputTransformer.class, new MimeType(MediaType.APPLICATION_ATOM_XML+"; id=a2"));
	...
	/**
	 * Tests if a basetype matches that the list will return the correct sorted
	 * list.
	 * 
	 * @throws MimeTypeParseException
	 * @throws InvalidSyntaxException 
	...
	public void testOnlyBaseTypeMatch() throws MimeTypeParseException, InvalidSyntaxException {
		...
		when(context.getServiceReferences(isA(String.class), isNull(String.class))).thenReturn(refs);
		MimeTypeToTransformerMapper matcher = new MimeTypeToTransformerMapperImpl(context);
		List<InputTransformer> matches = matcher.findMatches(InputTransformer.class, new MimeType(MediaType.APPLICATION_JSON));
	...
	public void testSingleIdMatch() throws MimeTypeParseException, InvalidSyntaxException {
		...
		when(context.getServiceReferences(isA(String.class), isNull(String.class))).thenReturn(refs);
		MimeTypeToTransformerMapper matcher = new MimeTypeToTransformerMapperImpl(context);
		List<InputTransformer> matches = matcher.findMatches(InputTransformer.class, new MimeType(MediaType.APPLICATION_JSON + "; id=a1"));
	...
	/**
	 * Tests the case where the ServiceReference Properties does not have a list
	 * of MimeTypes, instead it provides a single String for the MimeType
	 * 
	 * @throws MimeTypeParseException
	 * @throws InvalidSyntaxException 
	 */
	...
	@Test
	public void testInvalidMimeTypeServicePropertyWithMatch() throws MimeTypeParseException, InvalidSyntaxException {
