...
/**
 * DDF custom mime type resolution packaged as a {@link MimeTypeResolver} OSGi service that can 
 * map a list of custom file extensions to their corresponding custom mime types, and vice versa.
...
{
    private static XLogger logger = new XLogger( LoggerFactory.getLogger( CustomMimeTypeResolver.class ) );
    ...
    public void setCustomMimeTypes( String[] customMimeTypes )
    {
        ...
        for ( String mimeTypeMapping : this.customMimeTypes )
        {
            ...
            {
                logger.info( "Creating fileExtensions array for mime type: " + mimeType );
                fileExtensions = new ArrayList<String>();
            }
            logger.info( "Adding file extension: " + fileExtension + " for mime type: " + mimeType );
    ...
    public String getFileExtensionForMimeType( String mimeType ) //throws MimeTypeException
    {
        ...
        if ( mimeType != null && !mimeType.isEmpty() )
        {
            ...
            {
                logger.debug( "Found " + fileExtensions.size() + " file extensions found for mime type = " + mimeType );
