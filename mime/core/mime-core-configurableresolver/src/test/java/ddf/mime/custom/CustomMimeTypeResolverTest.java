...
public class CustomMimeTypeResolverTest
{
    ...
    public void testGetCustomFileExtensionsToMimeTypesMap()
    {
        ...
        Map<String,String> fileExtensionsToMimeTypes = resolver.getCustomFileExtensionsToMimeTypesMap();
    ...
    public void testGetCustomMimeTypesToFileExtensionsMap()
    {
        ...
        Map<String,List<String>> mimeTypesToFileExtensions = resolver.getCustomMimeTypesToFileExtensionsMap();
