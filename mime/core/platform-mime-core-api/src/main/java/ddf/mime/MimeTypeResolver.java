...
public interface MimeTypeResolver {
    ...
    /**
     * Gets the file extension for the specific mime type. For example, if the mime type is
     * image/nitf a file extension of .nitf would be returned. The mapping of file extensions to
     * mime types is part of the configuration of a MimeTypeResolver.
     * 
     * @param contentType
     *            the mime type
     ...
     * 
     * @param fileExtension
     *            the file extension without the period in it
