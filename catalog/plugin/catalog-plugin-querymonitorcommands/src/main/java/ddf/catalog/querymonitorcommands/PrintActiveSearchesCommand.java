...
import ddf.catalog.querymonitor.ActiveSearch;
import ddf.catalog.querymonitor.QueryMonitorPlugin;

@Command(scope = "catalog", name = "printactivesearches", description = "Prints a summary of all ActiveSearches currently in the QueryMonitor")
@Service
public class PrintActiveSearchesCommand implements Action {
    ...
    @Reference
    private QueryMonitorPlugin queryMonitor = null;
    ...
    /**
     * Method to implement {@link Action}. Called when the catalog:printacticesearches command is called by the shell.
     * Prints out a formatted table representing a {@link QueryMonitorPlugin}'s {@link ActiveSearch} {@link Map}.
     *
    ...
    /**
     * Helper method called by the execute method when the catalog:printacticesearches command is called by the shell.
     * Prints the {@link String} message using the specified {@link org.fusesource.jansi.Ansi.Color}
     */
    ...
    void printActiveSearchesToConsole() {
        ...
        console.println();
        String colorString = Ansi.ansi()
                .fg(Ansi.Color.CYAN)
                .toString();
        console.print(colorString);
        console.print(String.format(FORMAT_STRING,
                "User Info",
                "Source",
                "Search Criteria",
                "Start Time",
