...
public class CatalogPolicyTest {
    ...
    public void testParseEmptyCreatePermissions() throws Exception {
        ...
        assertThat(policyPlugin.getCreatePermissionMap()
                .size(), equalTo(0));
    }
    ...
    public void testParseEmptyUpdatePermissions() throws Exception {
        ...
        assertThat(policyPlugin.getUpdatePermissionMap()
                .size(), equalTo(0));
    }
    ...
    public void testParseEmptyDeletePermissions() throws Exception {
        ...
        assertThat(policyPlugin.getDeletePermissionMap()
                .size(), equalTo(0));
    }
    ...
    public void testParseEmptyReadPermissions() throws Exception {
        ...
        assertThat(policyPlugin.getReadPermissionMap()
                .size(), equalTo(0));
    }
    ...
    public void testPostResources() throws StopProcessingException {
        ...
        PolicyResponse response = policyPlugin.processPostResource(resourceResponse,
                mock(Metacard.class));
        assertThat(response.itemPolicy()
                .size(), equalTo(0));
        assertThat(response.operationPolicy()
    ...
    public void testPreCreate() throws StopProcessingException {
        policyPlugin.setCreatePermissions(new String[] {"role=admin"});
        PolicyResponse response = policyPlugin.processPreCreate(mock(Metacard.class),
                new HashMap<>());
        assertThat(response.itemPolicy()
                .size(), equalTo(0));
        assertThat(response.operationPolicy()
    ...
    public void testPreUpdate() throws StopProcessingException {
        ...
        PolicyResponse response = policyPlugin.processPreUpdate(mock(Metacard.class),
                new HashMap<>());
        assertThat(response.itemPolicy()
                .size(), equalTo(0));
        assertThat(response.operationPolicy()
                .size(), equalTo(1));
        response = policyPlugin.processPreUpdate(mock(Metacard.class),
                Collections.singletonMap(Constants.LOCAL_DESTINATION_KEY, false));
        assertThat(response.itemPolicy()
                .size(), equalTo(0));
        assertThat(response.operationPolicy()
    ...
    public void testPreDelete() throws StopProcessingException {
        ...
        assertThat(response.operationPolicy()
                .size(), equalTo(1));
        response = policyPlugin.processPreDelete(new ArrayList<>(),
                Collections.singletonMap(Constants.LOCAL_DESTINATION_KEY, false));
        assertThat(response.itemPolicy()
                .size(), equalTo(0));
        assertThat(response.operationPolicy()
    ...
    public void testPreQuery() throws StopProcessingException {
        ...
        assertThat(response.operationPolicy()
                .size(), equalTo(1));
        response = policyPlugin.processPreQuery(mock(Query.class),
                Collections.singletonMap(Constants.LOCAL_DESTINATION_KEY, false));
        assertThat(response.itemPolicy()
                .size(), equalTo(0));
        assertThat(response.operationPolicy()
