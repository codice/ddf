	...
	private List<String> getSortedAttributesList(XMLStreamReader2 xmlStreamReader) {
		...
		for (int i = 0; i < xmlStreamReader.getAttributeCount(); i++) {
			...
			attributeBuffer.append((attributePrefix != null) ? attributePrefix : "")
					.append((attributePrefix != null) ? ":" : "").append(xmlStreamReader.getAttributeLocalName(i))
					.append("=").append(DOUBLE_QUOTE).append(xmlStreamReader.getAttributeValue(i)).append(DOUBLE_QUOTE);
