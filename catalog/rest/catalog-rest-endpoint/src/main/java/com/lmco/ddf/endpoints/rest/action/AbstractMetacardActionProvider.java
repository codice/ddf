...
public abstract class AbstractMetacardActionProvider implements ActionProvider, DdfConfigurationWatcher {
    ...
    abstract protected Action getAction(String metacardId, String metacardSource);
    ...
    public void ddfConfigurationUpdated(Map configuration) {
    	...
    	if (configuration != null) {
    		...
    		Object serviceContextMapValue = configuration.get(DdfConfigurationManager.SERVICES_CONTEXT_ROOT);
