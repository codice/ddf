 ...
 */
package org.codice.ddf.intrigue.query.cql;
...
public class CqlResultTest {
    ...
    private void distanceCheck(Double input, Double output) {
        ...
        QueryRequest request = new QueryRequestImpl(new QueryImpl(filterBuilder.attribute("test")
                .equalTo()
                .text("value")));
        CqlResult cqlResult = new CqlResult(result,
                null,
                request,
                false,
                filterAdapter,
