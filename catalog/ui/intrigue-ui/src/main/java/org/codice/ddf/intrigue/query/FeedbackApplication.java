 ...
 */
package org.codice.ddf.intrigue.query;
...
import org.codice.ddf.intrigue.config.ConfigurationApplication;
import org.codice.ddf.intrigue.query.feedback.FeedbackRequest;
...
public class FeedbackApplication implements SparkApplication {
    ...
    private static FeedbackRequest parseFeedbackRequest(String json) {
        ...
        if (searchStatus != null) {
            feedbackRequest.setQueryStatus(searchStatus.stream()
                    .map(Object::toString)
    ...
    private void initConfigurationAppValues(boolean reinit) {
        ...
        if (reinit || subjectTemplate == null || bodyTemplate == null) {
            if (configurationApplication != null) {
                ...
                String subjectTemplateStr =
                        configurationApplication.getQueryFeedbackEmailSubjectTemplate();
                String bodyTemplateStr =
                        configurationApplication.getQueryFeedbackEmailBodyTemplate();
