...
define([
    ...
    return Marionette.ItemView.extend({
        ...
        loadData: function() {
            ...
            var self = this;
            setTimeout(function() {
                $.when($.get('/intrigue/internal/metacard/' + self.model.get('metacard').id + '/attribute/validation').then(function(response) {
                    self._attributeValidation = response;
                }), $.get('/intrigue/internal/metacard/' + self.model.get('metacard').id + '/validation').then(function(response) {
