...
define([
    ...
    return Marionette.ItemView.extend({
        ...
        loadData: function(){
            ...
            var self = this;
            setTimeout(function(){
                $.get('/intrigue/internal/history/'+self.model.get('metacard').get('id')).then(function(response){
        ...
        revertToSelectedVersion: function(){
            LoadingCompanionView.beginLoading(this);
            var self = this;
            $.get('/intrigue/internal/history/revert/'+this.model.get('metacard').get('id')+'/'+selectedVersion).then(function(){
