...
module.exports = Marionette.LayoutView.extend({
    ...
    getAssociations: function() {
        ...
        $.get('/intrigue/internal/associations/' + this.model.get('metacard').get('id')).then(function(response) {
    ...
    handleSave: function() {
        ...
        $.ajax({
            url: '/intrigue/internal/associations/' + this.model.get('metacard').get('id'),
