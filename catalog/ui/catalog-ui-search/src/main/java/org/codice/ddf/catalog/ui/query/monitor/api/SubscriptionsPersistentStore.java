...
public interface SubscriptionsPersistentStore {
  ...
  /**
   * Associate an email address with an ID. Adding an email that is already assoicated with an ID is
   * a no-op.
   *
   * @param id must be non-null and non-blank
  ...
  /**
   * Remove a set of emails that have been associated with an ID. Removing an email that is not
  ...
  /**
   * Remove an email that has been associated with an ID. Removing an email that is not associated
   * with an ID is a no-op.
   *
   * @param id must be non-null and non-blank
