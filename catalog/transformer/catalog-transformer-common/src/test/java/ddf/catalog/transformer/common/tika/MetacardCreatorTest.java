...
public class MetacardCreatorTest {
  ...
  public void testNoMetadata() {
    ...
    assertThat(metacard.getAttribute(Core.CREATED).getValue(), nullValue());
    assertThat(metacard.getAttribute(Core.MODIFIED).getValue(), nullValue());
  ...
  private Metacard createTestMetacard(Set<AttributeDescriptor> extraAttributes) {
    ...
    assertThat(convertDate((Date) metacard.getAttribute(Core.CREATED).getValue()), is(created));
    assertThat(convertDate((Date) metacard.getAttribute(Core.MODIFIED).getValue()), is(modified));
