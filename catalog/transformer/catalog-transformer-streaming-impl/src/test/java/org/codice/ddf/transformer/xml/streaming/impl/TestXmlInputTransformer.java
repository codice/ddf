...
public class TestXmlInputTransformer {
    ...
    public void testNormalTransform() throws FileNotFoundException, CatalogTransformerException {
        ...
        assertThat(metacard.getAttribute(Metacard.POINT_OF_CONTACT)
                .getValues()
                .get(0), is("POC!"));
        assertThat(metacard.getAttribute(Metacard.RESOURCE_URI)
                .getValues()
                .size(), is(1));
        assertThat(metacard.getAttribute(Metacard.RESOURCE_URI)
                .getValues()
     ...
     */
    @Test
    public void testConfiguredTransform()
        ...
        assertThat(factory.getXmlToMetacardMapping()
                .equals(xmlToMetacard), is(true));
        ...
        assertThat(metacard.getAttribute(Metacard.RESOURCE_URI)
                .getValues()
                .get(0), is("foobar"));
        assertThat(metacard.getAttribute(Metacard.CONTENT_TYPE)
                .getValues()
                .size(), is(1));
        assertThat(metacard.getAttribute(Metacard.CONTENT_TYPE)
                .getValues()
                .get(0), is("ddf.metacard"));
    ...
    public void testBadGHTransform()
        ...
        doThrow(new SAXException()).when(gh)
