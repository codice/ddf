...
public class XsltBundleObserver<T extends AbstractXsltTransformer>
  ...
  public XsltBundleObserver(
      BundleContext bundleContext, Class<T> transformerClass, String publishedInterface) {
  ...
  private String capitalize(String format) {
    ...
    return new StringBuilder(format.substring(0, 1).toUpperCase())
        .append(format.substring(1))
        .toString();
  }
}
