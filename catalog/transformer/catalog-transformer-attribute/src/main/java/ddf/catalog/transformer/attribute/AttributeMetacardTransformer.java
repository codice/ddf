...
public class AttributeMetacardTransformer implements MetacardTransformer {
   ...
   *
   * @param attributeName The name of the attribute that will be used to retrieve the value within
   *     the {@link Metacard}
   * @param id the {@link MetacardTransformer} id
  ...
  public BinaryContent transform(Metacard metacard, Map<String, Serializable> arguments)
    ...
    if (metacard == null) {
      throw new CatalogTransformerException(
          "No attribute [" + attributeName + "] found in Metacard.");
    }
