...
public abstract class AbstractXmlTransformer {
    ...
    static {
        try {
            ...
            CONTEXT_PATH.add(MetacardElement.class.getPackage()
                    .getName());
            CONTEXT_PATH.add(AdaptedMetacard.class.getPackage()
                    .getName());
            CONTEXT_PATH.add(AbstractGeometryType.class.getPackage()
                    .getName());
