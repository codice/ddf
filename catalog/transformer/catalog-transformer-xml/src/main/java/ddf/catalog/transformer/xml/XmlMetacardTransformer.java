...
public class XmlMetacardTransformer extends AbstractXmlTransformer implements
		MetacardTransformer {

	
	private static final Logger LOGGER = Logger
			.getLogger(XmlMetacardTransformer.class);
	...
	public BinaryContent transform(Metacard metacard,
		...
		if (metacard == null) {
			...
			throw new CatalogTransformerException(
					"Unable to transform null metacard");
		}
		...
		try {
			...
			try {
				...
				throw new CatalogTransformerException("Failed Transformation",
						e);
			}
			...
			throw new CatalogTransformerException("Failed JAXB Transformation",
					e);
