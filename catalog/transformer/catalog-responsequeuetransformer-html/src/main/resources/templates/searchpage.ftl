...
<body>
	...
	<div id="aboutModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		...
		<div class="modal-body" id="about_content" style='padding:10px; background:#fff;'>
			...
			Copyright (c) Codice Foundation<p>
			This is free software: you can redistribute it and/or modify it under the terms of the GNU Lesser General Public License as published by the Free Software Foundation, either version 3 of the License, or any later version. <p>
			...
			See the GNU Lesser General Public License for more details. A copy of the GNU Lesser General Public License is distributed along with this program and can be found at http://www.gnu.org/licenses/lgpl.html.<p>
	
			Powered by:<p>
			<a href="http://twitter.github.com/bootstrap">Bootstrap</a><p>
			<a href="http://glyphicons.com/">GlyphIcons</a><p>
		</div>
