...
public class TestZipValidator {
  ...
  private static final String MODIFIED_EXISTING_FILE_ZIP_PATH =
      TestZipCompression.class.getClassLoader().getResource(MODIFIED_EXISTING_FILE_ZIP).getPath();
  ...
  public void setUp() {
    ...
    zipValidator.setSignaturePropertiesPath(
        TestZipValidator.class.getResource("/signature.properties").getPath());
    zipValidator.init();
  }
