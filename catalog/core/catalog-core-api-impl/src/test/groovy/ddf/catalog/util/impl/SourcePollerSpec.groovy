...
class SourcePollerSpec extends Specification {
    ...
    private static final SMALL_TIMEOUT_TIME_UNIT = TimeUnit.MILLISECONDS
    ...
    def setup() {
        ...
        sourcePoller = new SourcePoller(sourceAvailabilityChecksThreadPool, pollAllSourcesThreadPool, SMALL_POLL_INTERVAL, SMALL_POLL_INTERVAL_TIME_UNIT, SMALL_TIMEOUT, SMALL_TIMEOUT_TIME_UNIT)
    }
