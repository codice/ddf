...
public class CatalogEndpointImplTest {
    ...
    private Map<String, String> getTestEndpointPropertiesWithDefaults() {
        ...
        endpointPropertiesWithDefaults.put(CatalogEndpointImpl.BINDING_TYPE_KEY,
                DEFAULT_BINDING_TYPE);
        endpointPropertiesWithDefaults.put(CatalogEndpointImpl.DESCRIPTION_KEY,
                DEFAULT_DESCRIPTION);
        ...
        endpointPropertiesWithDefaults.put(CatalogEndpointImpl.URL_BINDING_NAME_KEY,
    ...
    private void assertEndpointPropertiesContainDefaults(Map<String, String> endpointProperties) {
        ...
        assertEquals("Url Binding Name",
                DEFAULT_URL_BINDING_NAME,
                endpointProperties.get(CatalogEndpointImpl.URL_BINDING_NAME_KEY));
        assertEquals("Version",
                DEFAULT_VERSION,
                endpointProperties.get(CatalogEndpointImpl.VERSION_KEY));
    }
}
