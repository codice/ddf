...
public class TestTypeAttributes {
    ...
    public void testContactAttributes() {
        ...
        assertThat(CONTACT_ATTRIBUTES.getAttributeDescriptor(Contact.CONTRIBUTOR_ADDRESS),
                notNullValue());
    ...
    public void testValidationAttributes() {
        ...
        assertThat(VALIDATION_ATTRIBUTES.getAttributeDescriptor(Validation.VALIDATION_ERRORS),
                notNullValue());
    ...
    public void testAssociationsAttributes() {
        ...
        assertThat(ASSOCIATIONS_ATTRIBUTES.getAttributeDescriptor(Associations.DERIVED),
                notNullValue());
