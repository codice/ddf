...
/**
 * This class provides attributes that reflect metadata about the metacard itself.
 * This includes created and modified dates.
 */
public class MetacardAttributes implements Metacard, MetacardType {

    private static final Set<AttributeDescriptor> DESCRIPTORS = new HashSet<>();

    private static final String NAME = "metacard";
    ...
    static {
        ...
        DESCRIPTORS.add(new AttributeDescriptorImpl(MODIFIED,
                ...
                false /* multivalued */,
                BasicTypes.DATE_TYPE));
        DESCRIPTORS.add(new AttributeDescriptorImpl(OWNER,
                true /* indexed */,
                true /* stored */,
                true /* tokenized */,
                true /* multivalued */,
        ...
        DESCRIPTORS.add(new AttributeDescriptorImpl(PERMISSIONS,
                true /* indexed */,
                true /* stored */,
                true /* tokenized */,
                true /* multivalued */,
