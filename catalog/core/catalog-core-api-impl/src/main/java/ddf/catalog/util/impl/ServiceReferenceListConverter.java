 ...
 * {@link java.util.List} implementations. This was originally intended to allow plugins to be
...
public class ServiceReferenceListConverter implements Converter {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(ServiceReferenceListConverter.class);
