 ...
 *
 * <p>This class does not have a custom serialization implementation (like some other API classes
 * such as {@link AttributeImpl}) because its physical representation is the same as its logical
...
public class AttributeDescriptorImpl implements AttributeDescriptor {
   ...
   * Constructor
   *
   * @param name - the name of this {@link AttributeDescriptor}
   * @param indexed - whether {@link ddf.catalog.data.Attribute} values using this {@link
   *     AttributeDescriptor} should be indexed
   * @param stored - whether {@link ddf.catalog.data.Attribute} values using this {@link
   *     AttributeDescriptor} should be stored
   * @param tokenized - whether {@link ddf.catalog.data.Attribute} values using this {@link
   *     AttributeDescriptor} should be tokenized
   * @param multivalued whether {@link ddf.catalog.data.Attribute} values using this {@link
   *     AttributeDescriptor} are multivalued
   * @param type - the type of this {@link AttributeDescriptor}
