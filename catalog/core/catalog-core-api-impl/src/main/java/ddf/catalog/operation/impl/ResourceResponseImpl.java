...
public class ResourceResponseImpl extends ResponseImpl<ResourceRequest>
  ...
  /**
   * Instantiates a new ResourceResponseImpl from the given {@link ResourceRequest} and {@link
   * Resource}.
   *
  ...
  /**
   * Instantiates a new ResourceResponseImpl from the {@link ddf.catalog.operation.Request}, {@link
   * Map}, and {@link Resource}
   *
  ...
  public ResourceResponseImpl(
      ResourceRequest request, Map<String, Serializable> properties, Resource resource) {
