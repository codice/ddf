...
/**
 * The DeleteRequestImpl class is used to delete a single or list of the {@link String} id or {@link
 * URI}.
 */
public class DeleteRequestImpl extends OperationImpl implements DeleteRequest {
  ...
  /**
   * Instantiates a new DeleteRequestImpl with a {@link URI} array with a {@link Map} of properties
   *
