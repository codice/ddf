...
/**
 * This converter is used to allow {@link DescribableServiceMap} objects to pass through for {@link
 * java.util.Map} implementations. Without this converter, blueprint will copy the map and lose the
 * reference.
 */
