...
/**
 * Functional interface used to abstract away methods that take in a {@link QueryRequest} and return
 * a {@link SourceResponse}. Used by classes such as {@link ResultIterable} to support interfaces
 * other than {@link ddf.catalog.CatalogFramework}.
 */
@FunctionalInterface
public interface QueryFunction {
   ...
   *     evaluated by this {@link ddf.catalog.CatalogFramework} or any of its {@link
