...
public class ValidationExceptionImpl extends ValidationException {
  ...
  /**
   * Constructs a {@code ValidationException} with a specified summary message of the failure and
   ...
   * @param warnings list of human readable warning messages
   */
  public ValidationExceptionImpl(
      String summaryMessage, List<String> errors, List<String> warnings) {
    super(summaryMessage);
    setErrors(errors);
   ...
   */
  public ValidationExceptionImpl(
      String summaryMessage, Throwable cause, List<String> errors, List<String> warnings) {
    super(summaryMessage, cause);
    setErrors(errors);
    setWarnings(warnings);
  }
  ...
  /**
   * @param errors Applies a list of all the error messages that have caused validation to fail. The
   *     error messages should be human-readable plain text.
   */
  ...
  /**
   * @param warnings Applies a list of warnings messages to this exception. Warning messages are
   *     issues that arose during validation but did not cause validation to fail. A warning message
