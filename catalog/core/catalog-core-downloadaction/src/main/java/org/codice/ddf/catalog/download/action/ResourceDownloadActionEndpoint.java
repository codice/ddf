...
public class ResourceDownloadActionEndpoint {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ResourceDownloadActionEndpoint.class);
    ...
    public ResourceDownloadActionEndpoint(Handlebars handlebars) {
        ...
        try {
            ...
            String message = String.format("Unable to compile handlebars template [%s].",
     ...
     */
    @GET
    public Response copyToLocalSite(@FormParam(SOURCE_PARAM) String sourceId,
            @FormParam(METACARD_PARAM) String metacardId)
        ...
        try {
            ...
            return Response.ok(generateHtmlResponse(SUCCESS_MESSAGE))
                    .build();
    ...
    private String generateHtmlResponse(String message) {
        try {
            ...
            throw new DownloadToLocalSiteException(Status.INTERNAL_SERVER_ERROR,
    ...
    ResourceDownloadMBean createResourceDownloadMBeanProxy() {
        try {
            ...
            String message = String.format("Unable to create MBean proxy for [%s].",
                    ResourceDownloadMBean.class.getName());
