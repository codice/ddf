...
public class ResourceDownloadActionProviderCanHandleTest {
    ...
    @Mock
    private ResourceCacheServiceMBean mockResourceCacheServiceMBeanProxy;
    ...
    public ResourceDownloadActionProviderCanHandleTest(String siteName, String resourceUri,
            String metacardId, boolean isMetacardResourceCached, boolean expectedCanHandle) {
    ...
    public void setup() {
        ...
        actionProvider = new ResourceDownloadActionProvider(ACTION_PROVIDER_ID) {
            @Override
