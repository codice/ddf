...
/**
 * Camel Consumer Post Ingest plugin used to provide the responses passed to Post Ingest Plugins
 * to camel routes.
 */
public class PostIngestConsumer extends DefaultConsumer implements PostIngestPlugin {
    ...
    private ExecutorService threadExecutor = new ThreadPoolExecutor(NUM_THREADS,
            NUM_THREADS,
            0L,
