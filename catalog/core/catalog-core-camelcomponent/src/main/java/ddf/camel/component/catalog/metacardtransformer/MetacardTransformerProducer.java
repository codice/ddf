...
/**
 * Camel Producer that will transform a metacard from the body, using the transformer id provided
 * in the route header and set the outgoing body as the transformed data.
 */
    ...
    public void process(Exchange exchange) throws Exception {
        ...
        if (incomingData instanceof Metacard) {
            ...
            if (transformerId != null) {
                ...
                LOGGER.debug("metacard transformer id not present in: {} parameter",
                        TRANSFORMER_ID);
            }
        }
        ...
        if (transformedData != null) {
            exchange.getOut()
                    .setBody(transformedData.getByteArray());
        } else  {
