...
public class CustomFtpletTest {
    ...
    public void setUp() {
        ...
        ftplet = new CustomFtplet(catalogFramework, mimeTypeMapper);
    }
    ...
    public void testMimeTypeMapperNull() {
        ...
        CustomFtplet ftplett = new CustomFtplet(catalogFramework, mimeTypeMapper);
