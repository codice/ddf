...
/**
 * Encapsulates all necessary information to identify a single subscription within the {@link
...
public interface SubscriptionIdentifier extends SubscriptionType {
  ...
  /**
   * Uniquely identifies a single subscription for a given type in the {@link
   * SubscriptionContainer}.
   *
