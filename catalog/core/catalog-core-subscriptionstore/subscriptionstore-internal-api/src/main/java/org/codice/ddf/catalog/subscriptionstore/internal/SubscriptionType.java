 ...
 * between a type and a consumer's {@link SubscriptionFactory} that gets registered with OSGi.
 * Consumers must ensure the value for {@link SubscriptionType#getTypeName()} is always:
 *
 * <ol>
 *   <li>Unique across all API consumers
 *   <li>Consistent across all {@link SubscriptionType}s, including {@link SubscriptionIdentifier}
 *       and {@link SubscriptionFactory} implementations
 * </ol>
 *
