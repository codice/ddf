...
/**
 * {@link CacheWriter} implementation for the {@link Cache} in {@link SubscriptionContainerImpl}.
 * All inner exceptions will be handled by the cache implementation, or rethrown as a {@link
...
public class SubscriptionCacheWriter implements CacheWriter<String, CachedSubscription> {
  ...
  public void deleteAll(Collection<?> keys) throws CacheWriterException {
    ...
    keys.stream().map(String.class::cast).forEach(persistor::delete);
  }
