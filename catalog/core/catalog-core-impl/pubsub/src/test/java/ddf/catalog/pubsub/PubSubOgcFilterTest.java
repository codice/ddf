...
public class PubSubOgcFilterTest {

  private static final Logger LOGGER = LoggerFactory.getLogger(PubSubOgcFilterTest.class);
  ...
  public void testContextualFeatureEvaluate() throws TransformerException {
    ...
    PropertyIsEqualTo filter =
        filterFactory.equal(
            filterFactory.property("name"), filterFactory.literal("FirstFeature"), true);
    printFilter(filter);
  ...
  public void testGeospatialFeatureEvaluate() throws TransformerException {
    ...
    BBOX bboxFilter =
        filterFactory.bbox("geo", -114, 10, -110, 30, DefaultGeographicCRS.WGS84.toString());
    assertTrue(bboxFilter.evaluate(feature));

    BBOX bboxFilter1 =
        filterFactory.bbox("geo", -110, 10, 0, 30, DefaultGeographicCRS.WGS84.toString());
