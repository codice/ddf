...
//					break;
		...
		else 
		{
			...
			logger.debug( "distanceBetweenNearestPtsOnGeometries = " + distanceBetweenNearestPtsOnGeometries +
					",    distance = " + distance );
		...
		throws IOException, SAXException, ParserConfigurationException 
	{
		...
		// libraries return the geometry data, it's WKT is in LAT,LON order (which is incorrect).
		...
		if ( geometry instanceof Polygon ) 
		{
			...
			logger.debug( "Translates to " + polygon.toText() );  // this logs the transformed WKT with LON,LAT ordered points
			logger.debug( "EXITING: " + methodName );
		...
		if ( geometry instanceof Point ) 
		{
			...
			logger.debug( "Translates to " + point.toText() );  // this logs the transformed WKT with a LON,LAT ordered point
			logger.debug( "EXITING: " + methodName );
