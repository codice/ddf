...
public class CaseSensitiveContextualAnalyzer extends Analyzer {
    ...
    public CaseSensitiveContextualAnalyzer(Version matchVersion, Set<?> stopWords) {
        ...
        enableStopPositionIncrements = StopFilter.getEnablePositionIncrementsVersionDefault(
                matchVersion);
     ...
     */
    public CaseSensitiveContextualAnalyzer(Version matchVersion, File stopwords)
            throws IOException {
