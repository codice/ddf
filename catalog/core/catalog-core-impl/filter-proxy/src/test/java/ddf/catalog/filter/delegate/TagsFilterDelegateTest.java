...
public class TagsFilterDelegateTest {
    ...
    public void testNoTags() throws Exception {
        Filter filter = builder.attribute("attribute1")
                .is()
                .like()
                .text("value1");
    ...
    public void testTagsBasic() throws Exception {
        Filter filter = builder.attribute(Metacard.TAGS)
                .is()
                .like()
                .text("value1");
    ...
    public void testTagsInvalidOr() throws Exception {
        Filter filter1 = builder.attribute("attribute1")
                .is()
                .like()
                .text("value1");
        Filter filter2 = builder.attribute(Metacard.TAGS)
                .is()
                .like()
                .text("value2");
    ...
    public void testTagsOr() throws Exception {
        ...
        Filter filter2 = builder.attribute(Metacard.TAGS)
                ...
                .like()
                .text("value2");
        Filter filter3 = builder.attribute(Metacard.TAGS)
                .is()
                .like()
                .text("value3");
    ...
    public void testTagsWithParam() throws Exception {
        ...
        assertThat(adapter.adapt(filter,
                new TagsFilterDelegate(new HashSet<>(Arrays.asList("value2", "value1")))),
                is(true));
    }
}
