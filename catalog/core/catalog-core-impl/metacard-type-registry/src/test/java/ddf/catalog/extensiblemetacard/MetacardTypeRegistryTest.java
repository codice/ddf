...
public class MetacardTypeRegistryTest {
    ...
    public static void setupMetacardTypeRegistry() throws Exception {
        ...
        QualifiedMetacardTypeImpl qmt3 = new QualifiedMetacardTypeImpl(
                QualifiedMetacardType.DEFAULT_METACARD_TYPE_NAMESPACE,
                QUALIFIED_METACARD_TYPE_NAME_3, qmtAttributes);
        mtr.register(qmt3);
    ...
    private void assertOnExpectedMetacardTypeFields(QualifiedMetacardType qmtResult) {
        ...
        AttributeDescriptor metadataAD = qmtResult
                .getAttributeDescriptor(METADATA_ATTRIBUTE_DESCRIPTOR_NAME);
    ...
    public void registerMetacardType() throws InvalidSyntaxException, IllegalArgumentException,
        ...
        QualifiedMetacardType metacardTypeBFromRegistry = mtr.lookup(
                SAMPLE_B_METACARD_TYPE_NAMESPACE, SAMPLE_B_METACARD_TYPE_NAME);
    ...
    @Test
    public void registerMetacardType_NullNamespace() throws IllegalArgumentException,
        MetacardTypeUnregistrationException {
        QualifiedMetacardType qmt = new QualifiedMetacardTypeImpl(null,
                QUALIFIED_METACARD_TYPE_NAME_1, qmtAttributes);
        mtr.register(qmt);
        QualifiedMetacardType metacardTypeFromReg = mtr.lookup(
                QualifiedMetacardType.DEFAULT_METACARD_TYPE_NAMESPACE,
                QUALIFIED_METACARD_TYPE_NAME_1);
    ...
    @Test
    public void registerMetacardType_EmptyNamepsace() throws IllegalArgumentException,
        MetacardTypeUnregistrationException {
    ...
    public void testRegisteredTypes() {
        ...
        QualifiedMetacardTypeImpl test2 = new QualifiedMetacardTypeImpl(
                QualifiedMetacardType.DEFAULT_METACARD_TYPE_NAMESPACE,
                QUALIFIED_METACARD_TYPE_NAME_3, qmtAttributes);
    ...
    private QualifiedMetacardType sampleMetacardTypeA() {
        ...
        descriptors.add(new AttributeDescriptorImpl(
                FREQUENCY_ATTRIBUTE_NAME_SAMPLE_METACARD_TYPE_A, true /* indexed */,
                true /* stored */, false /* tokenized */, false /* multivalued */,
                BasicTypes.LONG_TYPE));
        descriptors.add(new AttributeDescriptorImpl(
                MIN_FREQUENCY_ATTRIBUTE_NAME_SAMPLE_METACARD_TYPE_A, true /* indexed */,
                true /* stored */, false /* tokenized */, false /* multivalued */,
                BasicTypes.LONG_TYPE));
        descriptors.add(new AttributeDescriptorImpl(
                MAX_FREQUENCY_ATTRIBUTE_NAME_SAMPLE_METACARD_TYPE_A, true /* indexed */,
                true /* stored */, false /* tokenized */, false /* multivalued */,
                BasicTypes.LONG_TYPE));
        descriptors.add(new AttributeDescriptorImpl(ANGLE_ATTRIBUTE_NAME_SAMPLE_METACARD_TYPE_A,
                ...
                false /* multivalued */, BasicTypes.INTEGER_TYPE));
    ...
    private void assertOnSampleMetacardTypeAExpectedAttributes(QualifiedMetacardType qmtResult) {
        ...
        AttributeDescriptor angle = qmtResult
                .getAttributeDescriptor(ANGLE_ATTRIBUTE_NAME_SAMPLE_METACARD_TYPE_A);
        assertNotNull(angle);
        assertEquals(ANGLE_ATTRIBUTE_NAME_SAMPLE_METACARD_TYPE_A, angle.getName());

        AttributeDescriptor maxFreq = qmtResult
                .getAttributeDescriptor(MAX_FREQUENCY_ATTRIBUTE_NAME_SAMPLE_METACARD_TYPE_A);
        assertNotNull(maxFreq);
        assertEquals(MAX_FREQUENCY_ATTRIBUTE_NAME_SAMPLE_METACARD_TYPE_A, maxFreq.getName());

        AttributeDescriptor minFreq = qmtResult
                .getAttributeDescriptor(MIN_FREQUENCY_ATTRIBUTE_NAME_SAMPLE_METACARD_TYPE_A);
        assertNotNull(minFreq);
        assertEquals(MIN_FREQUENCY_ATTRIBUTE_NAME_SAMPLE_METACARD_TYPE_A, minFreq.getName());

        AttributeDescriptor freq = qmtResult
                .getAttributeDescriptor(FREQUENCY_ATTRIBUTE_NAME_SAMPLE_METACARD_TYPE_A);
        assertNotNull(freq);
    ...
    private void assertOnSampleMetacardTypeBExcpectedAttributes(QualifiedMetacardType qmt) {
        ...
        AttributeDescriptor preciseHeight = qmt
                .getAttributeDescriptor(PRECISE_HEIGHT_METERS_ATTRIBUTE_KEY);
        ...
        AttributeDescriptor preciseLength = qmt
                .getAttributeDescriptor(PRECISE_LENGTH_METERS_ATTRIBUTE_KEY);
        ...
        AttributeDescriptor numReviewers = qmt
                .getAttributeDescriptor(NUMBER_REVIEWERS_ATTRIBUTE_KEY);
