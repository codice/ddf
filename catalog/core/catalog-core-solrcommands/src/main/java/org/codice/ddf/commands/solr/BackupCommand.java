...
public class BackupCommand extends SolrCommands {
    ...
    @Option(name = "-backupDirectory", aliases = {"--dir"}, multiValued = false, required = false,
    ...
    @Option(name = "-coreName", aliases = {"--core"}, multiValued = false, required = false,
            description = "Name of the Solr core to be backed up.  If not specified, the 'catalog' core will be backed up.")
    String coreName;

    @Option(name = "-numToKeep", aliases = {"--numToKeep"}, multiValued = false, required = false,
    ...
    public Object doExecute() throws Exception {
        ...
        coreName = StringUtils.isNotBlank(coreName) ? coreName : "catalog";
