...
public class ImportCommand extends CatalogCommands {
  ...
  protected Object executeWithSubject() throws Exception {
    ...
    if (invalidMetacards > 0) {
      console.println(
          "Some metacards were in an invalid format, please ensure the archive was not modified and was generated by 'catalog:export'. Note Archives generated by 'catalog:dump' will not be recognized by this import command'");
    }
    return null;
  }
