...
/**
 * This class is a backend information gathering and aggregation class. It holds information about
 * all downloads and then returns this information when requested, usually by {@link
 * org.codice.ddf.catalog.admin.downloadmanager.DownloadManagerService}. Most of the information is
 * accessed through a reference to the {@link
 * ddf.catalog.resource.download.ReliableResourceDownloadManager} responsible for the download.
 */
