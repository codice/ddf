...
public interface ResourceCache {
  ...
  /**
   * Gets a specific resource associated with the {@link Metacard} provided based on the attributes
  ...
  /**
   * Puts a {@link Resource} in the cache based on the given {@link Metacard} and the attributes of
   ...
   * @return {@code true} only if the resource of the given type associated currently exists in the
   *     cache
   */
