...
public interface ResourceCacheServiceMBean {
    ...
    public static final String OBJECT_NAME = ResourceCacheService.class.getName() + ":service=resource-cache-service";
    
    public static final Class<ResourceCacheServiceMBean> MBEAN_CLASS = ResourceCacheServiceMBean.class;
