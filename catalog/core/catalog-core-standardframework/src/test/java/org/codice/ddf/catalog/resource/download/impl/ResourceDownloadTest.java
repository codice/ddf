...
public class ResourceDownloadTest {
    ...
    private ResourceDownloadMBean createResourceDownloadMBean()
        throws MalformedObjectNameException {
        return new ResourceDownload(mockMBeanServer, mockCatalogFramework,
                mockResourceCacheServiceMBean);
    }
