...
public class Crypter {
  ...
  private final String associatedDataPath =
      AccessController.doPrivileged(
          (PrivilegedAction<String>) () -> System.getProperty("associated.data.path"));
  ...
  public Crypter(String keysetFileName) throws Crypter.CrypterException {
    ...
    synchronized (Crypter.class) {
      ...
      try {
        ...
        throw new Crypter.CrypterException("Problem initializing keyset", e);
      }
    }
  }

  public Crypter() throws Crypter.CrypterException {
  ...
  public byte[] encrypt(byte[] plainBytes) throws Crypter.CrypterException {
    ...
    try {
      ...
      throw new Crypter.CrypterException(ENCRYPTION_PROBLEM_MSG, e);
    }
  }
  ...
  public byte[] decrypt(byte[] encryptedBytes) throws Crypter.CrypterException {
    ...
    try {
      ...
      throw new Crypter.CrypterException(DECRYPTION_PROBLEM_MSG, e);
    }
  }
  ...
  public InputStream encrypt(InputStream plainInputStream) throws Crypter.CrypterException {
    ...
    try {
      if (plainInputStream == null || plainInputStream.available() < 1) {
        throw new Crypter.CrypterException("Plain InputStream cannot be null or empty.");
      }
    } catch (IOException e) {
      throw new Crypter.CrypterException("Problem reading data from plain InputStream.", e);
    }
    ...
    try {
      ...
      throw new Crypter.CrypterException("Unable to create temporary file for encryption.");
    }
  ...
  public InputStream decrypt(InputStream encryptedInputStream) throws Crypter.CrypterException {
    ...
    try {
      if (encryptedInputStream == null || encryptedInputStream.available() < 1) {
        throw new Crypter.CrypterException("Encrypted InputStream cannot be null or empty.");
      }
    } catch (IOException e) {
      throw new Crypter.CrypterException("Problem reading data from encrypted InputStream.", e);
    }
  ...
  private byte[] getAssociatedData() throws Crypter.CrypterException {
    ...
    try {
      ...
      throw new Crypter.CrypterException("Problem getting associated data.", e);
    }
  }
