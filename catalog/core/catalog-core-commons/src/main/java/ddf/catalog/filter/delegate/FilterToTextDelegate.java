...
public class FilterToTextDelegate extends FilterDelegate<String> {
	...
	// PropertyIsLike
	@Override
	public String propertyIsLike(String propertyName, String pattern,
	...
	// PropertyIsEqualTo
	@Override
	public String propertyIsEqualTo(String propertyName, String literal,
			boolean isCaseSensitive) {
	...
	@Override
	public String propertyIsEqualTo(String propertyName, Date startDate,
			Date endDate) {
	...
	@Override
	public String propertyIsNotEqualTo(String propertyName, Date startDate,
			Date endDate) {
		return propertyName + "!=" + startDate + " to " + endDate;
	}
	...
	@Override
	public String propertyIsGreaterThanOrEqualTo(String propertyName,
			String literal) {
		return propertyName + ">=" + literal;
	}
	...
	@Override
	public String propertyIsLessThanOrEqualTo(String propertyName,
			String literal) {
		return propertyName + "<=" + literal;
	}
	...
	@Override
	public String propertyIsBetween(String propertyName, Date lowerBoundary,
			Date upperBoundary) {
		return lowerBoundary + "<=" + propertyName + "<=" + upperBoundary;
	}

	@Override
	public String propertyIsBetween(String propertyName, int lowerBoundary,
			int upperBoundary) {
		return lowerBoundary + "i<=" + propertyName + "<=" + upperBoundary
				+ "i";
	}

	@Override
	public String propertyIsBetween(String propertyName, short lowerBoundary,
			short upperBoundary) {
		return lowerBoundary + "s<=" + propertyName + "<=" + upperBoundary
				+ "s";
	}

	@Override
	public String propertyIsBetween(String propertyName, long lowerBoundary,
			long upperBoundary) {
		return lowerBoundary + "l<=" + propertyName + "<=" + upperBoundary
				+ "l";
	}

	@Override
	public String propertyIsBetween(String propertyName, float lowerBoundary,
			float upperBoundary) {
		return lowerBoundary + "f<=" + propertyName + "<=" + upperBoundary
				+ "f";
	}
	...
	public String propertyIsBetween(String propertyName, double lowerBoundary,
		...
		return lowerBoundary + "d<=" + propertyName + "<=" + upperBoundary
				+ "d";
	}
	...
	public String propertyIsBetween(String propertyName, Object lowerBoundary,
		...
		return lowerBoundary + "o<=" + propertyName + "<=" + upperBoundary
				+ "o";
	}
	...
	// XpathIsLike
	@Override
	public String xpathIsLike(String xpath, String pattern,
			boolean isCaseSensitive) {
