...
/**
 * <p>
 * WktStandard supports converting WKT into standard representations based on
 * the WKT grammar in the OpenGIS Simple Feature Access specification.
 * </p>
 * <p>
 * DDF normalizes MULTIPOINT geometries to the style defined by the WKT grammar.
 * For example, <code>MULTIPOINT ((0 0), (10 10))</code> is in the normalized
 * format. Some systems require a different format of MULTIPOINT. The previous
 * example would denormalize as <code>MULTIPOINT (0 0, 10 10)</code>
 * </p>
 * 
