...
public class SpatialDistanceFilterTest {
	...
	public void testCreateFromInfiniteCoordinates() {
		toTest = new SpatialDistanceFilter(Double.NEGATIVE_INFINITY,Double.POSITIVE_INFINITY,Double.MIN_VALUE);
	...
	public void testCreateFromValidStringCoordinates() {
		...
		assertEquals("POINT(14 91)", toTest.geometryWkt); // comes back as expected:<POINT(14[ 91])> but was:<POINT(14[.0 91.0])>
