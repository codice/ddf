...
public interface MetacardVersion extends Metacard {
  ...
  /**
   * {@link ddf.catalog.data.Attribute} name for action of the current {@link MetacardVersion}. Can
   * be one of <code>Created</code>, <code>Updated</code>, or <code>Deleted</code>.
   *
   * @since DDF-2.9.0
   */
  ...
  /**
   * {@link ddf.catalog.data.Attribute} name for metacard ID on a history item of this {@link
   * Metacard} revision.
   *
   * @since DDF-2.9.0
   */
  ...
  /**
   * {@link ddf.catalog.data.Attribute} name for original metacard type of this {@link Metacard}
   * revision.
   *
   * @since DDF-2.9.0
   */
  ...
  /**
   * {@link ddf.catalog.data.Attribute} name for original serialized metacard type of this {@link
   * Metacard} revision.
   *
   * @since DDF-2.9.0
   */
  ...
  /**
   * {@link ddf.catalog.data.Attribute} name for original resource URI of this {@link Metacard}
   * revision.
   */
  ...
  enum Action {
    ...
    public static Action ofMetacard(Metacard metacard) {
      ...
      Serializable svalue =
          Optional.ofNullable(metacard.getAttribute(ACTION))
    ...
    public static boolean isVersion(Metacard metacard) {
      return metacard instanceof MetacardVersion
          || PREFIX.equals(metacard.getMetacardType().getName());
    }
  }
}
