...
public interface EventProcessor {
  ...
  public static final String EVENT_METACARD = "ddf.catalog.event.metacard";

  /** @deprecated This constant is implementation specific and will be removed from API */
  public static final String EVENT_OLD_METACARD = "ddf.catalog.event.old-metacard";

  /** @deprecated This constant is implementation specific and will be removed from API */
  public static final String EVENT_TIME = "ddf.catalog.event.time";

  /** @deprecated This constant is implementation specific and will be removed from API */
  public static final String EVENTS_TOPIC_CREATED = "ddf/catalog/event/CREATED";

  /** @deprecated This constant is implementation specific and will be removed from API */
  public static final String EVENTS_TOPIC_UPDATED = "ddf/catalog/event/UPDATED";

  /** @deprecated This constant is implementation specific and will be removed from API */
  public static final String EVENTS_TOPIC_DELETED = "ddf/catalog/event/DELETED";
   ...
   *
   * <p><b>Note:</b> <em>{@link Subscription}s are transient, not durable, i.e., only maintained in
   * memory and will be lost if DDF is shutdown.</em><br>
   * Durability must be implemented by the client bundle (typically an endpoint - refer to {@link
   * DurableSubscription} for an example).
   *
   * <p><b>Note:</b> <em>A {@link Subscription} can also be registered using the whiteboard
   * model:</em> <br>
   * To register a {@link Subscription} via the whiteboard model, simply register any implementation
   * of {@link Subscription} with OSGi registry under the interface {@link Subscription}. To
   * unregister the {@link Subscription}, simply unregister the service that was originally
   * registered. {@link Subscription}s registered in this manner do not get a subscription id and
   * cannot be unsubscribed via the {@link EventProcessor} Implementations of this method
   * <em>must</em> call the {@link ddf.catalog.plugin.PreSubscriptionPlugin#process(Subscription)}
   * method for each
   *
   * @param subscription the {@link Subscription} to register
  ...
  /**
   * Notify this {@code EventProcessor} that a {@link Metacard} (or equivalent) has been created in
   * a {@link ddf.catalog.source.RemoteSource}.
   *
   * <p><b>Implementations of this method must:</b>
   *
   * <ol>
   *   <li>Call the {@link ddf.catalog.plugin.PreDeliveryPlugin#processCreate(Metacard)} method for
   *       all of the registered {@link ddf.catalog.plugin.PreDeliveryPlugin}s
  ...
  /**
   * Notify this {@code EventProcessor} that a {@link Metacard} (or equivalent) has been updated in
   * a {@link ddf.catalog.source.RemoteSource}.
   *
   * <p><b>Implementations of this method must:</b>
   *
   * <ol>
   *   <li/>Call {@link
   *       ddf.catalog.plugin.PreDeliveryPlugin#processUpdateHit(ddf.catalog.operation.Update)}
   *       method of all registered {@link ddf.catalog.plugin.PreDeliveryPlugin}s when a {@link
   *       Metacard} has been updated and the new version matches a {@link Subscription}
   *   <li/>Call {@link
   *       ddf.catalog.plugin.PreDeliveryPlugin#processUpdateMiss(ddf.catalog.operation.Update)}
   *       method of all registered {@link ddf.catalog.plugin.PreDeliveryPlugin}s when a {@link
   *       Metacard} has been updated and the new version matches a {@link Subscription} but the old
   *       version does not
   *   <li>Call all registered implementations of {@link DeliveryMethod} with the updated {@link
   *       Metacard}.
   * </ol>
   *
   * @param newMetacard the new version of the {@link Metacard}
   * @param oldMetacard the previous version of the {@link Metacard} (optional, pass {@code null} if
   *     not relevant)
   * @see ddf.catalog.source.FederatedSource
   * @see ddf.catalog.source.RemoteSource
   * @see ddf.catalog.source.ConnectedSource
  ...
  /**
   * Notify this {@link EventProcessor} that a {@link Metacard} (or equivalent) has been deleted in
   * a {@link ddf.catalog.source.RemoteSource}.
   *
   * <p><b>Implementations of this method must:</b>
   * <li>If possible (that is, the {@link Metacard} is fully populated) call all active matching
   *     {@link Subscription}s associated {@link DeliveryMethod#deleted(Metacard)} with the {@link
   *     Metacard} that was deleted.
   * <li>If impossible (this is, the {@link Metacard} only has {@link Metacard#getId()}, call all
   *     active {@link Subscription}s.
   * </ol>
   *
