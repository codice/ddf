...
public interface NumericalRangeExpressionBuilder {
     ...
     * @return {@link Filter} a filter that will pass only {@link Metacard}s where the indicated {@link Attribute} is within the indicated range
     */
    ...
    /**
     * Completes building a Numerical Range Filter, using a range between two numbers of type {@link Short}
     * @param arg0 the bottom range, inclusive
     * @param arg1 the top of the range, inclusive
     * @return {@link Filter} a filter that will pass only {@link Metacard}s where the indicated {@link Attribute} is within the indicated range
     */
    ...
    /**
     * Completes building a Numerical Range Filter, using a range between two numbers of type {@link Float}
     * @param arg0 the bottom range, inclusive
     * @param arg1 the top of the range, inclusive
     * @return {@link Filter} a filter that will pass only {@link Metacard}s where the indicated {@link Attribute} is within the indicated range
     */
    ...
    /**
     * Completes building a Numerical Range Filter, using a range between two numbers of type {@link Double}
     * @param arg0 the bottom range, inclusive
     * @param arg1 the top of the range, inclusive
     * @return {@link Filter} a filter that will pass only {@link Metacard}s where the indicated {@link Attribute} is within the indicated range
     */
