...
/**
 * CreateResponseImpl contains the {@link Response} information (created metacards)
 * on a {@link CreateRequest}.
 * 
 */
public class CreateResponseImpl extends ResponseImpl<CreateRequest> implements CreateResponse {
	 ...
	 */
	public CreateResponseImpl(CreateRequest request, Map<String, Serializable> properties, List<Metacard> createdMetacards ) {
