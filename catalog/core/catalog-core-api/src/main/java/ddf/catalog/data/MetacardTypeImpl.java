...
public class MetacardTypeImpl implements MetacardType {
	 ...
	 * 
	 * @serialData First, the name is written as a {@code String} by the default
	 *             Java serialization implementation, then the number of
	 *             {@link AttributeDescriptor} objects is written as an (
	 *             {@code int}), followed by all of the
	 *             {@code AttributeDescriptor} objects in no guaranteed sequence
	 *             or order.
	 * @param stream
	 ...
	 * 
	 * @param stream
	 *            the {@link ObjectInputStream} that contains the bytes of
	 *            the object
	 * @throws IOException
