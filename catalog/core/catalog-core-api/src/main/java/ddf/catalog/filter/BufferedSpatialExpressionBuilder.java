...
public interface BufferedSpatialExpressionBuilder extends SpatialExpressionBuilder {
  ...
  /**
   * Creates a {@link Filter} matching against a wkt-defined shape buffered by the specified
   * distance
   *
   * @param wkt - WKT representing shape to be buffered.
   * @param buffer - distance in meters
