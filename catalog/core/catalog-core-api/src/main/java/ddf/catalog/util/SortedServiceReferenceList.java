...
public class SortedServiceReferenceList implements List<ServiceReference> {
	...
	private Set<ServiceReference> serviceSet = Collections.synchronizedSet(new TreeSet<ServiceReference>(
	 ...
	 * internally maintained and sorted serviceSet. This method is invoked when
	 * a service is bound (created/installed).
	 * 
	 * @param ref
	 ...
	 * internally maintained and sorted serviceMap. This method is invoked when
	 * a service is unbound (removed/uninstalled).
	 * 
	 * @param ref
	 *            the OSGi service reference
	 */
