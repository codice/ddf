...
public interface NumericalExpressionBuilder {
  ...
  /**
   * Complete building a {@link Filter} with the previously specified operation using an {@code int}
   * as an argument
   *
   * @param arg - int number to filter on
   * @return {@link Filter}
   */
  public abstract Filter number(int arg);

  /**
   * Complete building a {@link Filter} with the previously specified operation using a {@code
   * short} as an argument
   *
   * @param arg - double number to filter on
   * @return {@link Filter}
   */
   ...
   *
   * @param arg - float number to filter on
   * @return {@link Filter}
   */
  ...
  /**
   * Complete building a {@link Filter} with the previously specified operation using a {@code long}
   * as an argument
   *
   * @param arg - long number to filter on
   * @return {@link Filter}
   */
