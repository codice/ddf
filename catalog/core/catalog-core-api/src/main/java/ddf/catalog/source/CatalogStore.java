 ...
 * </p>
 * A CatalogStore represents an editable store that is either local or remote
 */
public interface CatalogStore extends FederatedSource {
     ...
     *
     * @param createRequest - the {@link CreateRequest} that includes a {@link java.util.List} of {@link ddf.catalog.data.Metacard}
     *                      objects to be stored in a {@link Source}. The ID of the {@link ddf.catalog.data.Metacard} object
     *                      will be ignored and populated / generated by the {@link CatalogStore} when the
     ...
     *
     * @param updateRequest - the {@link UpdateRequest} that includes updates to {@link ddf.catalog.data.Metacard} records that
     ...
     * @throws IngestException if an issue occurs during the update such as multiple records were matched for a
     *                         single update entry
     */
     ...
     *
     * @param deleteRequest - the {@link DeleteRequest} containing the attribute values associated with
