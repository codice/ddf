...
/**
 * Response from {@link PolicyPlugin} containing policy information for {@link ddf.catalog.operation.Operation}
 * and individual items, such as {@link ddf.catalog.data.Metacard} or {@link ddf.catalog.data.Result}
 */
