...
public interface DefaultAttributeValueRegistry {
   ...
   *
   * <p>In the event that an attribute has a 'global' default value as well as a default value for
   * the given metacard type, the default value for the given metacard type will be returned (i.e.,
   * the more specific default value wins). If the attribute has a 'global' default value but no
   * default value for the given metacard type, then the 'global' default value will be returned.
   *
   * @param metacardTypeName the name of the metacard type, cannot be null
   * @param attributeName the name of the attribute belonging to the metacard type, cannot be null
   * @return an {@link Optional} containing the default value registered for the given attribute of
   *     the given metacard type, or {@link Optional#empty()} if the attribute does not have a
   ...
   *
   * @param attributeName the name of the attribute whose default value will be removed, cannot be
   *     null
