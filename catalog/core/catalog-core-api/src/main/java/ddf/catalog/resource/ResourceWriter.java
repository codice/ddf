...
public interface ResourceWriter {
   ...
   *     of {@link Resource}
   * @throws {@link IOException} thrown typically when there is an issue storing the {@link
   *     Resource}
   */
   ...
   * @param arguments optional arguments associated with the operation
   * @return the {@link URI} associated with the {@link Resource}
   * @throws {@link ResourceNotSupportedException} thrown if this writer does not support the {@link
   *     Resource}
   * @throws {@link IOException} thrown typically when there is an issue storing the {@link
   *     Resource}
   */
   ...
   * @throws {@link ResourceNotSupportedException} thrown if this writer does not support the {@link
   *     Resource}
   * @throws {@link IOException} thrown typically when there is an issue accessing the {@link
   *     Resource} file
   */
