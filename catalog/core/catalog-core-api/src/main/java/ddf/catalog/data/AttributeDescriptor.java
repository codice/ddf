...
public interface AttributeDescriptor extends Serializable {
  ...
  /**
   * Returns the {@link AttributeType} of {@link Attribute}s described by this {@link
   * AttributeDescriptor}.
   *
  ...
  /**
   * Whether or not this {@link Attribute} should be indexed by {@link ddf.catalog.source.Source}
   * implementations, therefore part of {@link ddf.catalog.operation.Query} evaluation. <br>
  ...
  /**
   * If the {@link ddf.catalog.data.AttributeType.AttributeFormat} of this {@link Attribute} is
   * {@link ddf.catalog.data.AttributeType.AttributeFormat#STRING}, returns whether or not {@link
   * ddf.catalog.source.Source} implementations should tokenize it; removing stopwords, etc.
   *
   * <p><b> This method is only relevant to {@link Attribute}s with an {@link
   * ddf.catalog.data.AttributeType.AttributeFormat} of {@link
   * ddf.catalog.data.AttributeType.AttributeFormat#STRING} </b> Some {@link Attribute}s may only
  ...
  /**
   * Returns whether or not {@link ddf.catalog.source.Source} implementations must store the value
   * of this {@link Attribute}. Some {@link Attribute}s may only need to be indexed, not stored (or
   * vice versa).
   *
   * @see #isIndexed()
