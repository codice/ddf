...
/**
 * The interface {@link SourceMetrics} used by the {@link FederationStrategy} to 
 * update metrics on individual {@link Source}s as queries and exceptions occur 
 * when the {@link Source} is accessed.
 * 
 * <p><b>
