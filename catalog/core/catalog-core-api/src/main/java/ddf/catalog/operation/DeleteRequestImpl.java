...
/**
 * The DeleteRequestImpl class is used to delete a single or list of 
 * the {@link String} id or {@link URI}.
 */
public class DeleteRequestImpl extends OperationImpl implements DeleteRequest {
	...
	/**
	 * Instantiates a new DeleteRequestImpl with a single {@link String} id
	 * to be deleted.
	 *
	...
	/**
	 * Instantiates a new DeleteRequestImpl with an array of {@link String} id
	 * to be deleted.
	 *
	...
	/**
	 * Instantiates a new DeleteRequestImpl to be deleted with an array of {@link String} ids
	...
	/**
	 * Instantiates a new DeleteRequestImpl with a {@link URI} array with a
	...
	/**
	 * Instantiates a new DeleteRequestImpl with a {@link List} of {@link Serializable}
	 * values. This allows for custom delete operations aside from String id or URI.
	 *
