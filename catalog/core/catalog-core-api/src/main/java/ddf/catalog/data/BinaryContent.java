...
public interface BinaryContent {
   ...
   * only be used once to extract the content. If it is necessary that the bytes of the <code>
   * InputStream</code> object are needed again, use the {@link #getByteArray()} method instead.
   *
