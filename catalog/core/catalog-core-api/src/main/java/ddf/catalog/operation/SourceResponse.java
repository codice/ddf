...
public interface SourceResponse extends Response<QueryRequest> {
	...
	/**
	 * The total number of hits matching the associated {@link Query} for the
	 * associated {@link Source}, -1 if unknown. This is typically more than the
	 * number of {@link Result}s returned from {@link #getResults()}.
	 * 
	...
	/**
	 * Get any specific details about the execution of the {@link QueryRequest}
	 * associated with this {@link SourceResponse}. <b>Must not be null.</b>
	 * 
