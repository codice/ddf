...
public class DistanceResultComparator implements Comparator<Result> {
	 ...
	 * distance ascending or distance descending.
	 * 
	 * @param distanceOrder the distance sort order
	 */
	 ...
	 * 1 if ascending sort order and A > B; -1 if ascending sort order and B > A
	 * -1 if descending sort order and A > B; 1 if descending sort order and B > A
	 */
	@Override
