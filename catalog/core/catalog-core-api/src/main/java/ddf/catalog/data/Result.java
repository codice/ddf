...
public interface Result {
   ...
   *
   * @return relevance score (typical range of 0-1, values over 1 are those that have been boosted)
   */
   ...
   *
   * @return distance in meters, null if {@code Result} was not part of a search that was sorted by
   *     distance.
   */
