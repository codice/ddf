...
public class QueryImpl implements Query {
    ...
    /**
     * Instantiates a new QueryImpl with a {@link Filter} Throws
     * IllegalArgumentException if a null object is passed in.
     * 
     * @param filter
     *            the filter
     */
    public QueryImpl(Filter filter) {
        ...
        if (null == filter) {
            throw new IllegalArgumentException(
                    "Null filter used in creation of QueryImpl object.");
        }
    ...
    /**
     * Instantiates a new QueryImpl with a {@link Filter}, startIndex, pageSize,
     * sortPolicy, requestsTotalResultsCount, and timeoutMillis
     * 
     * @param rootFilter
     *            the filter
     * @param startIndex
     ...
     */
    public QueryImpl(Filter rootFilter, int startIndex, int pageSize,
            SortBy sortPolicy, boolean requestsTotalResultsCount,
            long timeoutMillis) {
        this(rootFilter);
