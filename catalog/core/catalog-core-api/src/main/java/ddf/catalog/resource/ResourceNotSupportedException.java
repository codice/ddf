...
/**
 * The ResourceNotSupportedException is thrown by a {@link ResourceReader} or {@link
 * CatalogFramework} when they do not support a {@link Resource} or {@link ResourceRequest}.
 *
 * <p>Common uses of this exception include when the {@link ResourceRequest} has an attribute name
