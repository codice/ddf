...
public interface PreFederatedQueryPlugin {
  ...
  /**
   * Processes a {@link QueryRequest} prior to execution of the Federated {@link
   ...
   *     PreFederatedQueryPlugin}, or if this is the last {@link PreFederatedQueryPlugin} to be
   *     called
