...
/**
 * The exception thrown to capture problems during the PubSub operations
 * create, update, and delete of subscriptions.
 * 
...
public class EventException extends Exception {
    ...
    /**
     * Instantiates a new {@code EventException} with the provided message and
     * throwable.
     * 
     * @param message the message
