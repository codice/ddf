...
/**
 * Transforms a {@link QueryRequest} containing external attribute names & values into a normalized
 * taxonomy {@link QueryRequest}.
 *
...
public interface QueryFilterTransformer {
   ...
   * requiring the endpoint to modify the request after conversion
   *
