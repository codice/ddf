...
public interface Subscriber {
   ...
   * Subscription's OSGi service, its associated DurableSubscription OSGi service (if any), and
   * removing the subscription from the internal hashmaps maintained by the Subscriber.
   *
