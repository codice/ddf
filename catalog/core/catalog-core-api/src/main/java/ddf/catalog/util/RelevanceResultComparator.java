...
public class RelevanceResultComparator implements Comparator<Result> {
	...
	/**
     * Constructs the comparator with the specified sort order, either
     * relevance ascending or relevance descending.
     * 
     ...
     * 1 if ascending relevance and A > B; -1 if ascending relevance and B > A
     * -1 if descending relevance and A > B; 1 if descending relevance and B > A
     */
	@Override
	public int compare( Result contentA, Result contentB){
	    if ( contentA != null && contentB != null)
		{
			...
			if(relevanceScoreA == null && relevanceScoreB != null){
				...
				logger.debug("relevanceScoreA is not null: " + relevanceScoreA + " and relevanceScoreB is null" );
				return -1;
			}
			else if(relevanceScoreA == null && relevanceScoreB == null){
