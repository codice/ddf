 ...
 * For example if {@link Metacard}s need to be validated prior to {@link CatalogProvider#create(CreateRequest)} a {@link PreIngestPlugin}
...
public interface PreIngestPlugin {
	 ...
	 *         {@link PreIngestPlugin}, or if this is the last
	 *         {@link PreIngestPlugin} to be called   
