...
public interface PreResourcePlugin {
   ...
   * @return the value of the processed {@link ResourceRequest} to pass to the next {@link
   *     PreResourcePlugin}, or if this is the last {@link PreResourcePlugin} to be called
