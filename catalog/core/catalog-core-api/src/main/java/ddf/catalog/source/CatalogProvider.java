 ...
 *
 * <p>The provider performs a translation between DDF objects and its native format. The key
 * functions of the CatalogProvider can be found in the {@link Source} and {@link
 * ddf.catalog.data.Metacard} interfaces.
 */
public interface CatalogProvider extends Source, Maskable {
   ...
   *     {@link CatalogProvider} when the record has been stored.
