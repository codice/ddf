...
public interface SpatialExpressionBuilder {
  ...
  /**
   * Complete building a spatial {@link Filter} for {@link ddf.catalog.data.Metacard}s where the
   * specified {@link ddf.catalog.data.Attribute} relates to the specified WKT per the specified
   * operator.
   *
   * @param wkt - WKT-formatted shape definition (2D)
