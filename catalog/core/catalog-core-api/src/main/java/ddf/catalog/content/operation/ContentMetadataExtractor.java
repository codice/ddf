...
public interface ContentMetadataExtractor {
   ...
   *
   * <p><strong>This method can have large memory effects. If you already have data in a datasource
   * that can be streamed, consider the {@link #process(InputStream, Metacard)} overloaded method
   * instead.</strong>
   *
