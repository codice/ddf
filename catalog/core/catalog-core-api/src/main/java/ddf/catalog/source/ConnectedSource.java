...
/**
 * Provides an implementation of {@link Source} that represents a remote {@Source} that is always
 * included in every local and enterprise {@link ddf.catalog.operation.Query} processed. However,
