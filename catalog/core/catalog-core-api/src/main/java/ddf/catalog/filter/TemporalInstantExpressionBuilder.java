...
/**
 * Completes the fluent API to build a temporal {@link Filter} using an instant
 * in time (vs a bounded range)
 * 
...
public interface TemporalInstantExpressionBuilder {
    ...
    /**
     * Complete building the {@link Filter} matching {@link Metacard}s where the
     * specified {@link Attribute} relates to the specified date via the
