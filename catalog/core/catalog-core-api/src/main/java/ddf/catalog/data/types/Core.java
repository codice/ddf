...
public interface Core {
    /**
     * {@link ddf.catalog.data.Attribute} checksum value for the {@link ddf.catalog.data.Metacard#RESOURCE_URI}
     */
    String CHECKSUM = "checksum";

    /**
     * {@link ddf.catalog.data.Attribute} algorithm used to calculate the checksum on the {@link ddf.catalog.data.Metacard#RESOURCE_URI}
     * for local resources
     */
    String CHECKSUM_ALGORITHM = "checksum-algorithm";

    /**
     * {@link ddf.catalog.data.Attribute} name for accessing the date/time this {@link ddf.catalog.resource.Resource} was created. <br/>
     */
    String CREATED = "created";

    /**
     * {@link ddf.catalog.data.Attribute} description associated with the {@link ddf.catalog.data.Metacard}
     */
    String DESCRIPTION = "description";

    /**
     * {@link ddf.catalog.data.Attribute} name for accessing the date/time the {@link ddf.catalog.data.Metacard} is no longer valid
    ...
    /**
     * {@link ddf.catalog.data.Attribute} name for accessing the language of the resource of this {@link ddf.catalog.data.Metacard}.
     */
    String LANGUAGE = "language";

    /**
     * {@link ddf.catalog.data.Attribute} name for accessing the location for this {@link ddf.catalog.data.Metacard}. <br/>
     */
    String LOCATION = "location";

    /**
     * {@link ddf.catalog.data.Attribute} name for accessing the XML metadata for this {@link ddf.catalog.data.Metacard}. <br/>
     */
    String METADATA = "metadata";

    /**
     * {@link ddf.catalog.data.Attribute} name for accessing the date/time this {@link ddf.catalog.resource.Resource} was last modified. <br/>
     */
    ...
    /**
     * {@link ddf.catalog.data.Attribute} name for accessing the size (in bytes) of the product this {@link ddf.catalog.data.Metacard}
     * represents. <br/>
     */
    String RESOURCE_SIZE = "resource-size";

    /**
     * {@link ddf.catalog.data.Attribute} name for accessing the {@link java.net.URI} reference to the product this
     * {@link ddf.catalog.data.Metacard} represents. <br/>
     */
    String RESOURCE_URI = "resource-uri";

    /**
     * {@link ddf.catalog.data.Attribute} name for the ID of the source where the {@link ddf.catalog.data.Metacard} is cataloged.
     */
    String SOURCE_ID = "source-id";

    /**
     * {@link ddf.catalog.data.Attribute} name for accessing the thumbnail image of the product this {@link ddf.catalog.data.Metacard}
