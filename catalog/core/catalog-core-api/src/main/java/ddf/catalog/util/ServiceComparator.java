...
public class ServiceComparator implements Comparator<ServiceReference> {
     ...
     * using the OSGi {@link ServiceReference} compare method.
     * 
     ...
     * and greater if it has a higher service ranking. Otherwise, if this ServiceReference and the specified 
     * ServiceReference have the same service ranking, this ServiceReference is less than the specified 
