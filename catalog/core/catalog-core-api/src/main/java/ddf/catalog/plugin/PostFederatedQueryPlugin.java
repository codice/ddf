 ...
 * For example if metrics need to be recorded on the query, a PostFederatedQueryPlugin could be implemented
 * to do this prior to the query response being returned to the {@link CatalogFramework}.
 * 
 * @author rodgersh
 */
