...
public interface InjectableAttribute {
     ...
     * <p>
     * Should return an empty set if this attribute should be injected into all {@link MetacardType}s.
     *
     * @return the names of the {@link MetacardType}s into which this attribute should be injected,
     * or an empty set if this attribute should be injected into all {@link MetacardType}s
     */
