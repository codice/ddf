...
public class QueryResponseImpl extends ResponseImpl<QueryRequest> implements
		QueryResponse {
    ...
    /**
	 * Instantiates a new QueryResponseImpl with a $(@link QueryRequest) and
    ...
    /**
	 * Instantiates a new QueryResponseImpl with a $(@link QueryRequest) and
	 * and a ${@link List} of results
	 * 
	 * @param request the request
	 * @param results the results
	 */
	public QueryResponseImpl(QueryRequest request, List<Result> results,
			long totalHits) {
    ...
    /**
	 * Instantiates a new QueryResponseImpl with a $(@link QueryRequest),
	 * a ${@link List} of results,
	 * a closeResultQueue indicator,
	 * and a number of hits to return
	 * 
	 * @param request the request
	 * @param results the results
	 * @param hits the hits
	 */
	public QueryResponseImpl(QueryRequest request, List<Result> results,
			boolean closeResultQueue, long hits) {
    ...
    /**
	 * Adds a ${@link Result} to this QueryResponse,
	 * and specifies whether or not to close the queue
	 * 
    ...
    /**
	 * Adds a ${@link List} of ${@link Result}s to this QueryResponse,
	 * and specifies whether or not to close the queue
	 * 
	 * @param results the results
	 * @param closeQueue the indicator for closing of the queue
