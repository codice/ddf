...
public interface Attribute extends Serializable {
   ...
   *
   * <p>If this {@link Attribute} is multivalued ( {@link AttributeDescriptor#isMultiValued()}
   * ==true), this method must return the first, if any, value as an instance of the Class
   * identified in the associated {@link AttributeDescriptor#getClass()} method.
   *
   ...
   *
   * <p>If this {@link Attribute} is <em>NOT</em> multivalued, this method must return either null
   * or a {@link List} with 0 or 1 entries depending on whether the value is null or not.
   *
