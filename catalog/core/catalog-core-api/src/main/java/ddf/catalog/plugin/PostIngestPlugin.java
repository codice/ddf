...
public interface PostIngestPlugin {
   ...
   * @return the value of the processed {@link CreateResponse} to pass to the next {@link
   *     PostIngestPlugin}, or if this is the last {@link PostIngestPlugin} to be called
   ...
   * @return the value of the processed {@link UpdateResponse} to pass to the next {@link
   *     PostIngestPlugin}, or if this is the last {@link PostIngestPlugin} to be called
   * @throws PluginExecutionException thrown when an error occurs during processing
   */
