...
public class AttributeDescriptorImpl implements AttributeDescriptor {
	 ...
	 * @param indexed
	 *            - whether {@link Attribute} values using this
	 *            {@link AttributeDescriptor} should be indexed
	 * @param stored
	 *            - whether {@link Attribute} values using this
	 *            {@link AttributeDescriptor} should be stored
	 * @param tokenized
	 *            - whether {@link Attribute} values using this
	 *            {@link AttributeDescriptor} should be tokenized
	 * @param multivalued
	 *            whether {@link Attribute} values using this
	 *            {@link AttributeDescriptor} are multivalued
	 * @param type
