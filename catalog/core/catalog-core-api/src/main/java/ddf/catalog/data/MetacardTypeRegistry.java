...
public interface MetacardTypeRegistry {
  ...
  /**
   * Registers a {@link QualifiedMetacardType} in the system so that it is accessible to {@link
   * ddf.catalog.transform.InputTransformer}s, {@link ddf.catalog.transform.MetacardTransformer}s,
   * {@link ddf.catalog.transform.QueryResponseTransformer}s, and other components. This allows
   * those components to know how to properly interpret a {@link Metacard} and its {@link
   * Attribute}s.
   *
   * <p>If the QualifiedMetacardType does not contain a namespace, the default namespace will be
   * assumed.
   *
   * @param qualifiedMetacardType the {@link QualifiedMetacardType} to make available to the catalog
   *     framework.
   ...
   *     {@link QualifiedMetacardType} 's name is null or empty.
   */
   ...
   *
   * @param qualifiedMetacardType The MetacardType to remove from the registry. Cannot be null or
   *     empty.
   ...
   *
   * @param namespace prefix qualifier in which the {@link MetacardType} name is unique.
   * @param metacardTypeName unique name identifying {@link MetacardType}. Cannot be null or empty.
   * @return {@link QualifiedMetacardType} matching provided namespace and metacardTypeName or null
   *     if no matching MetacardType can be found.
   * @throws IllegalArgumentException if the namespace is null or if the metacardTypeName is null or
   *     empty.
   */
   ...
   * @return {@link QualifiedMetacardType} matching provided namespace and metacardTypeName or null
   *     if no matching MetacardType can be found.
   * @throws IllegalArgumentException if the metacardTypeName is null or empty.
   */
