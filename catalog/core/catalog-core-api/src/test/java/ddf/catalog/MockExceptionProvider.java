...
/**
 * Throws a runtime exception for all of the performing operations. This is used
 * to test the catalog framework and verify that runtime exceptions are being
 * caught and not thrown back to the endpoint.
 * 
 * @author LMCO
 * 
 */
public class MockExceptionProvider extends MockSource implements CatalogProvider
{
    ...
    public MockExceptionProvider( String shortName, String title, String version, String organization,
	...
	@Override
	public CreateResponse create(CreateRequest create)
