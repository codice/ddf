...
public class MockDelayProvider extends MockSource implements CatalogProvider {
	...
	public MockDelayProvider(String shortName, String title, String version,
		...
		provider = new MockMemoryProvider(shortName, title, version,
				organization, catalogTypes, isAvailable, lastAvailability);
	}
