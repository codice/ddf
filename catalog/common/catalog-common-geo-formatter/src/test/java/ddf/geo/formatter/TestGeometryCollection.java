...
public class TestGeometryCollection extends AbstractTestCompositeGeometry {

    @Test
    public void testGeoRssConversion() throws ParseException, IOException, SAXException {

        String entryXmlText = getSampleAtomEntry(new GeometryCollection(reader.read(
                "GEOMETRYCOLLECTION(POINT (1 2),LINESTRING (1 2, 3 4, 5 7))")));
