...
public class TestMultiLineString extends AbstractTestCompositeGeometry {

	@Test
	public void testGeoRssConversion() throws ParseException, IOException, SAXException {

		String entryXmlText = getSampleAtomEntry(new MultiLineString(
				reader.read("MULTILINESTRING ((1 2, 3 4, 5 7),\r\n" + "(8 9, 10 12, 13 14, 15 16))")));
