...
public class KmlFeatureToJtsGeometryConverterTest {
  ...
  //      KmlDocumentToJtsGeometryConverterTest.assertKmlDocument((Document) kmlFeature,
  // jtsGeometry);
  //    }
  ...
  //      KmlPlacemarkToJtsGeometryConverterTest.assertPlacemark((Placemark) kmlFeature,
  // jtsGeometry);
  //    }
