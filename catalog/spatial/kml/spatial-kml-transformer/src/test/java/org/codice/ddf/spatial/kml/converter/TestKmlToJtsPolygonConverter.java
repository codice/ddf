...
public class TestKmlToJtsPolygonConverter {
  ...
  public static void setupClass() {
    InputStream stream = TestKmlToJtsPolygonConverter.class.getResourceAsStream("/kmlPolygon.kml");
  ...
  private Polygon getTestKmlPolygonWithHoles() {
    InputStream stream =
        TestKmlToJtsPolygonConverter.class.getResourceAsStream("/kmlPolygonWithHoles.kml");
