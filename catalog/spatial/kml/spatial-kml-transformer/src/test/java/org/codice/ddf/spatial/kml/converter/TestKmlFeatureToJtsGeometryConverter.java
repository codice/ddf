...
public class TestKmlFeatureToJtsGeometryConverter {
  ...
  public void testConvertKmlDocumentFeature() {
    InputStream stream =
        TestKmlFeatureToJtsGeometryConverter.class.getResourceAsStream("/kmlDocument.kml");
  ...
  public void testConvertKmlFolderFeature() {
    InputStream stream =
        TestKmlFeatureToJtsGeometryConverter.class.getResourceAsStream("/kmlFolder.kml");
  ...
  public void testConvertKmlPlaceMarkFeature() {
    InputStream stream =
        TestKmlFeatureToJtsGeometryConverter.class.getResourceAsStream("/kmlPoint.kml");
  ...
  public void testConvertKmlPhotoOverlayFeature() {
    InputStream stream =
        TestKmlFeatureToJtsGeometryConverter.class.getResourceAsStream("/kmlPhotoOverlay.kml");
  ...
  public void testConvertKmlGroundOverlayFeature() {
    InputStream stream =
        TestKmlFeatureToJtsGeometryConverter.class.getResourceAsStream("/kmlGroundOverlay.kml");
  ...
  static void assertFeature(Feature kmlFeature, Geometry jtsGeometry) {
    if (kmlFeature instanceof Document) {
      TestKmlDocumentToJtsGeometryConverter.assertKmlDocument((Document) kmlFeature, jtsGeometry);
    }
    ...
    if (kmlFeature instanceof Placemark) {
      TestKmlPlacemarkToJtsGeometryConverter.assertPlacemark((Placemark) kmlFeature, jtsGeometry);
    }
    if (kmlFeature instanceof PhotoOverlay) {
      TestKmlPhotoOverlayToJtsPointConverter.assertKmlPhotoOverlayToJtsPoint(
          (PhotoOverlay) kmlFeature, (Point) jtsGeometry);
    }
    if (kmlFeature instanceof GroundOverlay) {
      TestKmlGroundOverlayToJtsGeometryConverter.assertKmlGroundOverlayToJtsGeometry(
