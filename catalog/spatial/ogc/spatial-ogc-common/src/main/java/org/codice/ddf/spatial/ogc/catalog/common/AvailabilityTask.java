...
public class AvailabilityTask implements Runnable {
  ...
  /**
   * Determines if the interval has elapsed before executing the {@link AvailabilityCommand}. It is
   * ideal this task is run on short intervals to check if the interval has elapsed.
   */
  @Override
  public void run() {
  ...
  /**
   * Update the timestamp based on last successful response. This timestamp is used to determine if
