...
public class Validator {
    ...
    public void validateOutputFormat(String format, TransformerManager mimeTypeTransformerManager)
        ...
        if (!StringUtils.isEmpty(format)) {
            if (!(DEFAULT_OUTPUT_FORMAT.equals(format) || MediaType.APPLICATION_OCTET_STREAM.equals(
                    format)) && mimeTypeTransformerManager != null
     ...
     * @throws CswException
     */
    public void validateTypeNameToNamespaceMappings(String typeNames, String namespaces,
