...
public class CswRecordCollectionMessageBodyWriterTest {
  ...
  @Test
  public void testWriteToWithSchema() throws IOException, CatalogTransformerException {
    ...
    writer.writeTo(collection, response);
  ...
  @Test
  public void testWriteValidate() throws IOException, CatalogTransformerException {
    CswRecordCollectionMessageBodyWriter writer =
        new CswRecordCollectionMessageBodyWriter(mockManager);
    when(mockManager.getTransformerBySchema(anyString())).thenReturn(mockTransformer);
  ...
  @Test
  public void testWriteToWithMimeType() throws IOException, CatalogTransformerException {
    CswRecordCollectionMessageBodyWriter writer =
        new CswRecordCollectionMessageBodyWriter(mockManager);
    ...
    collection.setMimeType("application/json");
    collection.setSourceResponse(mock(SourceResponse.class));
    QName example = new QName("example");
  ...
  @Test
  public void testWriteToProductData()
