...
public class UpdateAction extends CswAction {
  ...
  /**
   * Constructs an UpdateAction with the specified metacard, typeName, and handle. This UpdateAction
   * will replace the existing metacard having the same ID as {@code metacard} with {@code
   * metacard}.
   *
   ...
   * URIs. {@code prefixToUriMappings} should contain the prefix to URI mappings declared in the
   * transaction request XML.
   *
   * <p>This UpdateAction will update all metacards matching {@code constraint} by updating their
