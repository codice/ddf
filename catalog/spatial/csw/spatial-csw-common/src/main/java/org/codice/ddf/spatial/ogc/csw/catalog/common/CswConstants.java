...
public final class CswConstants {
    ...
    */
    ...
    public static final String EBRIM_RECORD =
            EBRIM_NAMESPACE_PREFIX + NAMESPACE_DELIMITER + EBRIM_RECORD_LOCAL_NAME;
    ...
    public static final List<String> VALID_SCHEMA_LANGUAGES = new ArrayList<>(Arrays.asList(
    ...
    static {
        ...
        OWS_BOUNDING_BOX_QNAME = new QName(OWS_NAMESPACE,
                OWS_BOUNDING_BOX,
                OWS_NAMESPACE_PREFIX);
    ...
    private static QName createDublinCoreTermQName(final String field) {
        return new QName(DUBLIN_CORE_TERMS_SCHEMA,
                field,
