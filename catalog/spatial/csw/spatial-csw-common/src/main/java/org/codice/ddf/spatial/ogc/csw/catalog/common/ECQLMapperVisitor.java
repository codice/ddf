 ...
 * then using ECQL.toFilter on cql that has one of those key words as a property name. This visitor
 * creates a new filter with those keywords quoted so ECQL.toFilter will work.
 */
