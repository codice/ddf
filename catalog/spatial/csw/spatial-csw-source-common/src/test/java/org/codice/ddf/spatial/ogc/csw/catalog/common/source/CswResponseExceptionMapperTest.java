...
public class CswResponseExceptionMapperTest {
  ...
  public void testEmptyCswException() {
    ...
    assertThat(
        cswException.getMessage(), containsString("Empty Exception Report (version = 1.2.0)"));
  }
  ...
  public void testCswExceptionWithCodeOnly() {
    ...
    assertThat(
        cswException.getMessage(), containsString("exceptionCode = INVALID_PARAMETER_VALUE"));
