...
public class TestCswSource extends TestCswSourceBase {
    ...
    public void testAddingContentTypesOnQueries()
        ...
        List<String> expectedNames = new LinkedList<>(Arrays.asList("a",
                "b",
                "c",
                "d",
                "e",
    ...
    public void testQueryWithSorting()
        ...
        assertThat(cswQuery.getSortBy()
                .getSortProperty()
                .get(0)
                .getSortOrder(), is(SortOrderType.DESC));
    }
    ...
    public void testPropertyIsLikeContentTypeVersion()
        ...
        Filter ctfilter = builder.attribute(Metacard.CONTENT_TYPE)
                .is()
                .text(format);
        Filter versionFilter = builder.attribute(Metacard.CONTENT_TYPE_VERSION)
                .is()
                .like()
                .text(version);
    ...
    public void testAbsoluteTemporalSearchPropertyIsBetweenQuery()
        ...
        Filter temporalFilter = builder.attribute(Metacard.EFFECTIVE)
                .is()
                .during()
    ...
    public void testAbsoluteTemporalSearchTwoRanges()
        ...
        Filter temporalFilter1 = builder.attribute(Metacard.EFFECTIVE)
                .is()
                .during()
                .dates(startDate.toDate(), endDate.toDate());
        Filter temporalFilter2 = builder.attribute(Metacard.EFFECTIVE)
                .is()
                .during()
    ...
    public void testRefreshWithNullConfiguration() throws SecurityServiceException {
        CswSource cswSource = getCswSource(null, null, "type", null, null);
    ...
    public void testRefresh() throws SecurityServiceException {
        CswSource cswSource = getCswSource(mockCsw, mockContext, "contentType");
        CswSourceConfiguration defaultCswSourceConfiguration = getStandardCswSourceConfiguration(
                "contentType",
                "qname",
                "queryprefix");
    ...
    public void testQueryWithAlternateQueryType()
        ...
        CswSource cswSource = getCswSource(mockCsw,
                mockContext,
                null,
    ...
    public void testCreateResults() throws SecurityServiceException {
        ...
        recordCollection.getCswRecords()
                .addAll(metacards);
    ...
    private void assertDefaultCswSourceConfiguration(CswSourceConfiguration cswSourceConfiguration,
            CswSourceConfiguration defaultCswSourceConfiguration) {
        assertThat(cswSourceConfiguration.getUsername(),
        ...
        assertThat(cswSourceConfiguration.isCqlForced(),
                is(defaultCswSourceConfiguration.isCqlForced()));
    }
    ...
    private Map<String, Object> getConfigurationMap(CswSource cswSource) {
        Map<String, Object> configuration = new HashMap<>();
