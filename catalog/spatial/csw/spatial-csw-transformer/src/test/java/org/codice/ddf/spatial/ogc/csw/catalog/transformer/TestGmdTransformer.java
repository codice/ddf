...
public class TestGmdTransformer {
    ...
    public void testDatasetToMetacard() throws Exception {
        ...
        assertThat(convertDate((Date) metacard.getAttribute(Core.CREATED)
                .getValue()), is("2004-03-10 00:00:00 UTC"));

        assertThat(convertDate((Date) metacard.getAttribute(Core.MODIFIED)
                .getValue()), is("2004-03-14 12:00:00 UTC"));
