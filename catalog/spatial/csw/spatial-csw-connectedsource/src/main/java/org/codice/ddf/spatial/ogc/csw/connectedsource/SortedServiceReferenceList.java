 ...
 */
package org.codice.ddf.spatial.ogc.csw.connectedsource;
 ...
 * <p>
 *
 * <p>It is an implementation of {@link List} but is backed by a sorted {@link TreeSet} of
...
public class SortedServiceReferenceList implements List<ServiceReference> {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(SortedServiceReferenceList.class);
