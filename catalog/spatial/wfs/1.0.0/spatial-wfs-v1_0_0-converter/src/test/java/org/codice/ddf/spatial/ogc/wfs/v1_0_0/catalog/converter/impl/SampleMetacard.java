...
public class SampleMetacard {
  ...
  public SampleMetacard() {
    ...
    metacard.setAttribute(
        new AttributeImpl(Core.LOCATION, "POLYGON ((30 10, 10 20, 20 40, 40 40, 30 10))"));
    ...
    descriptors.add(
        new AttributeDescriptorImpl("version", false, false, false, false, BasicTypes.LONG_TYPE));
    descriptors.add(
        new AttributeDescriptorImpl("end_date", false, false, false, false, BasicTypes.DATE_TYPE));
    descriptors.add(
        new AttributeDescriptorImpl(
            "filename", false, false, false, false, BasicTypes.STRING_TYPE));
    descriptors.add(
        new AttributeDescriptorImpl("height", false, false, false, false, BasicTypes.LONG_TYPE));
    descriptors.add(
        new AttributeDescriptorImpl(
            "index_id", false, false, false, false, BasicTypes.STRING_TYPE));
    descriptors.add(
        new AttributeDescriptorImpl(
            "other_tags_xml", false, false, false, false, BasicTypes.STRING_TYPE));
    descriptors.add(
        new AttributeDescriptorImpl(
            "repository_id", false, false, false, false, BasicTypes.LONG_TYPE));
    descriptors.add(
        new AttributeDescriptorImpl(
            "start_date", false, false, false, false, BasicTypes.DATE_TYPE));
    descriptors.add(
        new AttributeDescriptorImpl(
            "style_id", false, false, false, false, BasicTypes.INTEGER_TYPE));
    descriptors.add(
        new AttributeDescriptorImpl("width", false, false, false, false, BasicTypes.LONG_TYPE));
    descriptors.add(
        new AttributeDescriptorImpl(
            "ground_geom", false, false, false, false, BasicTypes.GEO_TYPE));
