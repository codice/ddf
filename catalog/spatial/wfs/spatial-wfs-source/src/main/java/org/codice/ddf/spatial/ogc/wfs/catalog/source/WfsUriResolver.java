...
/**
 * This class is used by {@link org.apache.ws.commons.schema.XmlSchema} to override the {@link
 * DefaultURIResolver}. It is used to resolve schemas defined by "import" and"include".
 */
public class WfsUriResolver extends DefaultURIResolver {
  ...
  /**
   * Try to resolve a schema location to some data. If the namespace is that of WFS or GML ignore it
   * because we already have our own bindings and this will only slow the schema creation down.
   *
