...
public class XStreamWfs20FeatureTransformer extends XStreamWfsFeatureTransformer<FeatureTypeType> {
  ...
  protected FeatureConverter getGenericFeatureConverter(MetacardMapper metacardMapper) {
    return new GenericFeatureConverterWfs20(metacardMapper);
  }

  @Override
  protected FeatureConverter getGenericFeatureConverter(FeatureTypeType featureType) {
    return new GenericFeatureConverterWfs20();
  }
