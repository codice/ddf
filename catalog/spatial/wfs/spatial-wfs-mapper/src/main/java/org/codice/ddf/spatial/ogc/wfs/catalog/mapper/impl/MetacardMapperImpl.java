...
public class MetacardMapperImpl implements MetacardMapper {
    ...
    public String getFeatureProperty(String metacardAttribute) {
        ...
        LOGGER.debug("Returning feature property {} for metacard attribute {}",
                featureProperty,
                metacardAttribute);
    ...
    public String getMetacardAttribute(String featureProperty) {
        String metacardAttribute = bidiMap.inverseBidiMap()
                .get(featureProperty);
        LOGGER.debug("Returning metacard attribute {} for feature property {}.",
                metacardAttribute,
                featureProperty);
