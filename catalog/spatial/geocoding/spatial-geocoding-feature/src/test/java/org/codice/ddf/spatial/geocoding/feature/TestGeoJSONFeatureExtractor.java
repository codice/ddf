...
public class TestGeoJSONFeatureExtractor {
  private static final String JAMAICA_GEOJSON_PATH =
      TestGeoJSONFeatureExtractor.class.getResource("/geojson/afghanistan.geojson").getPath();

  private static final String EMPTY_GEOJSON_PATH =
      TestGeoJSONFeatureExtractor.class.getResource("/geojson/empty.geojson").getPath();

  private static final String NA_GEOJSON_PATH =
      TestGeoJSONFeatureExtractor.class.getResource("/geojson/northamerica.geojson").getPath();

  private static final String BAD_GEOJSON_PATH =
      TestGeoJSONFeatureExtractor.class.getResource("/geojson/bad.geojson").getPath();
