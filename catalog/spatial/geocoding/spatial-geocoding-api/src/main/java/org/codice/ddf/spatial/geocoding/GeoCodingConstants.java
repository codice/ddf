...
public final class GeoCodingConstants {
  ...
  public static final int COUNTRY_GAZETTEER_SORT_VALUE = 1;

  public static final int POPULATION_OVER_400K = 2;

  public static final int POPULATION_LT_400K_GT_350K = 3;

  public static final int POPULATION_LT_350K_GT_300K = 4;

  public static final int POPULATION_LT_300K_GT_250K = 5;

  public static final int POPULATION_LT_250K_GT_200K = 6;

  public static final int POPULATION_LT_200K_GT_150K = 7;

  public static final int POPULATION_LT_150K_GT_100K = 8;

  public static final int POPULATION_LT_100K_GT_50K = 9;

  public static final int POPULATION_UNDER_50K = 10;
