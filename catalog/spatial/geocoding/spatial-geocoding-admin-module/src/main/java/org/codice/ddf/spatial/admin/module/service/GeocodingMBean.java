...
public interface GeocodingMBean {
  ...
  /**
   * Calls {@link org.codice.ddf.spatial.geocoding.GeoEntryIndexer#updateIndex} with the given URL
   * and country code.
   *
   * @param url - the URL of the GeoNames server
   * @param createIndex - true if the index is to be created, false if the index is to be appended
   *     to
  ...
  /**
   * Calls {@link org.codice.ddf.spatial.geocoding.GeoEntryIndexer#updateIndex} with the given path
   ...
   *
   * @return The current value of the progressCallback in the {@link
