...
public class TestRegistryReportActionProvider {
    ...
    public void testMetacardNull() {
        assertThat(new RegistryReportActionProvider(ACTION_PROVIDER_ID).getActions(null),
                hasSize(0));
    }
    ...
    public void testMetacard() {
        ...
        assertThat(action.getUrl()
                .toString(), is(expectedDefaultAddressWith(metacard.getAttribute(
    ...
    public void testSecureMetacard() {
        ...
        assertEquals(
                SAMPLE_SECURE_PROTOCOL + SAMPLE_IP + ":" + SAMPLE_SECURE_PORT + SAMPLE_SERVICES_ROOT
                        ...
                        .getValue()
                        .toString() + PATH_AND_FORMAT + SOURCE_ID_QUERY_PARAM + SAMPLE_SOURCE_ID,
                action.getUrl()
                        .toString());
        assertEquals(ACTION_PROVIDER_ID, actionProvider.getId());
    ...
    public void testBlankSourceId() {
        ...
        assertThat(action.getUrl()
                        .toString(),
                is(SAMPLE_PROTOCOL + SAMPLE_IP + ":" + SAMPLE_PORT + SAMPLE_SERVICES_ROOT
                        + SAMPLE_PATH
                        + metacard.getAttribute(RegistryObjectMetacardType.REGISTRY_ID)
                        .getValue()
                        .toString() + PATH_AND_FORMAT));
    }
    ...
    public void testEmptyConfigurationsSource() throws IOException, InvalidSyntaxException {
        ...
        when(configurationAdmin.listConfigurations(String.format("(id=%s)",
                SAMPLE_SOURCE_ID))).thenReturn(configurations);
