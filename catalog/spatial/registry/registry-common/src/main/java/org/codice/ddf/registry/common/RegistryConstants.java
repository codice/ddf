...
public class RegistryConstants {
    ...
    public static final String REGISTRY_TAG_INTERNAL = "registry.internal";
    ...
    public static final String REGISTRY_ID_PROPERTY = "org.codice.ddf.registry.registry-id";
    ...
    public static final String REGISTRY_ORIGIN_REG_ID = "urn:registry:registry-origin-id";

    public static final String REGISTRY_ORIGIN_MCARD_ID = "urn:registry:metacard-origin-id";
