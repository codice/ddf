...
public class RegistryTransformerTest {
  ...
  public void testParserReturnNull() throws Exception {
    ...
    when((mockParser)
            .unmarshal(any(ParserConfigurator.class), any(Class.class), any(InputStream.class)))
        .thenReturn(null);
  ...
  public void testJaxbElementNullValue() throws Exception {
    ...
    when((mockParser)
            .unmarshal(any(ParserConfigurator.class), any(Class.class), any(InputStream.class)))
        .thenReturn(mockRegistryObjectType);
  ...
  public void testBasicInfo() throws Exception {
    ...
    assertThat(
        RegistryUtility.getStringAttribute(meta, RegistryObjectMetacardType.REGISTRY_ID, null),
        is("urn:uuid:2014ca7f59ac46f495e32b4a67a51276"));
  ...
  public void testOrgInfo() throws Exception {
    ...
    assertThat(
        RegistryUtility.getStringAttribute(metacard, Contact.POINT_OF_CONTACT_NAME, null),
        is("Codice"));
    assertThat(
        RegistryUtility.getListOfStringAttribute(metacard, Contact.POINT_OF_CONTACT_ADDRESS),
    ...
    assertThat(
        RegistryUtility.getListOfStringAttribute(metacard, Contact.POINT_OF_CONTACT_EMAIL),
  ...
  public void testCustomSlotSaved() throws Exception {
    ...
    assertThat(
        convert("/custom-slot-service.xml").getMetadata().contains("unknowSlotName"), is(true));
  }
  ...
  public void testServiceWithMinimumBinding() throws Exception {
    ...
    assertThat(
        RegistryUtility.getStringAttribute(
            metacard, RegistryObjectMetacardType.SERVICE_BINDING_TYPES, null),
        is("csw"));
  }
  ...
  public void testServiceWithMultipleBindings() throws Exception {
    ...
    List<String> serviceBindingTypes =
        RegistryUtility.getListOfStringAttribute(
            metacard, RegistryObjectMetacardType.SERVICE_BINDING_TYPES);
  ...
  public void testLastUpdated() throws Exception {
    ...
    String utc = ((Date) metacard.getAttribute(Core.MODIFIED).getValue()).toInstant().toString();
  ...
  public void testPersonNoext() throws Exception {
    ...
    assertThat(
        RegistryUtility.getStringAttribute(metacard, Metacard.POINT_OF_CONTACT, null),
  ...
  public void testServiceBindingWithMultipleTypes() throws Exception {
    ...
    List<String> serviceBindingsList =
        RegistryUtility.getListOfStringAttribute(
            metacard, RegistryObjectMetacardType.SERVICE_BINDING_TYPES);
  ...
  public void testFullRegistryPackage() throws Exception {
    ...
    assertThat(
        RegistryUtility.getStringAttribute(metacard, Core.CREATED, null), is(date.toString()));

    date = Date.from(ZonedDateTime.parse("2015-11-01T13:15:30Z").toInstant());
    assertThat(
        RegistryUtility.getStringAttribute(metacard, DateTime.START, null), is(date.toString()));

    date = Date.from(ZonedDateTime.parse("2015-12-01T23:01:40Z").toInstant());
    assertThat(
        RegistryUtility.getStringAttribute(metacard, DateTime.END, null), is(date.toString()));

    date = Date.from(ZonedDateTime.parse("2016-01-26T17:16:34.996Z").toInstant());
    assertThat(
        RegistryUtility.getStringAttribute(metacard, Core.MODIFIED, null), is(date.toString()));

    assertThat(
        RegistryUtility.getStringAttribute(metacard, RegistryObjectMetacardType.LINKS, null),
        is("https://some/link/to/my/repo"));

    assertThat(
        RegistryUtility.getStringAttribute(metacard, Core.LOCATION, null),
        is("POINT (112.267472 33.467944)"));
    assertThat(
        RegistryUtility.getStringAttribute(metacard, RegistryObjectMetacardType.REGION, null),
        is("USA"));

    List<String> attributeValuesList =
        RegistryUtility.getListOfStringAttribute(metacard, RegistryObjectMetacardType.DATA_SOURCES);
    ...
    attributeValuesList =
        RegistryUtility.getListOfStringAttribute(
            metacard, RegistryObjectMetacardType.SERVICE_BINDINGS);
    assertThat(attributeValuesList.size(), is(2));
  ...
  public void testMultipleOrgsOneEmpty() throws Exception {
    ...
    assertThat(
        ...
        is(nullValue()));
    assertThat(
        RegistryUtility.getStringAttribute(metacard, Contact.POINT_OF_CONTACT_ADDRESS, null),
        is(nullValue()));
    assertThat(
        RegistryUtility.getStringAttribute(metacard, Contact.POINT_OF_CONTACT_PHONE, null),
        is(nullValue()));
    assertThat(
        RegistryUtility.getStringAttribute(metacard, Contact.POINT_OF_CONTACT_EMAIL, null),
        is(nullValue()));
  }
  ...
  public void testMultiplePersonsOneEmpty() throws Exception {
    ...
    assertThat(metacard.getPointOfContact(), is("no name, no telephone number, no email address"));
  }
