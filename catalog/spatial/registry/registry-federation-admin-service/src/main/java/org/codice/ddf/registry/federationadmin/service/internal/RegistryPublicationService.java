...
public interface RegistryPublicationService {
   ...
   * The local metacard's last published time will also be updated. The updated metacard will be
   ...
   * @throws FederationAdminException if there were problems writing to the remote registry or
   *     updating the local metacard
   */
   ...
   *
   * <p>The remote destination will be removed from the local metacard's list of published
   * locations. The local metacard's last published time will also be updated. The updated metacard
   * will be written to the local store.
   *
   ...
   * @throws FederationAdminException if there were problems deleting from the remote registry or
   *     updating the local metacard
   */
   ...
   * locations.
   *
   * <p>The metacard's last published time will be updated and the updated metacard will be written
   * to the local store.
   *
   * @param metacard the metacard up write
   * @throws FederationAdminException if there are any problems updating the local or remote
   *     registries.
   */
