...
public class SpecificationLinkWebConverter extends RegistryObjectWebConverter {
   ...
   *
   * @param specificationLink the SpecificationLinkType to be converted into a map, null returns
   *     empty Map
  ...
  public Map<String, Object> convert(SpecificationLinkType specificationLink) {
    ...
    webMapHelper.putAllIfNotEmpty(
        specificationLinkMap, super.convertRegistryObject(specificationLink));
    webMapHelper.putIfNotEmpty(
        specificationLinkMap, SERVICE_BINDING, specificationLink.getServiceBinding());
    webMapHelper.putIfNotEmpty(
        specificationLinkMap, SPECIFICATION_OBJECT, specificationLink.getSpecificationObject());
    webMapHelper.putIfNotEmpty(
        specificationLinkMap, USAGE_DESCRIPTION, specificationLink.getUsageDescription());
    webMapHelper.putIfNotEmpty(
        specificationLinkMap, USAGE_PARAMETERS, specificationLink.getUsageParameter());
