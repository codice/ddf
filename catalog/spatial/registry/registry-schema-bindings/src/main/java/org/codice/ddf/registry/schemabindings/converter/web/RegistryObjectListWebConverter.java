...
public class RegistryObjectListWebConverter {
  ...
  /**
   * This method creates a Map<String, Object> representation of the RegistryObjectListType
   ...
   * <p>
   *
   * <p>Uses: AssociationWebConverter ExtrinsicObjectWebConverter OrganizationWebConverter
   * PersonWebConverter ServiceWebConverter
   *
   * @param registryObjectList the RegistryObjectListType to be converted into a map, null returns
   *     empty Map
  ...
  public Map<String, Object> convert(RegistryObjectListType registryObjectList) {
    ...
    for (JAXBElement<? extends IdentifiableType> identifiable :
