...
public class ClassificationTypeConverter
  ...
  /**
   * This method creates an ClassificationType from the values in the provided map. The following
   ...
   *
   * @param map the Map representation of the ClassificationType to generate, null returns empty
   *     Optional
  ...
  public Optional<ClassificationType> convert(Map<String, Object> map) {
    ...
    optionalClassification =
        mapToSchemaElement.populateStringElement(
            ...
            CLASSIFICATION_NODE,
            optionalClassification,
            (valueToPopulate, classification) ->
