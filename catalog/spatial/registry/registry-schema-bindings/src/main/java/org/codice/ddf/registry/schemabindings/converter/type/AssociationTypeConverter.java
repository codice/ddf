...
public class AssociationTypeConverter
  ...
  /**
   * This method creates an AssociationType1 from the values in the provided map. The following keys
   * are expected in the provided map (Taken from EbrimConstants):
   *
   * <p>ASSOCIATION_TYPE = "associationType"; SOURCE_OBJECT = "sourceObject"; TARGET_OBJECT =
   * "targetObject";
   *
   * <p>This will also try to populate the RegistryObjectType values also looked for in the map.
   *
   * @param map the Map representation of the AssociationType1 to generate, null returns empty
   *     Optional
