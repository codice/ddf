...
public class ExternalIdentifierTypeConverter
  ...
  /**
   * This method creates an ExternalIdentifierType from the values in the provided map. The
   ...
   *
   * @param map the Map representation of the ExternalIdentifierType to generate, null returns empty
   *     Optional
  ...
  public Optional<ExternalIdentifierType> convert(Map<String, Object> map) {
    ...
    optionalExternalIdentifier =
        mapToSchemaElement.populateStringElement(
            ...
            optionalExternalIdentifier,
            (valueToPopulate, externalIdentifier) ->
                externalIdentifier.setIdentificationScheme(valueToPopulate));
    ...
    optionalExternalIdentifier =
        mapToSchemaElement.populateStringElement(
            ...
            optionalExternalIdentifier,
            (valueToPopulate, externalIdentifier) ->
                externalIdentifier.setRegistryObject(valueToPopulate));
