...
public class PostalAddressWebConverter {
  ...
  /**
   * This method creates a Map<String, Object> representation of the PostalAddressType provided. The
  ...
  public Map<String, Object> convert(PostalAddressType postalAddress) {
    ...
    webMapHelper.putIfNotEmpty(addressMap, STATE_OR_PROVINCE, postalAddress.getStateOrProvince());
