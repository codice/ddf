...
public class WebMapHelper {
  ...
  public void putIfNotEmpty(Map<String, Object> map, String key, VersionInfoType versionInfoType) {
  ...
  public void putIfNotEmpty(
      Map<String, Object> map, String key, InternationalStringType internationalStringType) {
