...
public class AssociationWebConverter extends RegistryObjectWebConverter {
  ...
  /**
   * This method creates a Map<String, Object> representation of the AssociationType1 provided. The
  ...
  public Map<String, Object> convert(AssociationType1 association) {
    ...
    webMapHelper.putIfNotEmpty(associationMap, ASSOCIATION_TYPE, association.getAssociationType());
