...
public class RegistryPackageTypeHelper {
   ...
   * @return a List containing the ServiceBindingTypes found in the RegistryPackageType an empty
   *     list if the RegistryPackageType provided is null
   */
  public List<ServiceBindingType> getBindingTypes(RegistryPackageType registryPackage) {
    ...
    return getServices(registryPackage)
        .stream()
        .flatMap(service -> service.getServiceBinding().stream())
   ...
   *
   * @param registryObjectList the RegistryObjectListType that will be crawled null returns an empty
   *     list
   * @return a List containing the ServiceBindingTypes found in the RegistryObjectListType an empty
   *     list if the RegistryObjectListType provided is null
   */
  public List<ServiceBindingType> getBindingTypes(RegistryObjectListType registryObjectList) {
    ...
    return getServices(registryObjectList)
        .stream()
        .flatMap(service -> service.getServiceBinding().stream())
        .collect(Collectors.toList());
  }
   ...
   *
   * @param registryPackage the RegistryPackageType that will be crawled null returns an empty list
   * @return a List containing the ServiceTypes found in the RegistryPackageType an empty list if
   *     the RegistryPackageType provided is null
   */
   ...
   * @param registryObjectList the RegistryObjectListType that will be crawled null returns an empty
   *     list
   * @return a List containing the ServiceTypes found in the RegistryObjectListType an empty list if
   *     the RegistryObjectListType provided is null
   */
   ...
   *
   * @param registryPackage the RegistryPackageType that will be crawled null returns an empty list
   * @return a List containing the ExtrinsicObjectTypes found in the RegistryPackageType an empty
   *     list if the RegistryPackageType provided is null
   */
   ...
   * @param registryObjectList the RegistryObjectListType that will be crawled null returns an empty
   *     list
   * @return a List containing the ExtrinsicObjectTypes found in the RegistryObjectListType an empty
   *     list if the RegistryObjectListType provided is null
   */
  public List<ExtrinsicObjectType> getExtrinsicObjects(RegistryObjectListType registryObjectList) {
   ...
   *
   * @param registryPackage the RegistryPackageType that will be crawled null returns an empty list
   * @return a List containing the OrganizationTypes found in the RegistryPackageType an empty list
   *     if the RegistryPackageType provided is null
   */
   ...
   * @param registryObjectList the RegistryObjectListType that will be crawled null returns an empty
   *     list
   * @return a List containing the OrganizationTypes found in the RegistryObjectListType an empty
   *     list if the RegistryObjectListType provided is null
   */
   ...
   *
   * @param registryPackage the RegistryPackageType that will be crawled null returns an empty list
   * @return a List containing the PersonTypes found in the RegistryPackageType an empty list if the
   *     RegistryPackageType provided is null
   */
   ...
   * @param registryObjectList the RegistryObjectListType that will be crawled null returns an empty
   *     list
   * @return a List containing the PersonTypes found in the RegistryObjectListType an empty list if
   *     the RegistryObjectListType provided is null
   */
   ...
   *
   * @param registryPackage the RegistryPackageType that will be crawled null returns an empty list
   * @return a List containing the AssociationTypes found in the RegistryPackageType an empty list
   *     if the RegistryPackageType provided is null
   */
   ...
   * RegistryObjectListType
   *
   * @param registryObjectList the RegistryObjectListType that will be crawled, null returns an
   *     empty list
   ...
   *
   * @param registryObjectList the RegistryObjectList that will be crawled, null returns an empty
   *     list
   * @param id to be used as the sourceObjectId of the Association
   * @param type Type of the object to find associations for
   * @return a List containing the objects associated to the provided id
  ...
  public <T extends RegistryObjectType> List<T> getAssociatedObjects(
    ...
    return getObjectsFromRegistryObjectList(registryObjectList, type)
        .stream()
  ...
  public <T extends RegistryObjectType> List<T> getAssociatedObjects(String id, Class<T> type) {
    ...
    return getObjectsFromRegistryObjectList(registryPackageType, type)
        .stream()
        .filter(isAssociatedObject(targetObjectIds))
        .collect(Collectors.toList());
  }
  ...
  private Set<String> getAssociationTargetObjectIds(
      RegistryObjectListType registryObjectList, String sourceId) {
    if (registryObjectList == null) {
      return new HashSet<>();
    }
    return getAssociations(registryObjectList)
        .stream()
  ...
  private void populateLists() {
    ...
    if (registryPackageType.isSetRegistryObjectList()) {
      ...
      for (JAXBElement<? extends IdentifiableType> identifiableType :
