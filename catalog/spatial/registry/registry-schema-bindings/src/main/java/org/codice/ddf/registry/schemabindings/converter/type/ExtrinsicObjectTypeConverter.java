...
public class ExtrinsicObjectTypeConverter
  ...
  /**
   * This method creates an ExtrinsicObjectType from the values in the provided map. The following
   ...
   *
   * @param map the Map representation of the ExtrinsicObjectType to generate, null returns empty
   *     Optional
  ...
  public Optional<ExtrinsicObjectType> convert(Map<String, Object> map) {
    ...
    optionalExtrinsicObject =
        mapToSchemaElement.populateBooleanElement(
            map,
            IS_OPAQUE,
            optionalExtrinsicObject,
