...
public class SlotTypeHelperTest {
    ...
    public static void setUpOnce() throws Exception {
        ...
        configurator = parser.configureParser(Arrays.asList(RegistryObjectType.class.getPackage()
                ...
                EbrimConstants.GML_FACTORY.getClass()
                        .getPackage()
                        .getName()), SlotTypeHelper.class.getClassLoader());
    ...
    public void testGetNameSlotMap() throws Exception {
        RegistryObjectType rot = getRegistryObjectFromResource(
                "/registry-package-slots-only-with-dup.xml");
        ...
        String value = stHelper.getStringValues(serviceType)
                .get(0);
    ...
    public void getNameSlotMapDuplicateSlotNamesAllowed() throws Exception {
        ...
        for (SlotType1 serviceTypeSlot : serviceTypes) {
            String value = stHelper.getStringValues(serviceTypeSlot)
                    .get(0);
    ...
    public void testGetStringValues() throws Exception {
        ...
        for (SlotType1 slot : slots) {
            String slotTypeUC = slot.getSlotType()
                    .toUpperCase();
            ...
            if (!slotTypeUC.contains("DATE")) {
                ...
                if (slot.getName()
                        .equals("inputDataSources") || slot.getName()
                        .equals("dataTypes")) {
