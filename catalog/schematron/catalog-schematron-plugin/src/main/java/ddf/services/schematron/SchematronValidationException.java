...
public class SchematronValidationException extends ValidationExceptionImpl {
    ...
    public SchematronValidationException(Throwable cause, List<String> errors,
            List<String> warnings) {
    ...
    public SchematronValidationException(String message, Throwable cause, List<String> errors,
            List<String> warnings) {
