...
public class SchematronValidationService implements MetacardValidator {
     ...
     * @param bundle                   OSGi bundle containing sch file that will be using this service
     * @param schematronSchemaFilename client-provided Schematron rules in XML-format, usually with a .sch file extension
     * @param suppressWarnings         indicates whether to suppress Schematron validation warnings and indicate that a
     ...
     * @param bundle                   OSGi bundle containing sch file that will be using this service
     * @param schematronSchemaFilename client-provided Schematron rules in XML-format, usually with a .sch file extension
     * @param bundleBaseDir            base directory in the bundle for getting resources out of the bundle
     * @param suppressWarnings         indicates whether to suppress Schematron validation warnings and indicate that a
     *                                 Catalog Entry with only warnings is valid
     * @throws SchematronInitializationException
     */
     ...
     *
     * @param catalogEntryNum of the catalog entry being validated (ranges from 1 to n)
