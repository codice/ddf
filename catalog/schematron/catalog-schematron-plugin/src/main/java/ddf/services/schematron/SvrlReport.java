...
public class SvrlReport implements SchematronReport 
{
	...
	/** 
	 * SVRL report tag for flag attribute in a svrl:failed-assert element that indicates 
	 * if the failure is an error or warning 
	 */
	 ...
	 * 
	 *  Example:
	 *  <svrl:failed-assert test="if(invalid) then 1 else not($hasInvalids)"
     *                 flag="warning"> 
     *  ...
     *  </svrl:failed-assert>
	 */
	...
	/**
	 * Private default constructor to prevent instantiating SvrlReport without
	 * required DOMResult argument.
	 */
	private SvrlReport()
	{
