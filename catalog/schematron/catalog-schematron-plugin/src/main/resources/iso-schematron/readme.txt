...
XSLT tab
 ...
 XSL_URL:$iso_dsdl_include.xsl
 Transformer:Saxon-B 9.1.0.6
Output Tab
 Save As "Step1.xsl"
 Checkmark "Open in XML Editor"
...
XSLT tab
 XML URL:${currentFileURL} or Step1.xsl
 XSL_URL:$iso_abstract_expand.xsl
 Transformer:Saxon-B 9.1.0.6
Output Tab
 Save As "Step2.xsl"
 Checkmark "Open in XML Editor"
...
XSLT tab
 XML URL:${currentFileURL} or Step2.xsl
 XSL_URL:$iso_svrl_for_xslt2.xsl
 Transformer:Saxon-B 9.1.0.6
Output Tab
 Save As "Step3.xsl"
 Checkmark "Open in XML Editor"
