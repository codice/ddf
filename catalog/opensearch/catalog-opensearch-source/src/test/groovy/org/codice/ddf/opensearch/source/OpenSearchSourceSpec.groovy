...
class OpenSearchSourceSpec extends Specification {
    ...
    def 'testQueries #filter'(Filter filter, Map<String, Object> expectedQueryParameters) throws UnsupportedQueryException {
        ...
        expectedQueryParameters << [
                ...
                //multiple geometry filters
                [start: ["1"], count: ["20"], mt: ["0"], q: ["someSearchPhrase"], dtstart: ["1970-01-01T00:00:10.000Z"], dtend: ["1970-01-01T00:00:10.005Z"], geometry:["GEOMETRYCOLLECTION (POLYGON ((1.0000449333831423 2.0000000550958474, 1.0000000547731072 1.999954791726554, 0.9999550666425013 1.9999999449027324, 0.999999945250056 2.0000452082732347, 1.0000449333831423 2.0000000550958474)), POLYGON ((7.226139911476106 0, 5.119984290991648 -5.144155513526761, -0.0241711783546176 -7.269631875480295, -5.119666214239614 -5.0960072200722095, -7.178433793970661 0.0000000000000055, -5.119666214239606 5.0960072200722175, -0.0241711783545997 7.269631875480295, 5.119984290991665 5.144155513526745, 7.226139911476106 0)))"], src: [""]],
