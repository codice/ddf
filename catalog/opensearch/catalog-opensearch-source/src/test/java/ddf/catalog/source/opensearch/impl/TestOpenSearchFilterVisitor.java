...
public class TestOpenSearchFilterVisitor {
    ...
    public void testNotFilter() {
        ...
        OpenSearchFilterVisitorObject result =
                (OpenSearchFilterVisitorObject) openSearchFilterVisitor.visit(notFilter,
    ...
    public void testOrFilter() {
        ...
        OpenSearchFilterVisitorObject openSearchFilterVisitorObject =
                new OpenSearchFilterVisitorObject();
        OpenSearchFilterVisitorObject result =
                (OpenSearchFilterVisitorObject) openSearchFilterVisitor.visit(orFilter,
                        openSearchFilterVisitorObject);
        assertThat(openSearchFilterVisitorObject, is(result));
    }
    ...
    public void testAndFilter() {
        ...
        OpenSearchFilterVisitorObject openSearchFilterVisitorObject =
                new OpenSearchFilterVisitorObject();
        OpenSearchFilterVisitorObject result =
                (OpenSearchFilterVisitorObject) openSearchFilterVisitor.visit(andFilter,
                        openSearchFilterVisitorObject);
        assertThat(openSearchFilterVisitorObject, is(result));
    }
    ...
    public void testDWithin() {
        DWithin dWithinFilter = (DWithin) geotoolsFilterBuilder.attribute(Core.LOCATION)
                .is()
                .withinBuffer()
                .wkt(WKT_POINT);
        OpenSearchFilterVisitorObject openSearchFilterVisitorObject =
    ...
    public void testIntersects() {
        Intersects intersectsFilter = (Intersects) geotoolsFilterBuilder.attribute(Core.TITLE)
                .intersecting()
                .wkt(WKT_POLYGON);
        OpenSearchFilterVisitorObject openSearchFilterVisitorObject =
                new OpenSearchFilterVisitorObject();
    ...
    public void testOverlaps() {
        During during = (During) geotoolsFilterBuilder.attribute(Core.TITLE)
                .during()
                .dates(START_DATE, END_DATE);
        TOverlaps overlapsFilter = new TOverlapsImpl(during.getExpression1(),
                during.getExpression2());
        OpenSearchFilterVisitorObject openSearchFilterVisitorObject =
                new OpenSearchFilterVisitorObject();
        openSearchFilterVisitorObject.setCurrentNest(NestedTypes.AND);
        OpenSearchFilterVisitorObject result =
                (OpenSearchFilterVisitorObject) openSearchFilterVisitor.visit(overlapsFilter,
                        openSearchFilterVisitorObject);
    ...
    public void testOverlapsInstant() {
        After after = (After) geotoolsFilterBuilder.attribute(Core.TITLE)
                .after()
                .date(new Date());
        TOverlaps overlapsFilter = new TOverlapsImpl(after.getExpression1(),
                after.getExpression2());
        OpenSearchFilterVisitorObject openSearchFilterVisitorObject =
                new OpenSearchFilterVisitorObject();
        openSearchFilterVisitorObject.setCurrentNest(NestedTypes.AND);
        OpenSearchFilterVisitorObject result =
    ...
    public void testDuring() {
        ...
        openSearchFilterVisitorObject.setCurrentNest(NestedTypes.AND);
        OpenSearchFilterVisitorObject result =
                (OpenSearchFilterVisitorObject) openSearchFilterVisitor.visit(during,
                        openSearchFilterVisitorObject);
    ...
    public void testDuringOrNest() {
        During overlaps = (During) geotoolsFilterBuilder.attribute(Core.TITLE)
                .during()
                .dates(START_DATE, END_DATE);
        OpenSearchFilterVisitorObject openSearchFilterVisitorObject =
                new OpenSearchFilterVisitorObject();
        openSearchFilterVisitorObject.setCurrentNest(NestedTypes.OR);
        OpenSearchFilterVisitorObject result =
                (OpenSearchFilterVisitorObject) openSearchFilterVisitor.visit(overlaps,
                        openSearchFilterVisitorObject);
        TemporalFilter temporalSearch = result.getTemporalSearch();
    ...
    public void testPropertyIsLike() {
        PropertyIsLike textLikeFilter = (PropertyIsLike) geotoolsFilterBuilder.attribute(Core.TITLE)
                .is()
                .like()
                .text(TEST_STRING);
        OpenSearchFilterVisitorObject openSearchFilterVisitorObject =
                new OpenSearchFilterVisitorObject();
        OpenSearchFilterVisitorObject result =
                (OpenSearchFilterVisitorObject) openSearchFilterVisitor.visit(textLikeFilter,
                        openSearchFilterVisitorObject);
    ...
    public void testPropertyIsLikeNonSearchTerm() {
        ...
        openSearchFilterVisitorObject.setContextualSearch(new ContextualSearch(Core.TITLE,
                searchPhraseMap,
                true));
    ...
    public void testPropertyEqualTo() {
        PropertyIsEqualTo propertyIsEqualToFilter =
                (PropertyIsEqualTo) geotoolsFilterBuilder.attribute(Core.ID)
                        .is()
                        .equalTo()
                        .text(TEST_STRING);
        OpenSearchFilterVisitorObject openSearchFilterVisitorObject =
                new OpenSearchFilterVisitorObject();
        OpenSearchFilterVisitorObject result =
                (OpenSearchFilterVisitorObject) openSearchFilterVisitor.visit(
                        propertyIsEqualToFilter,
                        openSearchFilterVisitorObject);
    ...
    public void testPropertyEqualToNotIdAttribute() {
        PropertyIsEqualTo propertyIsEqualToFilter =
                (PropertyIsEqualTo) geotoolsFilterBuilder.attribute(Core.TITLE)
                        .is()
                        .equalTo()
                        .text(TEST_STRING);
        OpenSearchFilterVisitorObject openSearchFilterVisitorObject =
