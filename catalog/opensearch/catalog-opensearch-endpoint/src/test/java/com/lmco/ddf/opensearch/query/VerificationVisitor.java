...
{
    private static final XLogger LOGGER = new XLogger( LoggerFactory.getLogger( VerificationVisitor.class ) );
    ...
    public Object visit( Function expression, Object data )
    {
        ...
        LOGGER.debug( indent( indent + 2 ) + "FUNCTION:" + " " + expression.getName() + SEPARATOR + expression.getClass().getName() );
    ...
    public Object visit( PropertyName expression, Object data )
    {
        ...
        LOGGER.debug( indent( indent + 2 ) + expression.getPropertyName() + SEPARATOR + expression.getClass().getName() );
    ...
    public Object visit( Literal expression, Object data )
    {
        ...
        LOGGER.debug( indent( indent ) + expression.getValue() + VerificationVisitor.SEPARATOR + expression.getClass().getName() );
        return data;
    }
