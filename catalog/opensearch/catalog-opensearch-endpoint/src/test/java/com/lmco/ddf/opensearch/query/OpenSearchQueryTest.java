...
public class OpenSearchQueryTest
{
    ...
    public void testComplexContextualFilterPhrases()
    {
        ...
        testKeywordFiler("A \"test keyword2 keyword3\" OR test2",
                filterBuilder.anyOf(  //OR
                        filterBuilder.allOf(getKeywordAttributeFilter("A"), getKeywordAttributeFilter("test keyword2 keyword3")),  //A AND test keyword2 keyword3
                        getKeywordAttributeFilter("test2")));  //test2

        testKeywordFiler("A ((\"test\" OR test2) NOT test3)",
                filterBuilder.allOf(                   //AND
                        getKeywordAttributeFilter("A"), //A
                        filterBuilder.allOf(    //AND
                            filterBuilder.anyOf(getKeywordAttributeFilter("test"), getKeywordAttributeFilter("test2")), //test OR test2
        ...
        testKeywordFiler("some!keyword*1 ((\"test keyword1 keyword!1#A\" OR test2) NOT test3)",
                filterBuilder.allOf(                   //AND
                        ...
                        filterBuilder.allOf(    //AND
                                filterBuilder.anyOf(getKeywordAttributeFilter("test keyword1 keyword!1#A"), getKeywordAttributeFilter("test2")), //test keyword1 keyword!1#A OR test2
                                filterBuilder.not(getKeywordAttributeFilter("test3"))))); // NOT test3
    }
    ...
    public void testComplexContextualFilterGroups()
    {
        ...
        testKeywordFiler("( (Apple) AND ((Orange OR Banana)   ) NOT (Strawberry )  )",
        		filterBuilder.allOf(
                        ...
                        filterBuilder.anyOf(getKeywordAttributeFilter("Orange"), getKeywordAttributeFilter("Banana"))),
    ...
    public void testComplexContextualFilterMixedBooleanOperators()
    {
        ...
        testKeywordFiler("A AND B OR C",
                filterBuilder.anyOf(  //OR
                        filterBuilder.allOf(getKeywordAttributeFilter("A"), getKeywordAttributeFilter("B")),  //A AND B
        ...
        testKeywordFiler("A AND B OR C NOT D  ",
                filterBuilder.allOf(filterBuilder.anyOf(filterBuilder.allOf(getKeywordAttributeFilter("A"), getKeywordAttributeFilter("B")), getKeywordAttributeFilter("C")),
                        filterBuilder.not(getKeywordAttributeFilter("D"))));

        testKeywordFiler("A B OR (C NOT D)",
                    filterBuilder.anyOf( //OR
                            filterBuilder.allOf(getKeywordAttributeFilter("A"), getKeywordAttributeFilter("B")),//A AND B
                            filterBuilder.allOf(getKeywordAttributeFilter("C"), filterBuilder.not(getKeywordAttributeFilter("D")))));  //C NOT D

        testKeywordFiler("A (\"test\") OR test2",
                filterBuilder.anyOf(  //OR
                        filterBuilder.allOf(getKeywordAttributeFilter("A"), getKeywordAttributeFilter("test")),  //A AND (test test2)
                        getKeywordAttributeFilter("test2")));  //test2
    }
    ...
    {
        // Test NOT Operator
        testKeywordFiler("A NOT B",filterBuilder.allOf(getKeywordAttributeFilter("A"), filterBuilder.not(getKeywordAttributeFilter("B"))));
        testKeywordFiler("A NOT \"B\"",filterBuilder.allOf(getKeywordAttributeFilter("A"), filterBuilder.not(getKeywordAttributeFilter("B"))));
        testKeywordFiler("A NOT   A",filterBuilder.allOf(getKeywordAttributeFilter("A"), filterBuilder.not(getKeywordAttributeFilter("A"))));
        testKeywordFiler("NOT    NOT NOT",filterBuilder.allOf(getKeywordAttributeFilter("NOT"), filterBuilder.not(getKeywordAttributeFilter("NOT"))));
    }
    ...
    {
        //Test OR Operator
        testKeywordFiler("A OR B",  filterBuilder.anyOf(getKeywordAttributeFilter("A"), getKeywordAttributeFilter("B")));
        testKeywordFiler("(A OR A)",  filterBuilder.anyOf(getKeywordAttributeFilter("A"), getKeywordAttributeFilter("A")));
        testKeywordFiler("OR OR OR OR OR OR OR", filterBuilder.anyOf(filterBuilder.anyOf(filterBuilder.anyOf(getKeywordAttributeFilter("OR"), getKeywordAttributeFilter("OR")), getKeywordAttributeFilter("OR")),
    ...
    {
        // Test AND Operator
        testKeywordFiler("A AND 999", filterBuilder.allOf(getKeywordAttributeFilter("A"), getKeywordAttributeFilter("999")));
        //TODO with the new keyword query grammar, this... probably shouldn't be allowed?
        //testKeywordFiler("AND AND", filterBuilder.allOf(getKeywordAttributeFilter("AND"), getKeywordAttributeFilter("AND")));
        testKeywordFiler("A B C D", filterBuilder.allOf(filterBuilder.allOf(filterBuilder.allOf(getKeywordAttributeFilter("A"), getKeywordAttributeFilter("B")), getKeywordAttributeFilter("C")),
        		getKeywordAttributeFilter("D")));
        testKeywordFiler("A B C AND D", filterBuilder.allOf(filterBuilder.allOf(filterBuilder.allOf(getKeywordAttributeFilter("A"), getKeywordAttributeFilter("B")), getKeywordAttributeFilter("C")),
        		getKeywordAttributeFilter("D")));
        testKeywordFiler("A AND AND AND C", filterBuilder.allOf(filterBuilder.allOf(getKeywordAttributeFilter("A"), getKeywordAttributeFilter("AND")), getKeywordAttributeFilter("C")));
    }
    ...
    {
        // Test Common Words
        // Note: Spec said implementation SHOULD ignores these words but did not say we must; therefore, DDF do not ignore them
    ...
    public void testComplexContextualFilterOrderOfPrecedence()
    {
        ...
        testKeywordFiler("A OR B   OR C OR D", filterBuilder.anyOf(filterBuilder.anyOf(filterBuilder.anyOf(getKeywordAttributeFilter("A"), getKeywordAttributeFilter("B")), getKeywordAttributeFilter("C")),
        		getKeywordAttributeFilter("D")));
        testKeywordFiler("A AND B AND   C AND D  ", filterBuilder.allOf(filterBuilder.allOf(filterBuilder.allOf(getKeywordAttributeFilter("A"), getKeywordAttributeFilter("B")), getKeywordAttributeFilter("C")),
        		getKeywordAttributeFilter("D")));
        testKeywordFiler("A AND (B AND C) AND D", filterBuilder.allOf(filterBuilder.allOf(getKeywordAttributeFilter("A"), filterBuilder.allOf(getKeywordAttributeFilter("B"), getKeywordAttributeFilter("C"))),
        		getKeywordAttributeFilter("D")));
        testKeywordFiler("A AND (\"B\" AND \"C\")", filterBuilder.allOf(getKeywordAttributeFilter("A"), filterBuilder.allOf(getKeywordAttributeFilter("B"), getKeywordAttributeFilter("C"))));
    }
    ...
    public void testContextualFilter_PhraseOnly() throws Exception
    {
        ...
        OpenSearchQuery query = new OpenSearchQuery( null, 0, 10, "relevance", "desc", 30000, filterBuilder );
    ...
    public void testBboxSpatialFilter() throws Exception
    {
        ...
        LOGGER.debug( "lowerCornerCoords:  [0] = " + lowerCornerCoords[0] + ",   [1] = " + lowerCornerCoords[1] );
        ...
        LOGGER.debug( "upperCornerCoords:  [0] = " + upperCornerCoords[0] + ",   [1] = " + upperCornerCoords[1] );
    ...
    public void testOgcFilterEvaluate_Contextual_Like() throws Exception
    {
        ...
        //Filter filter = filterFactory.equal( filterFactory.property( "thing" ), filterFactory.literal( searchTerm ), false );
        //Filter filter = filterFactory.like( filterFactory.property( Query.ANY_TEXT ), searchTerm, "*", "?", "\\" );
        //Filter filter = filterFactory.equal( filterFactory.property( Query.ANY_TEXT ), searchTerm, false );
        //Filter filter = filterFactory.like( filterFactory.property( Query.ANY_TEXT ), searchTerm, "*", "?", "\\" );
        ...
        TemporalFilter temporalFilter = new TemporalFilter( startDate, endDate );
        //WORKS Filter filter = filterFactory.between( filterFactory.literal( new Date() ), filterFactory.literal( temporalFilter.getStartDate() ), filterFactory.literal( temporalFilter.getEndDate() ) );
...
//    }
    ...
    private void verifyTemporalFilter( Filter filter, String expectedStartDate, String expectedEndDate ) throws Exception
    {    
    ...
    private void verifyTypeVersionFilter( List<Filter> childFilters, String expectedType, String expectedVersion )
    {
