...
public interface OpenSearchParser {
     ...
     */
    void populateSearchOptions(WebClient client, QueryRequest queryRequest, Subject subject,
     ...
     * @param parameters      - the given OpenSearch parameters
     */
    void populateContextual(WebClient client, Map<String, String> searchPhraseMap,
            List<String> parameters);
     ...
     */
    void populateGeospatial(WebClient client, SpatialDistanceFilter spatial,
     ...
     * @throws UnsupportedQueryException
     */
    void populateGeospatial(WebClient client, SpatialFilter spatial, boolean shouldConvertToBBox,
