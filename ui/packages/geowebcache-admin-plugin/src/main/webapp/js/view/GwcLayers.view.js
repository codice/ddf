...
define([
    ...
    function ($, Backbone, _, Marionette, Handlebars, ich, gwcLayerPage, gwcLayerTable, Modal, addLayerModal) {

        var EMPTY_INPUT_DIV = "<div><input type='text' class='form-control input-list'></input><a href='#' class='fa fa-minus-square fa-lg minus-button'></a></div>";
        ...
        GwcLayersView.Modal = Modal.extend({
            ...
            onRender: function() {
                ...
                this.setupPopOver('[data-toggle="wms-layers-popover"]', 'The name(s) of WMS layers that exist at the URL specified above.  ' +
            ...
            renderFields: function() {
                ...
                if(layer.xmlLayers.length > 0) {
                    ...
                    $.each(layer.xmlLayers , function(index,value) {
                        that.$(".layer-wms-name").append("<div><input type='text' class='form-control input-list' value='" + value +  "'></input><a href='#' class='fa fa-minus-square fa-lg minus-button'></a></div>");
                    });
                }
                ...
                $.each(layer.mimeTypes , function(index,value) {
                    that.$(".layer-mime").append("<div><input type='text' class='form-control input-list' value='" + value +  "'></input><a href='#' class='fa fa-minus-square fa-lg minus-button'></a></div>");
                });
            },
            ...
            generateLayerDataFromFields: function() {
                ...
                return {name : name, oldName : this.options.name, mimes: mimes, url : url, wmsLayerNames : wmsLayerNames};
            },
        ...
        GwcLayersView.LayersTable = Marionette.LayoutView.extend({
            ...
            showUpdateModal: function(e) {
                this.modal = new GwcLayersView.Modal({name : $(e.target).text(), layers : this.model});
