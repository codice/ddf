...
define([
    ...
    'js/CustomElements'
], function (Marionette, _, Backbone, wreqr, Spinner, spinnerConfig, $, AlertsModel, AlertsView, template, ConfigurationFieldCollectionView, CustomElements) {
    ...
    ConfigurationEditView.View = Marionette.Layout.extend({
        ...
        onRender: function() {
            ...
            this.configurationItems.show(new ConfigurationFieldCollectionView({
