...
const Details = (props: Props) => {
    return (
        <React.Fragment>
            <div title={props.date} data-help="The date the workspace was last modified">
                {props.date}
            </div>
            <div title={props.owner} data-help="The owner of the workspace.">
                {props.localStorage ? 
                    <Icon className="fa fa-home"></Icon> : <Icon className="fa fa-cloud"></Icon>
                }
...
const Footer = (props: Props) => {
    return (
        <>
            <SaveButton isSaved={!props.unsaved} onClick={(e) => {
                e.stopPropagation();
