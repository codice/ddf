...
const Root = styled<RootProps, 'div'>('div')`
    ...
    border-bottom: 1px solid ${props => transparentize(0.9, readableColor(props.theme.backgroundAccentContent))};

    .home-templates-adhoc {
        text-align: center;
        padding: ${props => props.theme.minimumSpacing} 0px ${props => props.theme.minimumSpacing} 0px;
        white-space: nowrap;

        .adhoc-search {
            display: inline-block;
            vertical-align: middle;
            width: calc(100% - ${props => props.theme.minimumButtonSize} - 2 * ${props => props.theme.mediumSpacing});
        }
        ...
        .adhoc-go {
        vertical-align: middle;
        width: calc(${props => props.theme.minimumSpacing} + 2 * ${props => props.theme.mediumSpacing});
        max-width: 100%;
        }
    }
    ...
    .home-templates-choices-choice-preview {
        ...
        text-align: center;
        width: 100%;
        background: ${props => transparentize(0.9, readableColor(props.theme.backgroundAccentContent))};
    ...
    ${props => {
        if (props.hasTemplatesExpanded) {
            return `
                ...
                height: calc(${props.theme.minimumLineSize} + 2*${props.theme.minimumButtonSize} + 2*${props.theme.minimumSpacing} + 2*${props.theme.minimumSpacing} + 3*${props.theme.minimumButtonSize});
                overflow: auto;
            `;
        }
    }}
        ...
        <Root hasTemplatesExpanded={props.hasTemplatesExpanded}>
            <div className="home-templates-center">
                <div className="home-templates-header">
                    ...
                    <div className="home-templates-header-item home-templates-header-button is-button" data-help="Click to see more choices for starting workspaces."
                ...
                <div className="home-templates-adhoc">
                    ...
                    <button className="adhoc-go is-primary" onClick={props.startAdhocSearch}>
