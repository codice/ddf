...
const withListenTo = <P extends WithBackboneProps>(Component: React.ComponentType<P>) => {
    return class BackboneContainer extends React.Component<Subtract<P, WithBackboneProps>, {}> {
