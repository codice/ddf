            ...
            <React.Fragment>
                <div className="details-text">
                    <div className="details-results" title={data.resultCount}> 
                        {data.pending ? (<i className="fa fa-circle-o-notch fa-spin is-critical-animation"></i>) : ''} 
                        {data.failed ? (<i className="fa fa-warning"></i>) : ''}
                        {data.resultCount}
                    </div>
                ...
                <button className="details-view is-button" title="Show the full status for the search." data-help="Show the full status for the search.">
