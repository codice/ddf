...
var AssociationsMenuView = require('../associations-menu/associations-menu.view.js')
var AssociationCollectionView = require('../association/association.collection.view.js')
var AssociationCollection = require('../association/association.collection.js')
var AssociationGraphView = require('../associations-graph/associations-graph.view.js')
...
module.exports = Marionette.LayoutView.extend({
  ...
  handleFilter: function() {
    var filter = this.associationsMenu.currentView
      .getFilterMenuModel()
      .get('value')[0]
