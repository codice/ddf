...
module.exports = Marionette.ItemView.extend({
    ...
    handlePercentage: function() {
        ...
        this.$el.find('.overwrite-progress > .progress-bar').css('width', percentage + '%');
    ...
    handleError: function() {
        ...
        this.$el.find('.error-message').html(getOverwriteModel(this).escape('message'));
    },
    handleSuccess: function(file, response) {
        ...
        this.$el.find('.success-message').html(getOverwriteModel(this).escape('message'));
    },
    archive: function() {
