...
module.exports = plugin(
  Marionette.LayoutView.extend({
    ...
    events: {
      ...
      'click > .user-settings-navigation .choice-theme':
        'handleNavigateToTheme',
      'click > .user-settings-navigation .choice-alerts':
        'handleNavigateToAlerts',
      'click > .user-settings-navigation .choice-map': 'handleNavigateToMap',
      'click > .user-settings-navigation .choice-search':
        'handleNavigateToSearch',
      'click > .user-settings-navigation .choice-hidden':
        'handleNavigateToHidden',
      'click > .user-settings-navigation .choice-time': 'handleNavigateToTime',
      'click > .user-settings-content > .content-header .header-back':
        'handleBack',
    },
    regions: {
