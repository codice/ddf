...
const ExportResults = reactToMarionette(require('react-component/export-results'));
        ...
        const dataModel = {
            ...
            props: {
                ...
                onDownloadSuccess: async (response) => {
                    ...
                    this.saveExport(formattedResponse.data, formattedResponse.status, formattedResponse);
                }
            }
        };
