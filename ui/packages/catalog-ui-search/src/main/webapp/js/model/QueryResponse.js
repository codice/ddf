...
var ResultForm = properties.hasExperimentalEnabled()
  ? require('component/result-form/result-form.js')
  : {}
...
module.exports = Backbone.AssociatedModel.extend({
  ...
  parse: function(resp, options) {
    ...
    if (resp.results) {
      ...
      var selectedResultTemplate = properties.hasExperimentalEnabled()
        ? ResultForm.getResultCollection().filteredList.filter(
            form =>
