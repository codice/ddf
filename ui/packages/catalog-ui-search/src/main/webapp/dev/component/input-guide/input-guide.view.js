...
module.exports = BaseGuideView.extend({
    ...
    showExampleOne() {
        ...
        this.listenTo(this.exampleOne.currentView.model, 'change:value', this.handleExampleOneValue);
    },
    handleExampleOneValue() {
        this.$el.toggleClass('above-100', this.exampleOne.currentView.model.getValue()[0] > 100);
        this.$el.toggleClass('below-100', this.exampleOne.currentView.model.getValue()[0] < 100);
    },
    showExampleTwo() {
        this.exampleTwo.show(new PropertyView({
            model: new Property({
                label: 'Date Input',
    ...
    showExampleThree() {
        this.exampleThree.show(new PropertyView({
            model: new Property({
    ...
    showExampleFour() {
        this.exampleFour.show(new PropertyView({
            model: new Property({
    ...
    showExampleFive() {
        this.exampleFive.show(new PropertyView({
            model: new Property({
                label: 'Boolean Input',
                value: [true],
                type: 'BOOLEAN',
    ...
    showExampleSix() {
        this.exampleSix.show(new PropertyView({
            model: new Property({
    ...
    showExampleSeven() {
        this.exampleSeven.show(new PropertyView({
            model: new Property({
                label: 'Number Input',
                value: [0],
                type: 'INTEGER',
    ...
    showExampleEight() {
        this.exampleEight.show(new PropertyView({
            model: new Property({
                label: 'Autocomplete',
    ...
    showExampleNine() {
        this.exampleNine.show(new PropertyView({
            model: new Property({
                label: 'Color',
                value: ["#741d1d"],
                type: 'COLOR',
    ...
    showExample10() {
        this.example10.show(new PropertyView({
            model: new Property({
                label: 'Near',
                value: [{
                    value: 1,
    ...
    showExample11() {
        this.example11.show(new PropertyView({
            model: new Property({
                label: 'Text',
                value: ['hello'],
                type: 'STRING',
    ...
    showExample12() {
        this.example12.show(new PropertyView({
            model: new Property({
                label: 'Textarea',
                value: [`
    ...
    showExample13() {
        this.example13.show(new PropertyView({
            model: new Property({
                label: 'Enum',
                value: [true],
                enum: [{
    ...
    showExample14() {
        this.example14.show(new PropertyView({
            model: new Property({
                label: 'Enum',
                value: ['more on'],
                enum: [{
    ...
    showExample15() {
        this.example15.show(new PropertyView({
            model: new Property({
                label: 'Enum',
                value: [[
                    'more Off', 'on'
    ...
    showExample16() {
        this.example16.show(new PropertyView({
            model: new Property({
                label: 'Enum',
    ...
    showExample17() {
        this.example17.show(new PropertyView({
            model: new Property({
                label: 'Enum',
    ...
    showExample18() {
        this.example18.show(new PropertyView({
            model: new Property({
                label: 'Enum',
                value: ['custom values too'],
                enum: [{
    ...
    showExample19() {
        this.example19.show(new PropertyView({
            model: new Property({
                label: 'Enum',
                value: ['custom values too'],
                enum: [{
    ...
    showExample20() {
        this.example20.show(new PropertyView({
            model: new Property({
                label: 'Enum',
                value: [],
                values: {
    ...
    showExample21() {
        this.example21.show(new PropertyView({
            model: new Property({
                label: 'Enum',
                value: ['custom values too'],
                enum: [{
    ...
    showExample22() {
        this.example22.show(new PropertyView({
            model: new Property({
                label: 'Enum',
                value: ['custom values too'],
                enum: [{
    ...
    showExample23() {
        this.example23.show(new PropertyView({
            model: new Property({
                label: 'Enum',
                value: ['custom values too'],
                enum: [{
    ...
    showExample24() {
        this.example24.show(new PropertyView({
            model: new Property({
                label: 'Enum',
                value: ['custom values too'],
                enum: [{
    ...
    showExample25() {
        this.example25.show(new PropertyView({
            model: new Property({
                label: 'Enum',
                value: ['custom values too'],
                enum: [{
