...
class ButtonGuide extends React.Component<{}, { fadeUntilHoverModel: any, code: any, buttonTypeModel: any, inTextModel: any, disabledModel: any, textModel: any, iconModel: any }> {
    ...
    getCode() {
        ...
        return `
            ...
            <Button 
                buttonType={buttonTypeEnum.${getEnumTypes(buttonTypeEnum)[this.state.buttonTypeModel.getValue()[0]]}}
                    ...
                    <div className="examples is-list has-list-highlighting">
                        ...
                        <div className="title">
                            ...
                            <MarionetteRegionContainer
                                ...
                                replaceElement={false}
                            />
                            <LiveProvider code={this.state.code} scope={{ Button, buttonTypeEnum }}>
