            ...
            <React.Fragment> {/* surround with multiple child roots with this to avoid wrapper divs */}
                ...
                <div className="section">
                    ...
                    <div className="is-medium-font">
                        <div className="section">
                        The region behavior is the preferred way of utilizing regions in Marionette going forward.
                        </div>
                        <div className="section">
                        An alternative to default marionette regions that allows rerendering without
                        loss of regions.  At it's core, this depends on the react renderer to work since it can handle reconciliation. 
                        </div>
                        <div className="section">
                        This behavior works across handlebars and JSX templates, but try to transition to JSX if possible.
                        </div>
                        <div className="section">
                ...
                <div className="section">
                    ...
                    <div className="is-medium-font">
                        <div className="section">
                        Import the region.behavior into your view.  Then utilize it as seen above.  
                        </div>
                        <div className="section">
                        See the workspace-item component and the workspace-templates components to 
                        get a better idea of how this is used.
                        </div>
                    </div>
                </div>
            </React.Fragment>
