...
define([
  ...
  PrivateKey.Model = Jolokia.extend({
    ...
    deleteUrl:
      '../jolokia/exec/org.codice.ddf.security.certificate.keystore.editor.KeystoreEditor:service=keystore/deletePrivateKey/',
    postUrl:
  ...
  PrivateKey.Response = Backbone.AssociatedModel.extend({
    url:
      '../jolokia/read/org.codice.ddf.security.certificate.keystore.editor.KeystoreEditor:service=keystore/Keystore',
    relations: [
      {
        type: Backbone.Many,
        key: 'value',
