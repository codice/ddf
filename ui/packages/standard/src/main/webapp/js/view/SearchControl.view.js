    ...
    setupEvents: function(tabHash) {
      if (tabHash === '#search') {
        this.listenTo(
          wreqr.vent,
          'metacard:selected',
          _.bind(this.model.setRecordViewState, this.model)
        )
        this.listenTo(
          wreqr.vent,
          'search:results',
          _.bind(this.model.setResultListState, this.model)
        )
        this.listenTo(
          wreqr.vent,
          'search:show',
          _.bind(this.model.setSearchFormState, this.model)
        )
        this.listenTo(
          wreqr.vent,
          'search:clear',
          _.bind(this.model.setInitialState, this.model)
        )
        this.listenTo(
          wreqr.vent,
          'search:resultsselect',
          _.bind(this.model.setResultListSelectState, this.model)
        )
        this.listenTo(
          wreqr.vent,
