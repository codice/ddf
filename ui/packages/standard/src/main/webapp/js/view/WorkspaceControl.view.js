    ...
    setupEvents: function(tabHash) {
      if (tabHash === '#workspaces') {
        this.listenTo(
          wreqr.vent,
          'workspace:show',
          _.bind(this.model.setWorkspaceViewState, this.model)
        )
        this.listenTo(
          wreqr.vent,
          'workspace:results',
          _.bind(this.model.setWorkspaceResultsState, this.model)
        )
        this.listenTo(
          wreqr.vent,
          'metacard:selected',
          _.bind(this.model.setWorkspaceMetacardState, this.model)
        )
        this.listenTo(
          wreqr.vent,
          'workspace:new',
          _.bind(this.model.setWorkspaceNewState, this.model)
        )
        this.listenTo(
          wreqr.vent,
          'workspace:searchedit',
          _.bind(this.model.setWorkspaceQueryEditState, this.model)
        )
        this.listenTo(
          wreqr.vent,
          'workspace:edit',
          _.bind(this.model.setWorkspaceEditState, this.model)
        )
        this.listenTo(
          wreqr.vent,
          'workspace:list',
          _.bind(this.model.setWorkspaceListState, this.model)
        )
        this.listenTo(
          wreqr.vent,
          'workspace:editall',
          _.bind(this.model.setWorkspaceListEditState, this.model)
        )
        this.listenTo(
          wreqr.vent,
          'workspace:save',
        ...
        this.listenTo(
          ...
          _.bind(this.model.setSelectWorkspaceState, this.model)
        )
        this.listenTo(
          wreqr.vent,
          'workspace:resultssavecancel',
          _.bind(this.model.revertToPrevious, this.model)
        )
        this.listenTo(
          wreqr.vent,
          'workspace:searchsavecancel',
          _.bind(this.model.revertToPrevious, this.model)
        )
        this.listenTo(
          wreqr.vent,
          'search:resultsselect',
          _.bind(this.model.setWorkspaceResultsSelectState, this.model)
        )
        this.resetViewState()
      } else {
