 ...
 *
 **/
define(['marionette', 'backbone', 'cesium', 'underscore', 'wreqr'], function(
  Marionette,
  Backbone,
  Cesium,
  _,
      ...
      return new Cesium.Primitive({
        ...
        appearance: new Cesium.PerInstanceColorAppearance({
          ...
          renderState: {
            ...
            lineWidth: Math.min(
              4.0,
              this.options.geoController.scene.maximumAliasedLineWidth
            ),
          },
        }),
      })
        ...
        geometryInstances: [
          new Cesium.GeometryInstance({
            geometry: new Cesium.CircleOutlineGeometry({
              center: this.options.geoController.ellipsoid.cartographicToCartesian(
                Cesium.Cartographic.fromDegrees(modelProp.lon, modelProp.lat)
              ),
  ...
  var FilterGeometryCollection = Marionette.CollectionView.extend({
    ...
    onDestroy: function() {
      ...
      this.options.geoController.scene.primitives.remove(
