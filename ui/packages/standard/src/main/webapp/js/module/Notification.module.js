...
define([
  ...
  Application.App.module('MenuModule.NotificationModule', function(
    NotificationModule
  ) {
    ...
    NotificationModule.addInitializer(function() {
      this.subscription = Cometd.Comet.subscribe(
        '/ddf/notifications/**',
        function(resp) {
          ...
          var incomingNotification = new Notification.Notification(resp.data, {
            validate: true,
          })
