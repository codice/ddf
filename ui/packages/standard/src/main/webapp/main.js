...
require.config({
  paths: {
    ...
    datepickerOverride:
      'lib/jquery/js/plugin/jquery-ui-datepicker-4digitYearOverride-addon',
    datepickerAddon:
      '../../webjars/jqueryui-timepicker-addon/1.4.5/src/jquery-ui-timepicker-addon',
    purl: '../../webjars/purl/2.3.1/purl',
    multiselect:
      '../../webjars/jquery-ui-multiselect-widget/1.14/src/jquery.multiselect',
    multiselectfilter:
      '../../webjars/jquery-ui-multiselect-widget/1.14/src/jquery.multiselect.filter',
