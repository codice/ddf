...
/**
 * A {@code java.util.Map} implementation that is used in concert with the OSGi Event Admin for
...
public class Notification extends HashMap<String, String> {
  ...
  public static final String NOTIFICATION_TOPIC_BROADCAST = NOTIFICATION_TOPIC_ROOT + "/broadcast";
   ...
   * @param timestamp A {@code Date} representing the point at which the event triggering this
