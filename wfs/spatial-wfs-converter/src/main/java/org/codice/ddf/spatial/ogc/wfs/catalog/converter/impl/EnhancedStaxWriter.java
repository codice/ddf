...
public class EnhancedStaxWriter extends StaxWriter {
    ...
    public EnhancedStaxWriter(QNameMap qnameMap, XMLStreamWriter out,
            boolean writeEnclosingDocument, boolean namespaceRepairingMode) throws
            XMLStreamException {
        super(qnameMap, out, writeEnclosingDocument, namespaceRepairingMode);
        this.out = out;
    }

    public EnhancedStaxWriter(QNameMap qnameMap, XMLStreamWriter out, NameCoder nameCoder) throws
            XMLStreamException {
