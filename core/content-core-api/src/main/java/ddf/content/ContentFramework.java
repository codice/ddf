...
/**
 * The {@link ContentFramework} functions as the routing mechanism between all
 * content components. It decouples clients from service implementations and
 * provides integration points for Content Plugins.
 * <p>
 ...
 * <li/>For the {@link #read(ReadRequest) read},
 * {@link #create(CreateRequest) create}, {@link #delete(DeleteRequest) delete},
 * {@link #update(UpdateRequest) update} methods, the {@link ContentFramework}
 * calls:
 * <ul>
...
{        
     ...
     * <li/>Call {@link ContentPlugin#process(CreateResponse)} for
     * each registered {@link ContentPlugin} in order determined by the
     ...
     * @return 
     *     the {@link CreateResponse} containing the {@link ContentItem} that was created,
    ...
    /**
     * Reads a {@link ContentItem} from the {@link StorageProvider}. The {@link ContentItem}
     * must exist in the {@link StorageProvider} for it to be successfully retrieved.
     * 
     *      * <p>
     * <b>Implementations of this method must:</b>
     * <ol>
     * <li/>Call {@link StorageProvider#read(ReadRequest)} on the registered
     * {@link StorageProvider}
     * <li/>Call {@link ContentPlugin#process(ReadResponse)} for
     * each registered {@link ContentPlugin} in order determined by the
     * OSGi SERVICE_RANKING (Descending, highest first), "daisy chaining" their
     * responses to each other.
     * </ol>
     ...
     * @return 
     *     the {@link ReadResponse} containing the retrieved {@link ContentItem}
     * @throws ContentFrameworkException 
    ...
    /**
     * Updates a {@link ContentItem} in the {@link StorageProvider}. The {@link ContentItem}
     * must exist in the {@link StorageProvider} for it to be successfully updated.
     * The {@link ContentItem} will not be created if it does not already exist.
     * 
     * <p>
     * <b>Implementations of this method must:</b>
     * <ol>
     ...
     * {@link StorageProvider}
     * <li/>Call {@link ContentPlugin#process(UpdateResponse)} for
     * each registered {@link ContentPlugin} in order determined by the
     * OSGi SERVICE_RANKING (Descending, highest first), "daisy chaining" their
     * responses to each other.
     * </ol>
     ...
     * @return 
     *     the {@link UpdateResponse} containing the updated {@link ContentItem}
     * @throws ContentFrameworkException
     *     if problems encountered while updating the {@link ContentItem}
     */
    public UpdateResponse update( UpdateRequest updateRequest, Request.Directive directive ) throws ContentFrameworkException;
    
    
    /**
     * Deletes a {@link ContentItem} from the {@link StorageProvider}. The {@link ContentItem}
     * must exist in the {@link StorageProvider} for it to be successfully deleted.
     * 
     * <p>
     * <b>Implementations of this method must:</b>
     * <ol>
     ...
     * {@link StorageProvider}
     * <li/>Call {@link ContentPlugin#process(DeleteResponse)} for
     * each registered {@link ContentPlugin} in order determined by the
     * OSGi SERVICE_RANKING (Descending, highest first), "daisy chaining" their
     * responses to each other.
     * </ol>
     ...
     * @return
     *     the {@link DeleteResponse} containing the status of the {@link ContentItem} deletion
     * @throws ContentFrameworkException
