...
/**
 * Cataloger provides the create, update, and delete capabilities for entries
 * in the Metadata Catalog (MDC) by invoking the {@link CatalogFramework}. Cataloger is the
 * single point of entry from the Content Framework to the {@link CatalogFramework}.
 * 
...
public class Cataloger
{
    ...
    /**
     * Creates a catalog entry in the Metadata Catalog (MDC) using the {@link CatalogFramework}
     * for the specified {@link Metacard}.
     * 
    ...
    public String createMetacard( Metacard metacard ) throws PluginExecutionException
    {
        ...
        if ( metacard != null )
        {
            ...
            try
            {
                ...
                CreateResponse catalogCreateResponse = this.catalogFramework.create( catalogCreateRequest );
    ...
    // Can only update catalog entry by product URI from Content Framework because the catalog ID is never
    // provided as an input from the client (via ContentRestEndpoint)
    public String updateMetacard( String productUri, Metacard metacard ) throws PluginExecutionException
    {
        ...
        if ( metacard != null )
        {
            ...
            {
                logger.debug( "Calling catalog framework" );
                UpdateResponse catalogUpdateResponse = this.catalogFramework.update( catalogUpdateRequest );
    ...
    public String deleteMetacard( String productUri ) throws PluginExecutionException
    {
        ...
        if ( productUri != null )
        {
            ...
            {
                logger.debug( "Calling catalog framework" );
                DeleteResponse catalogDeleteResponse = this.catalogFramework.delete( catalogDeleteRequest );
