...
/**
 * Interface defining the contract for all transformers that parse content and
...
public interface ContentTransformer extends Describable
{
    ...
    /**
     * Updates an existing {@link Metacard} in the catalog using the specified
     * {@link InputStream}.
     * 
     * @param currentMetacard the {@link Metacard} to be updated
     * @param stream the {@link InputStream} to parse for updating the {@link Metacard}
