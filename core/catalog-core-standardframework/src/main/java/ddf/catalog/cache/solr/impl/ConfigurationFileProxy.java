...
public class ConfigurationFileProxy {
    ...
    //DDF-579 private static final String DEFAULT_SOLR_DATA_PARENT_DIR = "data";
    ...
    public ConfigurationFileProxy(BundleContext bundleContext) {
        ...
        String storedDataDirectoryPath = "";
        ...
        if (isNotBlank(storedDataDirectoryPath)) {
            ...
            //DDF-579 this.dataDirectory = new File(DEFAULT_SOLR_DATA_PARENT_DIR, "solr");
    ...
    public URL getResource(String name) {
        ...
        if (bundleContext != null) {
            ...
            try {
                //DDF-579  return new File(new File(new File(DEFAULT_SOLR_CONFIG_PARENT_DIR, "solr"), "conf"),
