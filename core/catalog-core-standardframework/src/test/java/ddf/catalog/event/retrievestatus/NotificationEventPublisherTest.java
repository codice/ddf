...
/**
 * 
 * Tests that the notification events are properly published when simulating
 * download events.
 * 
 */
public class NotificationEventPublisherTest extends AbstractDownloadsStatusEventPublisherTest {
