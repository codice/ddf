...
public class CollectionPermissionTest
{
    ...
    public void testCollectionImplies()
    {
        ...
        CollectionPermission task1Permission = new CollectionPermission(new ActionPermission(
            ActionPermission.CREATE_ACTION), new ActionPermission(ActionPermission.QUERY_ACTION));
        ...
        CollectionPermission task2Permission = new CollectionPermission(new ActionPermission(
            ActionPermission.CREATE_ACTION), new ActionPermission(ActionPermission.DELETE_ACTION));
    ...
    /**
     * Tests that the permission list which comes back is the same as what was
     * put in.
     */
    @Test
