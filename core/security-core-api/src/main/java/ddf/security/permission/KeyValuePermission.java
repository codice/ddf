...
/**
 * Permission class comprised of a key and a list of corresponding values. Contains the logic to determine
 * if this key/value permission can imply another key/value permission.
 */
public class KeyValuePermission implements Permission
{
     ...
     * described by the specified {@code Permission} argurment, {@code false} otherwise.
     * <p/>
     * That is, this current instance must be exactly equal to or a <em>superset</em> of the functionality
     * and/or resource access described by the given {@code Permission} argument. Yet another way of saying this
     * would be:
     * <p/>
     * If &quot;permission1 implies permission2&quot;, i.e. <code>permission1.implies(permission2)</code> ,
     ...
     * <p/>
     * If the keys of each permission are equal and if the values from this object implies the values from
     * the passed in permission, then this permission will imply the passed in permission.
     * @param p  permission to checked to see if this permission implies p
     * @return  {@code true} if this current instance <em>implies</em> all the functionality and/or resource
     *          access described by the specified {@code Permission} argument, {@code false} otherwise.
     */
    @Override
