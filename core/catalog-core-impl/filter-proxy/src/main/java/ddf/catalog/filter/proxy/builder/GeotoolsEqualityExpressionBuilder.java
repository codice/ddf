...
public class GeotoolsEqualityExpressionBuilder extends GeotoolsBuilder implements EqualityExpressionBuilder {
	...
	/* (non-Javadoc)
	 * @see ddf.catalog.filter.proxy.builder.EqualityExpressionBuilder#dateRange(java.util.Date, java.util.Date)
	 */
	@Override
