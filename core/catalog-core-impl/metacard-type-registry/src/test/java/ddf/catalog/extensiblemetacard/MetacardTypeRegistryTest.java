...
public class MetacardTypeRegistryTest {
    ...
    public void testLookupMetacardType() {
        QualifiedMetacardType qmtResult = mtr
                .lookup("ddf.test.namespace", QUALIFIED_METACARD_TYPE_NAME_1);
    ...
    public void registerMetacardType() throws InvalidSyntaxException, IllegalArgumentException,
        ...
        QualifiedMetacardType metacardTypeAFromRegistry = mtr
                .lookup(QualifiedMetacardType.DEFAULT_METACARD_TYPE_NAMESPACE,
        ...
        QualifiedMetacardType metacardTypeBFromRegistry = mtr
                .lookup(SAMPLE_B_METACARD_TYPE_NAMESPACE, SAMPLE_B_METACARD_TYPE_NAME);
    ...
    public void registerMetacardType_NullNamespace()
        ...
        mtr.register(qmt);
        QualifiedMetacardType metacardTypeFromReg = mtr
                .lookup(QualifiedMetacardType.DEFAULT_METACARD_TYPE_NAMESPACE,
    ...
    private QualifiedMetacardType sampleMetacardTypeA() {
        ...
        descriptors.add(new AttributeDescriptorImpl(
                MIN_FREQUENCY_ATTRIBUTE_NAME_SAMPLE_METACARD_TYPE_A, true /* indexed */, true /* stored */,
                false /* tokenized */, false /* multivalued */, BasicTypes.LONG_TYPE));
        descriptors.add(new AttributeDescriptorImpl(
                MAX_FREQUENCY_ATTRIBUTE_NAME_SAMPLE_METACARD_TYPE_A, true /* indexed */, true /* stored */,
                false /* tokenized */, false /* multivalued */, BasicTypes.LONG_TYPE));
        descriptors
                .add(new AttributeDescriptorImpl(ANGLE_ATTRIBUTE_NAME_SAMPLE_METACARD_TYPE_A, true /* indexed */,
