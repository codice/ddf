...
public class GeospatialEvaluationCriteriaImpl implements GeospatialEvaluationCriteria
{
	...
	public GeospatialEvaluationCriteriaImpl( Geometry criteria, String geoOperation,
			Geometry input, double distance ) 
	{
	   ...
	   public GeospatialEvaluationCriteriaImpl( Geometry criteria, String geoOperation,
           String input, double distance ) throws ParseException 
   {
	...
	public GeospatialEvaluationCriteriaImpl( Geometry criteria, String operation, String input ) throws ParseException 
	{
	    WKTReader2 wktreader = new WKTReader2();
		this.criteria = criteria;
