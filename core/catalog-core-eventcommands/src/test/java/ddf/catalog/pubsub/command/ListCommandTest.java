...
public class ListCommandTest
{
    ...
    /**
     * Test subscriptions:list command with no args. 
     * Should return all registered subscriptions.
     * 
     * @throws Exception
     */
    @Test
    public void testListNoArgsSubscriptionsFound() throws Exception
    {
        ...
        when(bundleContext.getServiceReferences(eq(SubscriptionsCommand.SERVICE_PID), anyString())).thenReturn(refs);
        ...
        assertThat(linesWithText, 
            hasItems("Total subscriptions found: 2", 
                     ListCommand.CYAN_CONSOLE_COLOR + ListCommand.SUBSCRIPTION_ID_COLUMN_HEADER + ListCommand.DEFAULT_CONSOLE_COLOR, 
                     MY_SUBSCRIPTION_ID, YOUR_SUBSCRIPTION_ID));
    ...
    /**
     * Test subscriptions:list command with no args. 
     * Should return no registered subscriptions.
     * 
     * @throws Exception
     */
    @Test
    public void testListNoArgsNoSubscriptionsFound() throws Exception
    {
        ...
        // then
        assertThat(buffer.toString(), startsWith(ListCommand.RED_CONSOLE_COLOR + ListCommand.NO_SUBSCRIPTIONS_FOUND_MSG + ListCommand.DEFAULT_CONSOLE_COLOR));
    ...
    /**
     * Test subscriptions:list command with one subscription ID argument not matching
    ...
    {
        // Setup argument captor for LDAP filter that will be passed in to getServiceReferences() call
        ...
        // Verify the LDAP filter passed in when mock BundleContext.getServiceReferences() was called.
    ...
    /**
     * Test subscriptions:list command with one subscription ID argument. 
     * Should return the one matching registered subscriptions.
     * 
     * @throws Exception
     */
    @Test
    ...
    /**
     * Test subscriptions:list command with the LDAP filter arg specified,
     * e.g., subscriptions:list -f "(subscription-id=my*)"
     * Should return matching subscriptions.
     * 
     * @throws Exception
     */
    @Test
