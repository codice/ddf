...
/**
 * DDF namespace resolver loads all registered NamespaceMap interfaces and builds
 * two HashMaps: one for namespace URIs to prefixes, and one for namespace prefixes to URIs.
 * If there are multiple entries found for a single URI or prefix, the last one loaded
 * from the OSGi Service Registry will be the one used.
 * 
 * @author Hugh Rodgers
 */
public class NamespaceResolver implements NamespaceContext
{
    ...
    /**
     * Retrieve the namespace URI for the given namespace prefix. Prefix is retrieved from
     * the list of namespace URIs and prefixes mapped from NamespaceMap entries in the OSGi
     * Service Registry.
     * 
    ...
    /**
     * Retrieve the namespace prefix for the given namespace URI. URI is retrieved from
     * the list of namespace URIs and prefixes mapped from NamespaceMap entries in the OSGi
     * Service Registry.
     * 
