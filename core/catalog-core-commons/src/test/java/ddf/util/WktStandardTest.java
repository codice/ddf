...
public class WktStandardTest {
	...
	public void denormalizeMultipointWithWholeNumbers() {
		assertThat(WktStandard.denormalize(WHOLE_NUMBER_MULTIPOINT.toText()),
				is("MULTIPOINT (10 10, 20 20, 30 30)"));
	}

	@Test
	public void denormalizeMultipointWithDecimalNumbers() {
		assertThat(WktStandard.denormalize(DECIMAL_NUMBER_MULTIPOINT.toText()),
				is("MULTIPOINT (10.1 10.2, 20.22 20.33)"));
	}
	
   @Test
    public void denormalizeMultipointWithNegatives() {
        assertThat(WktStandard.denormalize("MULTIPOINT ((-1 -1), (29.5 -15.5), (-30.5 14.5))"),
   ...
   public void denormalizeMultipointWithSinglePoint() throws ParseException {
       ...
       assertThat(WktStandard.denormalize("MULTIPOINT ((-1 -1))"),
               is("MULTIPOINT (-1 -1)"));
   }
   ...
   public void denormalizeMultipointWithExtraEndingSpace() throws ParseException {
	...
	public void denormalizeGeometryCollection() {
		...
		assertThat(
				WktStandard.denormalize(GEO_FACTORY.createGeometryCollection(
						geometries).toText()),
	...
	public void denormalizeNotNeeded() {
		...
		assertThat(WktStandard.denormalize(denormalizedWkt),
				is(denormalizedWkt));
	}
	...
	public void denormalizeEmptyMultiPoint() {
		...
		assertThat(WktStandard.denormalize(emptyMultipoint),
				is(emptyMultipoint));
	}
	...
	public void normalizeGeometryCollection() {
		assertThat(
				WktStandard
						.normalize("GEOMETRYCOLLECTION ( MULTIPOINT(10 10,20 20) , POINT (5 20) ,  MULTIPOINT(  30 30  ,  40 40  ) )"),
