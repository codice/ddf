...
public class CatalogEndpoint extends DefaultEndpoint {
     ...
     * @param contextPath
     *            the context path of the catalog route node, which is the portion of the URI after
     *            the <code>catalog</code> scheme, e.g., <code>inputtransformer</code>, which
     *            indicates how to interpret the <code>catalog</code> route node
