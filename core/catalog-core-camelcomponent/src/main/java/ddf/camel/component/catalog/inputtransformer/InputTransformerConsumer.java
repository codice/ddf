 ...
 * a Camel <from> route node with a URI like <code>catalog:inputtransformer</code>
 * 
...
{
    private static final transient Logger LOGGER = LoggerFactory.getLogger( InputTransformerConsumer.class );
