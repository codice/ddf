...
public class AttributeImplTest {
	...
	private Attribute serializationLoop(Attribute toSerialize) throws FileNotFoundException, IOException, ClassNotFoundException{
	...
	/**
	 * Tests what happens when someone tries to manually change the serialized
	 * object after it has been serialized. The expected outcome is that it will
	 * be detected that the object is corrupt. The original serialized object's
	 * name field was "id", it was manually changed, then saved again.
	 * 
	 * @throws IOException
