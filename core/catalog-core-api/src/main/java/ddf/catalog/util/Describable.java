 ...
 * a how the Describable interface is used view the {@link Source} interface and the
...
public interface Describable {
	 ...
	 * <br/>
	 * Example: <code>html<code> for a {@link MetacardTransformer} that transforms {@link Metacard}s to HTML
