...
public class QueryRequestImpl extends OperationImpl implements QueryRequest {
    ...
    /**
	 * Instantiates a new QueryRequestImpl with a $(@link Query) and
    ...
    /**
	 * Instantiates a new QueryRequestImpl with a $(@link Query) and
	 * a ${@link Collection} of sourceIDs
	 *
	 * @param query the query
    ...
    /**
	 * Instantiates a new QueryRequestImpl with a $(@link Query) and
	 * a boolean indicating if it is an Enterprise QueryRequest.
	 *
	 * @param query the query
    ...
    /**
	 * Instantiates a new QueryRequestImpl with a $(@link Query),
	 * a boolean indicating if it is an Enterprise QueryRequest,
	 * a ${@link Collection} of siteNames, and
	 * a ${@link Map} of properties
	 *
	 * @param query the query
	 * @param isEnterprise the enterprise indicator
	 ...
	 */
    public QueryRequestImpl(Query query, boolean isEnterprise, Collection<String> siteNames, Map<String, Serializable> properties) {
        super(properties);
        this.query = query;
