...
/**
 * The SourceInfoRequestEnterprise should be used to obtain {@link Source} information
 * about each {@link Source} in the enterprise.
 */
public class SourceInfoRequestEnterprise extends SourceInfoRequestLocal {
	 ...
	 *
	 * @param includeContentTypes - true to include content types,  otherwise false
	 */
