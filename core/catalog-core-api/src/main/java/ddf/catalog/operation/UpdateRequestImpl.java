...
public class UpdateRequestImpl extends OperationImpl implements UpdateRequest {
     ...
     */
    public UpdateRequestImpl(List<Entry<Serializable, Metacard>> updateList, String attributeName, Map<String, Serializable> properties) {
		super(properties);
    ...
    /**
     * Instantiates a new UpdateRequestImpl from an array of ids and 
     * a list of {@link Metacard}
     *
    ...
    /**
     * Instantiates a new UpdateRequestImpl from an array of {@link URI} and 
     * a list of {@link Metacard}
     *
     * @param uris - the uris associated with the {@link Metacard} list
     * @param metacards the updated {@link Metacard} values
     * @throws IllegalArgumentException if the uris array size and list of {@link Metacard} size does not match
     */
    public UpdateRequestImpl(URI[] uris, List<Metacard> metacards) throws IllegalArgumentException {
        this(formatEntryList((Serializable[]) uris, metacards), UpdateRequest.UPDATE_BY_PRODUCT_URI, null);
    }
     ...
     */
    private static List<Entry<Serializable, Metacard>> formatEntryList(Serializable[] values, List<Metacard> metacards) {
