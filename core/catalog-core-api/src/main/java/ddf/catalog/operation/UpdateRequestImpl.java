 ...
 * 
 * @deprecated Use ddf.catalog.operation.impl.UpdateRequestImpl
 *
 */
@Deprecated
public class UpdateRequestImpl extends OperationImpl implements UpdateRequest {
     ...
     * 
     * @param updateList
     *            - the list of updated {@link Metacard}
     * @param attributeName
     *            the attribute name (e.g. Metacard.ID, Metacard.PRODUCT_URI)
     * @param properties
     ...
     * 
     * @param id
     *            the id of the {@link Metacard} to update
     * @param metacard
     *            the updated {@link Metacard} value.
     */
     ...
     * 
     * @param ids
     *            - the ids associated with the {@link Metacard} list
     * @param metacards
     *            the updated {@link Metacard} values
     * @throws IllegalArgumentException
     *             if the ids array size and list of {@link Metacard} size does not match
     */
    public UpdateRequestImpl(String[] ids, List<Metacard> metacards)
        throws IllegalArgumentException {
     ...
     * 
     * @param uris
     *            - the uris associated with the {@link Metacard} list
     * @param metacards
     *            the updated {@link Metacard} values
     * @throws IllegalArgumentException
    ...
    public UpdateRequestImpl(URI[] uris, List<Metacard> metacards) throws IllegalArgumentException {
        this(formatEntryList((Serializable[]) uris, metacards),
                UpdateRequest.UPDATE_BY_PRODUCT_URI, null);
    }
