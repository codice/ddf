...
/**
 * The SourceInfoRequestLocal should be used to obtain local {@link Source} information.
 * This request may obtain information from the {@link CatalogProvider}.
 */
public class SourceInfoRequestLocal extends OperationImpl implements SourceInfoRequest {
	 ...
	 *
	 * @param includeContentTypes - true to include the content types, otherwise false
	 */
