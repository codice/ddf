...
public class SourceResponseImpl extends ResponseImpl<QueryRequest> implements SourceResponse {
	...
	/**
	 * Instantiates a new SourceResponseImpl with the original query
	 * request and results from the query being executed.
	 *
	...
	/**
	 * Instantiates a new SourceResponseImpl. Use when the total amount of hits
	 * is known.
	 *
	 * @param request the original request
	 ...
	 * @param results the results associated with the query
	 */
	public SourceResponseImpl(QueryRequest request, Map<String, Serializable> properties, List<Result> results ) {
	    this( request, properties, results, results != null ? results.size() : 0  );
	}

	/**
	 * Instantiates a new SourceResponseImpl with properties and when the total number of hits is known.
	 *
	 * @param request the original request
	 * @param properties the properties associated with the operation
	 * @param results the results associated with the query
	 ...
	 */
	public SourceResponseImpl(QueryRequest request, Map<String, Serializable> properties, List<Result> results, long totalHits ) {
