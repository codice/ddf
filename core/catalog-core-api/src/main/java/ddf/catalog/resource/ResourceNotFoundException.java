...
/**
 * ResourceNotFoundException is thrown when a {@link ResourceReader} is unable
 * to find a {@link Resource}.
 *
...
public class ResourceNotFoundException extends Exception {
    ...
    /**
     * Instantiates a new resource not found exception with the provided message and a
     * throwable.
     * 
     * @param message the message
