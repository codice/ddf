...
public class ResourceImpl extends BinaryContentImpl implements Resource {
     ...
     * 
     * @param inputStream the {@link InputStream} of the {@link Resource}
     ...
     * 
     * @param inputStream the {@link InputStream} of the {@link Resource}
     * @param mimeType the {@link MimeType} of the {@link Resource}
     * @param name the name of the {@link Resource}
     */
     ...
     * 
     * @param inputStream the {@link InputStream} of the {@link Resource}
     * @param mimeTypeString the Mime Type value of the {@link Resource}
     * @param name the name of the {@link Resource}
     */
     ...
     * 
     * @param mimeTypeString the Mime Type string value
     * @param name the name of the {@link Resource}
	...
	try {
	    ...
	    logger.warn("Could not assign the MimeType to the Resource named '" + name + "' because the following "
		    + "MimeType could not be parsed properly: " + mimeTypeString);
	}
	return mimeType;
    }
