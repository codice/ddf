...
public class BasicTypes {
	...
	/**
	 * A Constant for a {@link MetacardType} with the required
	...
	/**
	 * A Constant for an {@link AttributeType} with
	...
	static {
		...
		basic = new MetacardTypeImpl(MetacardType.DEFAULT_METACARD_TYPE_NAME,
				descriptors);
