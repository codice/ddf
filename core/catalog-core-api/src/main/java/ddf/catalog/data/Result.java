...
/**
 * The Result is used to supplement {@link Metacard} fields when a {@link Metacard} is returned
 * from a query. It adds a relevance score and distance in meters to the {@link Metacard}'s
 * existing attributes.
 * 
...
public interface Result {
     ...
     * 
     * @return relevance score (typical range of 0-1, values over 1 are those
     ...
     * 
	 * @return distance in meters, null if {@code Result} was not part of a search that
	 * was sorted by distance.
	 */
