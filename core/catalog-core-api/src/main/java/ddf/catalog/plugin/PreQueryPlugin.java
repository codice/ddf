 ...
 * For example if a query needed to be altered, a PreQueryPlugin could be implemented
...
public interface PreQueryPlugin {
	 ...
	 *         {@link PreQueryPlugin}, or if this is the last
	 *         {@link PreQueryPlugin} to be called     
