...
public interface PostResourcePlugin {
	 ...
	 *         {@link PostResourcePlugin}, or if this is the last
	 *         {@link PostResourcePlugin} to be called
	 * @throws PluginExecutionException thrown when an error occurs while processing the {@link ResourceResponse}
