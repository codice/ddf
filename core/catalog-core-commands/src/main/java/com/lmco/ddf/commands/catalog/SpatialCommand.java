...
import com.lmco.ddf.commands.util.SpatialOperations;
...
public class SpatialCommand extends CatalogCommands {
    ...
    protected void doRadiusQuery(PrintStream console,
            CatalogFacade catalogFacade) //throws CatalogException 
    {
...
//      executeQuery(console, catalogProvider, criterion);
	...
	protected void doNNQuery(PrintStream console, CatalogFacade catalogFacade) //throws CatalogException 
	{
...
//		executeQuery(console, catalogProvider, criterion);
    ...
    private void doOperationsQuery(PrintStream console,
    		 CatalogFacade catalogFacade) //throws CatalogException 
    {   
...
//      
//      SortPolicyImpl sortPolicy = new SortPolicyImpl(true, Constants.MTS_SORT_QUALIFIER, Constants.SORT_POLICY_VALUE_DISTANCE, Order.ASCENDING) ;
//      
//      QueryImpl query = new QueryImpl(filterNodeTerm, null, 0, numberOfItems,sortPolicy, null, null, true, 0) ;
//                  
...
//			}
//			
//			if(result.getGeospatialCoverageWKTs() != null && !result.getGeospatialCoverageWKTs().isEmpty()) {
