...
digraph tree {
 splines=false;
 node[style="filled", fillcolor="#FFFFFF",fontname="sansserif"];
 fontname="sansserif";
 node1[shape=box, label="And"];
 node2[shape=box, label="mission"];
 node3[shape=box, label="planning"];
 node1 -> node2
 node1 -> node3
}
....
...
digraph tree {
 splines=false;
 node[style="box,filled", fillcolor="#FFFFFF",fontname="sansserif"];
 fontname="sansserif";
 node1[shape=box, label="PropertyIsLike"];
 node2[shape=box, label="Property:\ntitle"];
 node3[shape=box, label="Literal:\nmission"];
 node1 -> node2
 node1 -> node3
}
....
...
digraph tree {
 ...
 node[style="box,filled", fillcolor="#FFFFFF",fontname="sansserif"];
 fontname="sansserif";
 node1[shape=box, label="OR"];
 node2[shape=box, label="PropertyIsLike"];
 node3[shape=box, label="PropertyIsLike"];
 node4[shape=box, label="Property:\nsubject"];
 node5[shape=box, label="Literal:\nmath"];
 node6[shape=box, label="Property:\nsubject"];
 node7[shape=box, label="Literal:\nscience"];    
 node1 -> node2
 node1 -> node3
 node2 -> node4
 node2 -> node5
...
[plantuml, test, png]
....
digraph ingest_plugins {
 compound=true;
 ranksep=0.8;
 nodesep=0.4;
 splines=false;
 node[style="rounded,filled", fillcolor="#99CCFF",fontname="sansserif"];
 fontname="sansserif";
 
 nodeClient [shape=box, label="Client"];
 nodeClient -> nodeEndpoint [dir=both];
 subgraph clusterDdf {
 label = "DDF";
 style="filled";
 fillcolor="#808080";
 ...
 nodeEndpoint [shape=box, label="Endpoint"];
 nodePreIngestPlugin [shape=box, label="Pre-Ingest Plugins"];
 nodeCatalogFramework [shape=box, label="Catalog Framework"];
 nodePostIngestPlugin [shape=box, label="Post-Ingest Plugins"];
 nodeSource [shape=box, label="Source"];
 {rank=same;nodeEndpoint;nodeCatalogFramework;nodeSource}
 
 nodeEndpoint -> nodeCatalogFramework -> nodePreIngestPlugin [dir=both];
 nodeCatalogFramework -> nodeSource  [dir=both];
 nodeCatalogFramework -> nodePostIngestPlugin  [dir=both];
 }
}
....
...
.QueryPlugin Flow
[plantuml, queryplugin, png]
....
digraph query_plugins {
 compound=true;
 ranksep=0.8;
 nodesep=0.4;
 splines=false;
 ...
 nodeEndpoint [shape=box, label="Endpoint"];
 nodePreQueryPlugin [shape=box, label="Pre-Query Plugins"];
 nodeCatalogFramework [shape=box, label="Catalog Framework"];
 nodePostQueryPlugin [shape=box, label="Post-Query Plugins"];
 nodeSource [shape=box, label="Source"];
 {rank=same;nodeEndpoint;nodeCatalogFramework;nodeSource}
 
 nodeEndpoint -> nodeCatalogFramework -> nodeSource  [dir=both];
 nodeCatalogFramework -> nodePreQueryPlugin  [dir=both];
 nodeCatalogFramework -> nodePostQueryPlugin  [dir=both];
 }
}
....
...
[plantuml, connectedsources, png]
....
digraph connected_sources {
	compound=true;
	ranksep=0.8;
 	nodesep=0.4;
	splines=false;
 	...
 	nodeSoapClient [shape=box, label="SOAP Client"];
 	nodeJsonClient [shape=box, label="JSON Client"];
 	nodeOpenSearchClient [shape=box, label="OpenSearch Client"];
 	nodeDdfDataSource1 [shape=box, label="DDF v2.X"];
 	nodeDdfDataSource2 [shape=box, label="DDF v2.X\nSource A"];
 	nodeDdfDataSourceMore [style=none,shape=plaintext, label="..."];
 	nodeDdfDataSource3 [shape=box, label="DDF v2.X\nSource X"];
 	nodeSoapClient -> nodeSoapEndpoint [dir=both];
 	nodeJsonClient -> nodeJsonEndpoint [dir=both];
 	nodeOpenSearchClient -> nodeOpenSearchEndpoint [dir=both];
 
 	nodeFederatedSource -> nodeDdfDataSource1 [dir=both];
 	nodeFederatedSource -> nodeDdfDataSource2 [dir=both];
 	nodeFederatedSource -> nodeDdfDataSourceMore [style=invis];
 	nodeFederatedSource -> nodeDdfDataSource3 [dir=both];
 	{rank=same;nodeDdfDataSource1;nodeDdfDataSource2;nodeDdfDataSourceMore;nodeDdfDataSource3;}
 	subgraph clusterDdf {
 		label = "DDF";
 		style="filled";
 		fillcolor="#808080";
 		...
 		nodeSoapEndpoint [shape=box, label="SOAP Endpoint"];
 		nodeJsonEndpoint [shape=box, label="JSON Endpoint"];
 		nodeOpenSearchEndpoint [shape=box, label="Open Search Endpoint"];
 
	 	nodeFanoutCatalogFramework [shape=box, label="Fanout Catalog Framework"];
 		nodeFederationStrategy [shape=box, label="Federation Strategy"];
 
 		nodeSoapEndpoint -> nodeFanoutCatalogFramework;
 		nodeJsonEndpoint -> nodeFanoutCatalogFramework;
 		nodeOpenSearchEndpoint -> nodeFanoutCatalogFramework;
 		nodeFanoutCatalogFramework -> nodeFederationStrategy [dir=both];
 
 		nodeFederationStrategy -> nodeFederatedSource [dir=both, lhead="clusterFederated"];
 
	 	subgraph clusterEnterpriseQuery {
 			label = "Enterprise\nQuery";
 			style="filled";
 			fillcolor="#CCFFFF";
 			subgraph clusterFederated {
 				label = "Federated Query";
 				style="filled";
 				fillcolor="#6699CC";
 
 				nodeFederatedSource [shape=box, label="Federated Source(s)"];
 			}
 		}
	}
}
...
digraph connected_sources {
 	...
 	nodeClient [shape=box, label="Client"];
 	nodeInternalDataSource [shape=box, label="Internal Data Source",style="rounded,filled,dashed"];
 	nodeExternalDataSource1 [shape=box, label="External Data Source 1",style="rounded,filled,dashed"];
 	nodeExternalDataSource2 [shape=box, label="External Data Source 2",style="rounded,filled,dashed"];
 	nodeExternalDataSourceMore [style=none,shape=plaintext, label="..."];
 	nodeExternalDataSource3 [shape=box, label="External Data Source 3",style="rounded,filled,dashed"];
 	nodeClient -> nodeEndpoint [dir=both];
 	nodeCatalogProvider -> nodeInternalDataSource [dir=both, ltail="clusterLocal"];
 	nodeConnectedSource -> nodeExternalDataSource1 [dir=both];
 	nodeFederatedSource -> nodeExternalDataSource2 [dir=both];
 	nodeFederatedSource -> nodeExternalDataSourceMore [style=invis];
 	nodeFederatedSource -> nodeExternalDataSource3 [dir=both];
 	{rank=same;nodeInternalDataSource;nodeExternalDataSource1;nodeExternalDataSource2;nodeExternalDataSourceMore;nodeExternalDataSource3}
 	subgraph clusterDdf {
 		label = "DDF";
 		style="filled";
 		fillcolor="#808080";
 		...
 		{rank=same;nodeEndpoint;nodeCatalogFramework;nodeFederationStrategy}
		
		nodeEndpoint -> nodeCatalogFramework -> nodeFederationStrategy [dir=both];
 
 		nodeFederationStrategy -> nodeFederatedSource [dir=both, lhead="clusterFederated"];
 		nodeFederationStrategy -> nodeCatalogProvider [dir=both, lhead="clusterLocal"];
 		...
 		subgraph clusterEnterpriseQuery {
			...
			subgraph clusterLocal {
 				...
 				nodeCatalogProvider [shape=box, label="Catalog Provider"];
	 			nodeConnectedSource [shape=box, label="Connected Source(s)"];
 				{rank=same;nodeCatalogProvider;nodeConnectedSource}
 			}
 		}
	}
}
...
[plantuml, transformer_communication_diagram, png]
....
digraph transformer {
	 compound=true;
	 ranksep=0.8;
	 ...
	 subgraph clusterDdf {
		 ...
		 nodeEndpoint [shape=box, label="Endpoint"];
		 nodeCatalogFramework [shape=box, label="Catalog Framework"];
		 nodeTransformer [shape=box, label="Transformer"];
		 nodeSource[shape=box, label="Source"];
		 {rank=same;nodeEndpoint;nodeCatalogFramework;nodeSource}
		 
		 nodeEndpoint -> nodeCatalogFramework -> nodeTransformer [dir=both];
		 nodeCatalogFramework -> nodeSource [dir=both];
...
digraph connected_sources {
	compound=true;
 	...
 	nodeClient [shape=box, label="Client"];
 	nodeInternalDataSource [shape=box, label="Oracle Database"];
 	nodeExternalDataSource1 [shape=box, label="Source A"];
 	nodeExternalDataSource2 [shape=box, label="Source B"];
 	nodeExternalDataSourceMore [style=none,shape=plaintext, label="..."];
 	nodeExternalDataSource3 [shape=box, label="Source X"];
 	nodeClient -> nodeEndpoint [dir=both];
 	nodeCatalogProvider -> nodeInternalDataSource [dir=both, ltail="clusterLocal"];
 	nodeConnectedSource -> nodeExternalDataSource1 [dir=both];
	nodeFederatedSource -> nodeExternalDataSource2 [dir=both];
	...
	subgraph clusterDdf {
		...
		nodeFederationStrategy -> nodeFederatedSource [dir=both, head="clusterFederated"];
		nodeFederationStrategy -> nodeCatalogProvider [dir=both, lhead="clusterLocal"];
...
The Sorted Federation Strategy configuration can be found in the web console under 
Configuration -> Catalog Sorted Federation Strategy.
...
|Managed Service PID
|`ddf.catalog.SortedFederationStrategy`
...
actor Client 
box "DDF" #DDEEFF 
  participant "Event Service Endpoint" as EventServiceEndpoint <<Endpoint>> 
  participant "Delivery Method Implementation" as DeliveryMethod <<DeliveryMethod>>  
  participant "Subscription Implementation" as Subscription <<Subscription>> 
  participant "Event Processor Implementation" as EventProcessorImpl <<EventProcessor>> <<PostIngestPlugin>>
  participant "Pre-Subscription Plugin" as PreSubscriptionPlugin <<PreSubscriptionPlugin>>
end box 
 

Client -> EventServiceEndpoint: createSubscription(criteria, id, callbackUrl) 
EventServiceEndpoint -> DeliveryMethod: create(callbackUrl, id) 
DeliveryMethod --> EventServiceEndpoint: deliveryMethod 
EventServiceEndpoint -> Subscription: create(criteria, deliveryMethod)
Subscription --> EventServiceEndpoint: subscription 
EventServiceEndpoint -> EventProcessorImpl: createSubscription(subscription, id) 
EventProcessorImpl -> PreSubscriptionPlugin: process(subscription)
PreSubscriptionPlugin --> EventProcessorImpl: subscription
EventProcessorImpl -> EventProcessorImpl: register subscription\nin OSGi registry
...
[plantuml, event_processing_and_notification, png]
....
autonumber 
...
actor Client 
box "DDF" #DDEEFF 
  participant "Ingest Service Endpoint" as IngestServiceEndpoint <<Endpoint>>
  participant "Standard Catalog Framework" as CatalogFramework <<CatalogFramework>>
  participant "Event Processor Implementation" as EventProcessorImpl <<EventProcessor>> <<PostIngestPlugin>>
  participant "Pre-Delivery Plugin" as PreDeliveryPlugin <<PreDeliveryPlugin>>
  participant "Subscription Implementation" as Subscription <<Subscription>>
  participant "Delivery Method Implementation" as DeliveryMethod <<DeliveryMethod>>  
end box 
participant "Client's Event Consumer Service" as EventConsumer <<EventConsumer>>
 

Client -> IngestServiceEndpoint: create Metacard 
IngestServiceEndpoint -> CatalogFramework: create(CreateRequest) 
CatalogFramework -> CatalogFramework: normal ingest processing
note right: see DDF Catalog->Types of Catalog Components->Catalog Framework page's\nIngest section for details
CatalogFramework -> EventProcessorImpl: process(CreateResponse)
loop process each registered subscription
  EventProcessorImpl -> EventProcessorImpl: determines if created Metacard\nmatches subscription's criteria
  group subscription criteria matched event
    EventProcessorImpl -> PreDeliveryPlugin: processCreate(Metacard) 
    PreDeliveryPlugin --> EventProcessorImpl: Metacard
    EventProcessorImpl -> Subscription: getDeliveryMethod
    Subscription --> EventProcessorImpl: deliveryMethod
    EventProcessorImpl -> DeliveryMethod: created(Metacard)
    DeliveryMethod -> EventConsumer: onCreateEvent(Metacard) 
  end
end
....
