...
----
features:removeurl -u <{branding} application's feature repository URL>

Example:   features:removeurl -u mvn:org.codice.{branding}.spatial/spatial-app/2.5.0/xml/features
----
...
----
features:addurl <{branding} application's feature repository URL>
features:install <{branding} application's main feature>

Example:

    {branding}@local>features:addurl mvn:{branding}.catalog/catalog-app/2.3.0/xml/features
    {branding}@local>features:install catalog-app
----
