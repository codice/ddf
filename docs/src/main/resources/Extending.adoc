...
[ditaa, catalog_architecture_plugins, png,width=500]
....
+------------------------------------------------------------+
|                /-------------------\                       |
|                |cDEFEndpoints      |                       |
...
.Ingest Plugin Flow
[ditaa,ingest-plugin-flow,png, width=500]
....
/------\
|Client|
|cDEF  |
...
[ditaa, catalog_architecture_operations, png, width=500]
....
+------------------------------------------------------------+
|                /-------------------\                       |
|                |cDEFEndpoints      |                       |
...
[ditaa, catalog_architecture_data, png, width=500]
....
+------------------------------------------------------------+
|                /-------------------\                       |
|                |cDEFEndpoints      |                       |
...
[ditaa, catalog_architecture_framework, png, width=500]
....
+------------------------------------------------------------+
|                /-------------------\                       |
|                |cDEFEndpoints      |                       |
...
.Catalog Fanout Framework
[ditaa,query-flow,png, width=500]
....
           /------\
           |Client|
           |cDEF  |
...
[ditaa, sources_architecture, png, width=500]
....
+----------------------------------------------------------------------------------------------+
|                /-------------------\                                               +-=------+|
...
.Connected Sources
image::query-flow.png, width=500[]
...
[ditaa, catalog_architecture_transformers, png, width=500]
....
+------------------------------------------------------------+
|                /-------------------\                       |
|                |cDEFEndpoints      |                       |
...
[ditaa, transformer_communication_diagram, png, width=500]
....
/------\
|Client|
|cDEF  |
...
[ditaa, catalog_architecture_federation, png, width=500]
....
+------------------------------------------------------------+
|                /-------------------\                       |
|                |cDEFEndpoints      |                       |
...
[ditaa, federation, png, width=500]
....
           /------\
           |Client|
           |cDEF  |
...
[ditaa, catalog_architecture_eventing, png, width=500]
....
+------------------------------------------------------------+
|                /-------------------\                       |
|                |cDEFEndpoints      |                       |
...
[ditaa, catalog_architecture_resources, png, width=500]
....
+------------------------------------------------------------+
|                /-------------------\                       |
|                |cDEFEndpoints      |                       |
