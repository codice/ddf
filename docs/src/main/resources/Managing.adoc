...
image::application_details.png[Application Details,1000]
...
image::welcome_page.png[Welcome Page,1000]

General Configuration Page

image::general_configuration.png[General Configuration,1000]

Installation Profile Page

image::installation_profile.png[Installation Profile,1000]

Select Applications Page

image::select_applications.png[Select Applications,1000]
...
image::final_page.png[Final Page,1000]
