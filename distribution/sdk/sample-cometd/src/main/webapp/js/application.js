...
(function($) {
    ...
    $(document).ready(function() {
      ...
      function addNotification(message) {
        ...
        $('#notifications').append('<div id="' + notifyId + '" class="notification"></div>');
      ...
      function addResult(message) {
        ...
        for (var i = 0; i < results; i++) {
          // get result elements
          var result      = message.data.results[i],
          ...
          $('#' + catalogId).append('<a class="btn" target="_blank" href="' + downloadUrl + '">Download</a>');
        }
      }
