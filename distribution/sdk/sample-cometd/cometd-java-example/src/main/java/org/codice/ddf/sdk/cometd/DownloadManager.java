...
/**
 * This class is used to download a product from the DDF. Since this could be a long running process
 * it is advised that it is run in a separate thread.
 */
  ...
  public void run() {
    ...
    try (ReadableByteChannel byteChannel = Channels.newChannel(url.openStream())) {
      ...
      try (FileOutputStream fileOutputStream =
          new FileOutputStream(outputFileName + fileExtension)) {
