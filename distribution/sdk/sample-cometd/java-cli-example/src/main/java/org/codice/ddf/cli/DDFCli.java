...
public class DDFCli {
  ...
  public static void main(String[] args) {
    CliBuilder builder = Cli.builder("ddf").withDescription("DDF Command Line Client");

    builder.withParser().withCommandAbbreviation().withOptionAbbreviation();

    builder.withCommand(Download.class).withCommand(Help.class).withDefaultCommand(Help.class);
