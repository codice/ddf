...
public class ObjectFactory {
  ...
  private static final QName HELLO_WORLD_RESPONSE_QNAME =
      new QName("http://ddf.sdk/soap/hello", "helloWorldResponse");

  private static final QName HELLO_WORLD_QNAME =
      new QName("http://ddf.sdk/soap/hello", "helloWorld");

  /**
   * Create a new ObjectFactory that can be used to create new instances of schema derived classes
   * for package: sdk.ddf.soap.hello
   */
  ...
  /**
   * Create an instance of {@link javax.xml.bind.JAXBElement }{@code <}{@link
   * sdk.ddf.soap.hello.HelloWorldResponse }{@code >}}
   */
  ...
  public JAXBElement<HelloWorldResponse> createHelloWorldResponse(HelloWorldResponse value) {
    return new JAXBElement<HelloWorldResponse>(
        HELLO_WORLD_RESPONSE_QNAME, HelloWorldResponse.class, null, value);
  }

  /**
   * Create an instance of {@link javax.xml.bind.JAXBElement }{@code <}{@link
   * sdk.ddf.soap.hello.HelloWorld }{@code >}}
   */
