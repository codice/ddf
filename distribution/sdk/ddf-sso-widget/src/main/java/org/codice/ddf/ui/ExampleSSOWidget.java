...
public class ExampleSSOWidget extends HttpServlet {
    ...
    protected void createPage(HttpServletRequest request, PrintWriter out)
        ...
        sb.append("<body>")
                .append(endl);
        sb.append("<h2 align=\"center\">Example SSO Widget")
                .append(" Protected Page on ")
        ...
        if (request.getContextPath() != null && !"".equals(request.getContextPath())) {
            sb.append("</p><p>")
                    .append(endl);
            sb.append("The context root name of this application is ")
        ...
        sb.append("<h3>Released Attributes:</h3>")
                .append(endl);
        ...
        if (hdrEnum != null) {
            ...
            sb.append("getHeaderNames() = null<br/>")
                    .append(endl);
        }
