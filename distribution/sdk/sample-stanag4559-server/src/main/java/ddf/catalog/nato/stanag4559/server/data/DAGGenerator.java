...
import ddf.catalog.nato.stanag4559.common.UCO.Edge;
...
public class DAGGenerator {
    ...
    */
    ...
    public static final String ORGANIZATION = "DDF";
    ...
    public static final String ABSTIME_CLASS = "class UCO.AbsTime";
    ...
    public static final String NSIL_RELATED_FILE = "";
    ...
    public static final String ENCODING_TYPE = "264ON2";
    ...
    public static final String IDENTIFIER_VALUE = "DDF-123";
    ...
    private static Node[] constructNSILProduct(ORB orb, Graph<Node, Edge> graph,
        ...
        Node node = constructEntityNode(NSIL_COMMON, orb);
        graph.addVertex(node);
        ...
        graph.addVertex(attribute);
        graph.addEdge(node, attribute);
        attribute = constructAttributeNode(IDENTIFIER_MISSION, IDENTIFIER_VALUE, orb);
        graph.addVertex(attribute);
        graph.addEdge(node, attribute);
        attribute = constructAttributeNode(SOURCE, SOURCE_LIST, orb);
        graph.addVertex(attribute);
        graph.addEdge(node, attribute);
        attribute = constructAttributeNode(TARGET_NUMBER, IDENTIFIER_VALUE, orb);
        graph.addVertex(attribute);
        graph.addEdge(node, attribute);
