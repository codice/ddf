...
public class SecurityPolicyConfigurator implements AdminConfig.ConfigWaitable {
    ...
    public static void configureRestForAnonymous(AdminConfig adminConfig,
        ...
        adminConfig
                .updateConfig(new SecurityPolicyConfigurator(serviceManager, serviceRoot, "ANON"));
    }

    public static void configureRestForBasic(AdminConfig adminConfig, ServiceManager serviceManager,
            String serviceRoot) throws IOException, InterruptedException {
        adminConfig
                .updateConfig(new SecurityPolicyConfigurator(serviceManager, serviceRoot, "basic"));
    }
