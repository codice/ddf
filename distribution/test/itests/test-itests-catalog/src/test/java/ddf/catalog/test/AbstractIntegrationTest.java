...
import ddf.common.test.AdminConfigFacade;
...
public abstract class AbstractIntegrationTest {
    ...
    protected static final String LOG_CONFIG_PID = AdminConfigFacade.LOG_CONFIG_PID;

    protected static final String LOGGER_PREFIX = AdminConfigFacade.LOGGER_PREFIX;

    protected static final String DEFAULT_LOG_LEVEL = AdminConfigFacade.DEFAULT_LOG_LEVEL;
    ...
    private AdminConfigFacade adminConfigFacade;

    private ServiceManagerFacade serviceManagerFacade;

    private CatalogBundleFacade catalogBundleFacade;
    ...
    public void initFacades() {
        adminConfigFacade = new AdminConfigFacade(configAdmin);
        serviceManagerFacade = new ServiceManagerFacade(bundleCtx, metatype, adminConfigFacade);
        catalogBundleFacade = new CatalogBundleFacade(serviceManagerFacade);
    }
    ...
    public AdminConfigFacade getAdminConfigFacade() {
        return adminConfigFacade;
    }
    ...
    public CatalogBundleFacade getCatalogBundleFacade() {
        return catalogBundleFacade;
    }
     ...
     * @deprecated since 2.8.0 see {@link ServiceManagerFacade#waitForHttpEndpoint(String)}
     */
    @Deprecated
    protected void waitForHttpEndpoint(String path) throws InterruptedException {
        serviceManagerFacade.waitForHttpEndpoint(path);
    }
     ...
     * @param featureNames
     * @throws Exception
     * @deprecated since 2.8.0 see {@link ServiceManagerFacade#stopFeature(boolean, String...)}
     */
    @Deprecated
    protected void stopFeature(boolean wait, String... featureNames) throws Exception {
        serviceManagerFacade.stopFeature(wait, featureNames);
    }

    /**
     * @throws IOException
     * @deprecated since 2.8.0 see {@link AdminConfigFacade#setLogLevels()}
     */
    @Deprecated
    protected void setLogLevels() throws IOException {
        adminConfigFacade.setLogLevels();
    }
     ...
     * @param featureNames
     * @throws Exception
     * @deprecated since 2.8.0 see {@link ServiceManagerFacade#startFeature(boolean, String...)}
     */
    @Deprecated
    protected void startFeature(boolean wait, String... featureNames) throws Exception {
        serviceManagerFacade.startFeature(wait, featureNames);
    }
     ...
     * @param properties
     * @throws IOException
     * @deprecated since 2.8.0 see {@link ServiceManagerFacade#createManagedService(String, Map)}
     */
    @Deprecated
    protected void createManagedService(String factoryPid, Map<String, Object> properties)
            throws IOException {
        serviceManagerFacade.createManagedService(factoryPid, properties);
    }

    /**
     * @param fanoutEnabled
     * @throws IOException
     * @deprecated since 2.8.0 see {@link AdminConfigFacade#setFanout(boolean)}
     */
    @Deprecated
    protected void setFanout(boolean fanoutEnabled) throws IOException {
        adminConfigFacade.setFanout(fanoutEnabled);
    }

    /**
     * @param symbolicNamePrefix
     * @throws InterruptedException
     * @deprecated since 2.8.0 see {@link ServiceManagerFacade#waitForRequiredBundles(String)}
     */
    @Deprecated
    protected void waitForRequiredBundles(String symbolicNamePrefix) throws InterruptedException {
        serviceManagerFacade.waitForRequiredBundles(symbolicNamePrefix);
    }

    /**
     * @param sources
     * @throws InterruptedException
     * @deprecated since 2.8.0 see {@link ServiceManagerFacade#waitForSourcesToBeAvailable(String, String...)}
     */
    @Deprecated
    protected void waitForSourcesToBeAvailable(String... sources) throws InterruptedException {
        serviceManagerFacade.waitForSourcesToBeAvailable(REST_PATH, sources);
    }
     ...
     * @deprecated since 2.8.0 see {@link CatalogBundleFacade#waitForFederatedSource(String)}
     */
    @Deprecated
    protected FederatedSource waitForFederatedSource(String id)
            throws InterruptedException, InvalidSyntaxException {
        return catalogBundleFacade.waitForFederatedSource(id);
    }

    /**
     * @return
     * @throws InterruptedException
     * @deprecated since 2.8.0 see {@link CatalogBundleFacade#waitForCatalogProvider()}
     */
    @Deprecated
    protected CatalogProvider waitForCatalogProvider() throws InterruptedException {
        return catalogBundleFacade.waitForCatalogProvider();
    }

    /**
     * @return
     * @throws InterruptedException
     * @deprecated since 2.8.0 see {@link CatalogBundleFacade#getCatalogFramework()}
     */
    @Deprecated
    protected CatalogFramework getCatalogFramework() throws InterruptedException {
        return catalogBundleFacade.getCatalogFramework();
    }
     ...
     * @param factoryPid
     * @return
     * @deprecated since 2.8.0 see {@link ServiceManagerFacade#getMetatypeDefaults(String, String)}
     */
    @Deprecated
    protected Map<String, Object> getMetatypeDefaults(String symbolicName, String factoryPid) {
        return serviceManagerFacade.getMetatypeDefaults(symbolicName, factoryPid);
    }
     ...
     * @param properties
     * @throws IOException
     * @deprecated since 2.8.0 see {@link ServiceManagerFacade#startManagedService(String, Map)}
     */
    @Deprecated
    protected void startManagedService(String servicePid, Map<String, Object> properties)
            throws IOException {
        serviceManagerFacade.startManagedService(servicePid, properties);
    }

    /**
     * @throws InterruptedException
     * @deprecated since 2.8.0 see {@link ServiceManagerFacade#waitForAllBundles()}
     */
    @Deprecated
    protected void waitForAllBundles() throws InterruptedException {
        serviceManagerFacade.waitForAllBundles();
    }
