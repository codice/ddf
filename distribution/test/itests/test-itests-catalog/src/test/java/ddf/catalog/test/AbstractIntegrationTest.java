...
public abstract class AbstractIntegrationTest {
    ...
    protected static final long ONE_MINUTE_MILLIS = TimeUnit.MINUTES.toMillis(1);

    protected static final long REQUIRED_BUNDLES_TIMEOUT = ServiceManager.REQUIRED_BUNDLES_TIMEOUT;

    protected static final long MANAGED_SERVICE_TIMEOUT = ServiceManager.MANAGED_SERVICE_TIMEOUT;

    protected static final long CATALOG_PROVIDER_TIMEOUT = CatalogBundle.CATALOG_PROVIDER_TIMEOUT;

    protected static final long HTTP_ENDPOINT_TIMEOUT = ServiceManager.HTTP_ENDPOINT_TIMEOUT;
