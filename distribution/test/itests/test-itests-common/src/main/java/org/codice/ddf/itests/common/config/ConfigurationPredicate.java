 ...
 *
 * @deprecated Use {@link org.codice.ddf.itests.common.WaitCondition} instead.
 */
public interface ConfigurationPredicate {
   ...
   * "property XYZ equals 123". This message will be used in log statements and exception messages.
   */
  String toString();
}
