...
public class ConfigurationPropertyMatches implements ConfigurationPredicate {
   ...
   * @param valueRegex regular expression the property value needs to match for this predicate to
   *     return {@code true}.
   */
  ...
  public String toString() {
    return String.format("property [%s] matches regular expression [%s]", propertyName, valueRegex);
  }
}
