...
public class ServiceManagerFacade {
    public static final Logger LOGGER = LoggerFactory.getLogger(ServiceManagerFacade.class);
    ...
    private final AdminConfigFacade adminConfigFacade;

    private BlueprintListener blueprintListener;

    public ServiceManagerFacade(BundleContext bundleCtx, MetaTypeService metatype,
            AdminConfigFacade adminConfigFacade) {
        this.bundleCtx = bundleCtx;
        this.metatype = metatype;
        this.adminConfigFacade = adminConfigFacade;
    }
    ...
    public void createManagedService(String factoryPid, Map<String, Object> properties)
        ...
        final Configuration sourceConfig = adminConfigFacade
    ...
    public void startManagedService(String servicePid, Map<String, Object> properties)
            throws IOException {
        Configuration sourceConfig = adminConfigFacade.getConfiguration(servicePid);
