...
@REM ****************************************************************************************************************************
@REM This file differs from the Solr provided script based on the workaround posted on the official Apache mailing list archive
@REM https://mail-archives.apache.org/mod_mbox/lucene-solr-user/201807.mbox/%3Cbd8befdae893df47033926484644f40c%40jafurrer.ch%3E
@REM
@REM Changed all occurrences of '-Dlog4j.configurationFile="file:' to '-Dlog4j.configurationFile="' (19 occurrences in total)
@REM Changed all occurrences of 'LOG4J_CONFIG=file:' to 'LOG4J_CONFIG=' (2 occurrences in total)
@REM
@REM This file can be removed once Solr is upgraded to 7.5/8.0
@REM https://issues.apache.org/jira/browse/SOLR-12538
@REM ****************************************************************************************************************************
...
IF NOT "%TMP%"=="%SOLR_HOME%" (
  ...
  set "LOG4J_CONFIG=%EXAMPLE_DIR%\resources\log4j2.xml"
)
...
IF "%FG%"=="1" (
  ...
  "%JAVA%" %SOLR_SSL_OPTS% %AUTHC_OPTS% %SOLR_ZK_CREDS_AND_ACLS% -Dsolr.install.dir="%SOLR_TIP%" -Dsolr.default.confdir="%DEFAULT_CONFDIR%"^
    -Dlog4j.configurationFile="%DEFAULT_SERVER_DIR%\resources\log4j2.xml" ^
