...
Once deployed, the bundle should come up in the Active state, if all the dependencies were properly met.
...
[ 162] [Active    ] [       ] [  ] [ 80] ${ddf-branding} :: Registry :: example Client (3.0.0)
----
