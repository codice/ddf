...
----
144 │ Resolved │  20 │ 1.0.0                 │ Apache Aries Blueprint Core Compatiblity Fragment Bundle, Hosts: 143
----
...
|`documentation`
|HTML of ${branding} documentation.
...
|`system`
|Local bundle repository. Contains all the JARs required by ${branding}, including third-party JARs.
