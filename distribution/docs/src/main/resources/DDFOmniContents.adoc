...
include::${project.build.directory}/apps/solr/ManContents.adoc[]
...
include::${project.build.directory}/apps/solr/IntContents.adoc[]
...
include::${project.build.directory}/apps/solr/ExtContents.adoc[]
