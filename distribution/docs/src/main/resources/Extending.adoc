...
These options are taken from suggestions provided on github issue tickets. There have been several tickets created and closed, and several workarounds have been suggested. However, it appears that these have not resolved the issue. Once more information develops on a solution for this issue, this page will be updated.
====
...
A code formatter for the Eclipse IDE that can be used across all DDF projects to enforce code consistency and minimize merge issues in the future.
...
DDF is a customized and branded distribution of Apache Karaf.  DDF could also be considered to be a more lightweight OSGi distribution, as compared to Apache ServiceMix, FUSE ESB, or Talend ESB, all of which are also built upon Apache Karaf.  Like its peers, DDF incorporates additional upstream dependencies (https://tools.codice.org/#DDFArchitecture-AdditionalUpstreamDependencies).
...
In the above example, the user's claims are represented very simply and resemble how they would actually appear in a SAML 2 assertion. Each of these user (or subject) claims will be converted to a KeyValuePermission object. These permission objects will be implied against the permission object generated from the metacard record. In this particular case, the metacard might be allowed if the policy is configured appropriately because all of the permissions line up correctly.
            ...
            <ns2:RequestedSecurityToken>
               <saml2:Assertion ID="_90DBA0754E55B4FE7013928310431176" IssueInstant="2014-02-19T17:30:43.117Z" Version="2.0" xsi:type="saml2:AssertionType" xmlns:saml2="urn:oasis:names:tc:SAML:2.0:assertion" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance">
                  ...
                  <ds:Signature xmlns:ds="http://www.w3.org/2000/09/xmldsig#">
                     ...
                     <ds:SignatureValue>
                    </ds:SignatureValue>
                     <ds:KeyInfo>
                        <ds:X509Data>
...
==== Creating a Policy
This document assumes basic knowledge of the XACML schema and does not go into detail on the XACML language. 
