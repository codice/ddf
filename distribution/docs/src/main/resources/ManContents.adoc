...
|Lists of Strings
|`name = [ "value1", "value2", ... ]`
|`authenticationTypes = [ "/\=SAML\|ANON", "/admin\=SAML\|basic", "/jolokia\=SAML\|basic", "/system\=basic", "/solr\=SAML\|PKI\|basic", "/security-config\=SAML\|basic" ]`
...
authenticationTypes=["/\=SAML|ANON","/admin\=SAML|basic","/jolokia\=SAML|basic","/system\=basic","/solr\=SAML|PKI|basic","/security-config\=SAML|basic","/search\=basic"]
