...
|etc/failed
|If there is a problem with any of the .config files, such as bad syntax or missing tokens, they will be relocated here.

|etc/processed
|All successfully processed .config files will be relocated here.
...
//      How does the below section relate to the previous section (Configuring {branding} with New Certificates)
//      and should they be combined?
//      Current answer: No, the first section is a light intro while these sections are security-intense.
...
//      DDF-1796: Hardening Section Needs a lot of Clean up
//      Do we place the warning note here?
...
//    For below note, if there is a SIMLINK, it will not be included
//    DDF-1796: Hardening Section Needs a lot of Clean up
