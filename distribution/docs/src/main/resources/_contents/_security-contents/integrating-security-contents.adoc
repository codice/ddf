...
. Run the installer at ${secure_url}/admin
...
Settings can be found in the ${admin-console} (${secure_url}/admin) under *${ddf-security} -> Configuration -> Security AuthZ Realm*.
