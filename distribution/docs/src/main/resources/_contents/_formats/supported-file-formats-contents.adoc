...
Many of these file types support additional <<_format_specific_attribute_mappings,format-specific attributes>> from which additional metadata can be extracted.
[NOTE]
====
