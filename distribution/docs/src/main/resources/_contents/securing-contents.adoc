...
. Install the `security-idp` feature either by command line: `feature:install security-idp`, or by the ${admin-console}: *${ddf-branding} Security* -> *Features* -> `security-idp`
