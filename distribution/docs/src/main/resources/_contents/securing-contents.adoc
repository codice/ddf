...
. Install the `security-idp` feature either by command line: `features:install security-idp`, or by the {admin-console}: *${ddf-branding} Security* -> *Features* -> `security-idp`
...
This also includes the {admin-
console} and any other web service that is hosted by ${branding}.
...
. Select the *${ddf-branding} Security* application.
...
. Click the ${ddf-branding} Catalog application tile
...
. Open the Admin Console at \https://localhost:8993/admin
. Click the ${ddf-branding} Security application tile
. Click the *Configuration* tab
...
These PolicyPlugin implementations allow an administrator to easily add filtering capabilities to some standard Metacard types for all ${ddf-branding} Catalog operations.
...
* `security/${ddf-branding-lowercase}-metacard-attribute-ruleset.cfg`
* `security/${ddf-branding-lowercase}-user-attribute-ruleset.cfg`
...
. After the installer completes, click the ${ddf-branding} Security application tile
. Click the *Features* tab
. Install `security-sts-ldaplogin` and `security-sts-ldapclaimshandler` features by clicking the *Play* button next to each
. Open the ${ddf-branding} Admin Console as an administrator (https://localhost:8993/admin).
. Click the *${ddf-branding} Security* application tile
. Click the *Configuration* tab
