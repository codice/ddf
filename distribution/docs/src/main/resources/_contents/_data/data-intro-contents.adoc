...
|STRING
|Attribute name accessing for the metadata content type of a resource.

|CONTENT_TYPE_VERSION
|metadata-content-type-version
|STRING
|Attribute name for the version of the metadata content accessing type of a resource.

|CREATED
|created
|DATE
|Attribute name for the date/time *this metacard* was created.
...
|effective
|DATE
|Attribute name for the date/time of *the product* represented by the metacard.

|EXPIRATION
|expiration
|DATE
|Attribute name for the date/time the metacard is no longer valid and can be removed.

|ID
|id
|STRING
|Attribute name for the ID of the metacard.
...
|location
|GEOMETRY
|Attribute name for the location for this metacard.
...
|metadata
|XML
|Attribute name for the XML metadata for this metacard.

|MODIFIED
|modified
|DATE
|Attribute name for the date/time this resource was last modified.
...
|resource-size
|STRING
|Attribute name for the size in bytes of the product this metacard represents.

|RESOURCE_URI
|resource-uri
|STRING
|Attribute name for the URI reference to the product this metacard represents.

|SOURCE_ID
|source-id
|String
|ID of the source where the metacard is cataloged.

|TARGET_NAMESPACE
|metadata-target-namespace
|STRING
|Attribute name for the target namespace of the metadata content type of a metacard.

|THUMBNAIL
|thumbnail
|BINARY
|Attribute name for the thumbnail image of the product this metacard represents. The thumbnail must be of MIME Type `image/jpeg` and be less than 128 kilobytes. 

|TITLE
|title
|STRING
|Attribute name for the title of the metacard.
