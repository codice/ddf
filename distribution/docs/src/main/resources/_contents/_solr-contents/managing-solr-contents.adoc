...
include::../_tables/conf-ddf.catalog.solr.external.SolrHttpCatalogProvider-table-contents.adoc[]
|===

include::../_tables/ddf.catalog.solr.external.SolrHttpCatalogProvider-table-contents.adoc[]
...
=== Using ${branding} Catalog Solr External Provider
...
==== Installing ${branding} Catalog Solr External Provider

By default, the ${ddf-solr} application installs the External Solr Provider.

===== Configuring ${branding} Catalog Solr External Provider
...
The <<ddf.catalog.solr.external.SolrHttpCatalogProvider, configurable properties>> for this SCP are accessed from the Catalog External Solr Catalog Provider configurations in the ${admin-console}.

=== Using ${branding} Catalog Solr Embedded Provider
...
===== Installing ${branding} Catalog Solr Embedded Provider
...
.${ddf-solr} Catalog Solr Embedded Provider Configurations
[cols="1,1m,1" options="header"]
|===
|Name
|Configuration ID
...
include::../_tables/conf-ddf.catalog.source.solr.SolrCatalogProvider-table-contents.adoc[]
|===

include::../_tables/ddf.catalog.source.solr.SolrCatalogProvider-table-contents.adoc[]
...
==== Standalone Solr Server Prerequisites
...
==== Installing Standalone Solr Server
...
==== Configuring Standalone Solr Server
...
==== Known Issues With Standalone Solr Server
