...
include::${project.build.directory}/doc-contents/_ddf/docs-${ddf.version}/_security-framework/security-sts-ldap-login-contents.adoc[]

include::${project.build.directory}/doc-contents/_ddf/docs-${ddf.version}/_security-framework/security-sts-ldap-claims-handler-contents.adoc[]
...
include::${project.build.directory}/doc-contents/_ddf/docs-${ddf.version}/_securing/configuring-web-context-policy-manager-contents.adoc[leveloffset=+1]

include::${project.build.directory}/doc-contents/_ddf/docs-${ddf.version}/_tables/org.codice.ddf.security.policy.context.impl.PolicyManager.adoc[]
...
To update the username and password, open the *${admin-console}* and select the *Sensor App* application.
