...
. Select *${ddf-ui}* application.
. Select *Configuration* tab.

include::{adoc-include}/_tables/org.codice.ddf.ui.search.standard.endpoint-table-contents.adoc[]
...
The <<_asynchronous_search_subscribing, Subscribing to Notifications>> section details how to subscribe to a CometD channel.
