...
The CSW endpoint is accessible from \http://<${secure_url}/services/csw.
...
----
http://${secure_url}/services/csw?service=CSW&version=2.0.2&request=GetCapabilities
----
...
----
${secure_url}/services/csw?service=CSW&version=2.0.2&request=GetRecords&o
...
.`GetRecordById` HTTP GET KVP Encoding
----
...
===== Known Issues with CSW Endpoint
