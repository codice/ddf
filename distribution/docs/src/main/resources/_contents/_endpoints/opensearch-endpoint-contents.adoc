...
===== Installing OpenSearch Endpoint

The OpenSearch Endpoint is installed by default with a standard installation in the {app-name} application.
The OpenSearch Endpoint is not installed by default with a standard installation in the {app-name} application.
To install:
...
===== OpenSearch Endpoint Known Issues
