...
* *Add to Bookmarks*: Adds the result to your bookmarks.
** Changes to *Remove from Bookmarks* for bookmarked items: Removes the result from your bookmarks.
...
* *Download*: Downloads the result's associated product directly to your machine.
...
. Select *Settings* icon (image:settings.png[settings]) on navigation bar.
. Select *Hidden*.
