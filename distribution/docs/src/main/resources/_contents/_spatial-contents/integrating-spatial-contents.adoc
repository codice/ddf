...
===== `Contextual Operation Examples`
A distributed query for records with a property name of "AnyText" and a value containing a string like "T#xtToMatch".
Note: The attribute value singleChar="#" indicates that '#' can be replaced by any other character for the string
[source,xml,linenums]
----
       ...
       <csw:Constraint version="1.1.0">
           <ogc:Filter>
               <ogc:PropertyIsLike wildCard="*" singleChar="#" escapeChar="!">
                   <ogc:PropertyName>AnyText</ogc:PropertyName>
                   <ogc:Literal>T#xtToMatch</ogc:Literal>
               </ogc:PropertyIsLike>
           </ogc:Filter>
       </csw:Constraint>
   </csw:Query>
<csw:DistributedSearch hopCount="2" /></csw:GetRecords>
----
A query for records with a property value equal to "TextToMatch".
[source,xml,linenums]
----
<csw:GetRecords xmlns:ows="http://www.opengis.net/ows" xmlns:ns2="http://www.w3.org/1999/xlink"
               xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml"
       ...
       <csw:Constraint version="1.1.0">
           <ogc:Filter>
               <ogc:PropertyIsEqualTo matchCase="true">
                   <ogc:PropertyName>AnyText</ogc:PropertyName>
                   <ogc:Literal>TextToMatch</ogc:Literal>
...
----
A fuzzy search query for records with a property value similar to "FuzzyTextToMatch".
Note: A fuzzy search will make a best effort matching unlike PropertyIsEqual and PropertyIsLike.
[source,xml,linenums]
----
<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<csw:GetRecords xmlns:ows="http://www.opengis.net/ows" xmlns:ns2="http://www.w3.org/1999/xlink"
    ...
    <csw:Query typeNames="csw:Record">
        ...
        <csw:Constraint version="1.1.0">
            <ogc:Filter>
                <ogc:PropertyIsFuzzy>
                    <ogc:PropertyName>AnyText</ogc:PropertyName>
                    <ogc:Literal>FuzzyTextToMatch</ogc:Literal>
                </ogc:PropertyIsFuzzy>
            </ogc:Filter>
        </csw:Constraint>
    </csw:Query>
<csw:DistributedSearch hopCount="2" /></csw:GetRecords>
----
===== `Temporal Operation Examples`
A query for records created after a specific date.
[source,xml,linenums]
----
<csw:GetRecords xmlns:ows="http://www.opengis.net/ows" xmlns:ns2="http://www.w3.org/1999/xlink"
               xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml"
       ...
       <csw:Constraint version="1.1.0">
           <ogc:Filter>
               <ogc:PropertyIsGreaterThan>
                   ...
                   <ogc:Literal>2012-12-25T10:10:19.000-07:00</ogc:Literal>
               </ogc:PropertyIsGreaterThan>
           </ogc:Filter>
       </csw:Constraint>
   </csw:Query>
...
----
A query for records created between two specific dates.
[source,xml,linenums]
----
<csw:GetRecords xmlns:ows="http://www.opengis.net/ows" xmlns:ns2="http://www.w3.org/1999/xlink"
               xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml"
       ...
       <csw:Constraint version="1.1.0">
           <ogc:Filter>
               <ogc:PropertyIsBetween>
                   <ogc:PropertyName>created</ogc:PropertyName>
                   <ogc:LowerBoundary>
                       <ogc:Literal>2012-12-24T17:05:19.000-07:00</ogc:Literal>
                   </ogc:LowerBoundary>
                   <ogc:UpperBoundary>
                       <ogc:Literal>2012-12-26T17:08:52.000-07:00</ogc:Literal>
                   </ogc:UpperBoundary>
               </ogc:PropertyIsBetween>
           </ogc:Filter>
       </csw:Constraint>
...
----
A query for records created before a specific date.
[source,xml,linenums]
----
<csw:GetRecords xmlns:ows="http://www.opengis.net/ows" xmlns:ns2="http://www.w3.org/1999/xlink"
               xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml"
...
A query for records with a BoundingBox within 500 meters of the specified LinearRing
[source,xml,linenums]
----
<csw:GetRecords xmlns:ows="http://www.opengis.net/ows" xmlns:ns2="http://www.w3.org/1999/xlink"
               xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml"
           ...
           <ogc:Filter>
               <ogc:DWithin>
                   ...
                   <gml:Polygon srsName="EPSG:4326">
                       <gml:exterior>
                           <gml:LinearRing>
                               <gml:pos>69.31 33.2</gml:pos>
                               <gml:pos>70.73 33.22</gml:pos>
                               <gml:pos>69.66 34.29</gml:pos>
                               <gml:pos>69.31 33.2</gml:pos>
                           </gml:LinearRing>
                       </gml:exterior>
                   </gml:Polygon>
                   <ogc:Distance units="METERS">500.0</ogc:Distance>
               </ogc:DWithin>
           </ogc:Filter>
       </csw:Constraint>
   </csw:Query>
...
----
A query for records with a BoundingBox that intersects the specified LinearRing
[source,xml,linenums]
----
<csw:GetRecords xmlns:ows="http://www.opengis.net/ows" xmlns:ns2="http://www.w3.org/1999/xlink"
               xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml"
...
----
A query for records with a BoundingBox that contains the specified Line
[source,xml,linenums]
----
<csw:GetRecords xmlns:ows="http://www.opengis.net/ows" xmlns:ns2="http://www.w3.org/1999/xlink"
               xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml"
           ...
           <ogc:Filter>
               <ogc:Contains>
                   ...
                   <gml:LineString srsName="EPSG:4326">
                       <ns2:pos>25 31</ns2:pos>
                       <ns2:pos>27 32 </ns2:pos>
                   </gml:LineString>
               </ogc:Contains>
           </ogc:Filter>
       </csw:Constraint>
...
----
===== `XPath Operation Example`
An xpath query for records with an xpath property with a value like "LikeTextToMatch".
Note: xpath expressions are evaluated against the internal document structure, NOT the outputSchema structure
[source,xml,linenums]
----
 <csw:GetRecords xmlns:ows="http://www.opengis.net/ows" xmlns:ns2="http://www.w3.org/1999/xlink"
               xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml"
       ...
       <csw:Constraint version="1.1.0">
           <ogc:Filter>
               <ogc:PropertyIsLike wildCard="*" singleChar="#" escapeChar="!">
                   ...
                   <ogc:Literal>LikeTextToMatch</ogc:Literal>
               </ogc:PropertyIsLike>
           </ogc:Filter>
       </csw:Constraint>
   </csw:Query>
...
A query for records which were created before a specific date AND contain a string like "LikeTextToMatch"
[source,xml,linenums]
----
...
----
A query for records with a property containing a value like "LikeTextToMatch" OR a property containing a value like "OtherLikeTextToMatch"
[source,xml,linenums]
----
<csw:GetRecords xmlns:ows="http://www.opengis.net/ows" xmlns:ns2="http://www.w3.org/1999/xlink"
               xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml"
       ...
       <csw:Constraint version="1.1.0">
           <ogc:Filter>
               <ogc:Or>
                       ...
                       <ogc:PropertyIsLike wildCard="*" singleChar="#" escapeChar="!">
                        <ogc:PropertyName>AnyText</ogc:PropertyName>
                        <ogc:Literal>OtherLikeTextToMatch</ogc:Literal>
                       </ogc:PropertyIsLike>
               </ogc:Or>
           </ogc:Filter>
       </csw:Constraint>
...
----
A query for records with a property NOT containing a value like "LikeTextToMatch"
[source,xml,linenums]
----
<csw:GetRecords xmlns:ows="http://www.opengis.net/ows" xmlns:ns2="http://www.w3.org/1999/xlink"
               xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml"
...
----
A query for records with a property containing a value like "LikeTextToMatch" AND NOT another property containing a property with a value like "OtherLikeText"
[source,xml,linenums]
----
<csw:GetRecords xmlns:ows="http://www.opengis.net/ows" xmlns:ns2="http://www.w3.org/1999/xlink"
               xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml"
           ...
           <ogc:Filter>
               <ogc:And>
                   ...
                   <ogc:Not>
                       <ogc:PropertyIsLike wildCard="*" singleChar="#" escapeChar="!">
                        <ogc:PropertyName>AnyText</ogc:PropertyName>
                        <ogc:Literal>OtherLikeText</ogc:Literal>
                       </ogc:PropertyIsLike>
                   </ogc:Not>
               </ogc:And>
           </ogc:Filter>
...
If an output type format is specified, the results will be transformed into the given format. The list of supported output formats can be found by doing a GetCapabilities request to the CSW endpoint. Supported output formats include:
- application/xml
- application/json
- application/atom+xml
- text/xml
- application/zip
Example query for records with a property name equal to "TextToMatch" and an output format of JSON.
[source,xml,linenums]
----
<csw:GetRecords xmlns:ows="http://www.opengis.net/ows" xmlns:ns2="http://www.w3.org/1999/xlink"
              xmlns:ogc="http://www.opengis.net/ogc" xmlns:gml="http://www.opengis.net/gml"
...
<xml>GeoJson far<\/xml>",
              ...
              "created":"2012-12-26T00:09:19.368+0000",
              ...
              "title":"GeoJson far",
              "resource-download-url":"https:\/\/localhost:8993\/services\/catalog\/sources\/ddf.distribution\/089000423b8444578519785564326818?transform=resource",
              "source-id":"ddf.distribution",
              "effective":"2012-12-26T00:09:19.368+0000",
              "point-of-contact":"",
              "resource.cached":false,
              "checksum":"54a63622",
              "modified":"2012-12-26T00:09:19.368+0000",
              "id":"089000423b8444578519785564326818",
...
[NOTE]
====
${branding} does not include a WFS Web Service Endpoint implementation.
