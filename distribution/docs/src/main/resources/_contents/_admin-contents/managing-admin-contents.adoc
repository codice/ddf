...
include::../_tables/conf-org.codice.ddf.admin.config.policy.AdminConfigPolicy-table-contents.adoc[]

include::../_tables/conf-org.codice.admin.ui.configuration-table-contents.adoc[]
|===

include::../_tables/org.codice.ddf.admin.config.policy.AdminConfigPolicy-table-contents.adoc[]

include::../_tables/org.codice.admin.ui.configuration-table-contents.adoc[]
...
==== Application Service Console Commands
...
* <<installer_module,Installer Module>>
