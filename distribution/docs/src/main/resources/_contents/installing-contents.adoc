...
If displayed, the
`${ddf-branding} :: Distribution :: Web Console`
entry should be in the *Resolved* state.
This is expected.
The ${ddf-branding} Distribution Web Console is an OSGi bundle fragment.
...
----
[ 261] [Resolved   ] [            ] [       ] [   80] ${ddf-branding} :: Distribution :: Web Console (2.2.0)
