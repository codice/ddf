...
The KML Style Mapper is installed by default with a standard installation in the <<_managing_ddf_spatial,${ddf-spatial} Application>> in the `spatial-kml-transformer` feature.
...
include::{adoc-include}/_tables/org.codice.ddf.spatial.kml.style-table-contents.adoc[]
