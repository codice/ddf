...
|`linksTitle`
|String
|The title displayed for additional links (e.g. Bookmarks, Additional Links, etc.).
|
|yes
...
|`links`
|String
|Additional links to be displayed on the landing page. Use the format <text>,<link> (e.g. example, http://www.example.com).
|
|yes
