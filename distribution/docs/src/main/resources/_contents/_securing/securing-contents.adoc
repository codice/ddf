...
More information on configuring the LDAP and a list of users and attributes can be found at <<_configuring_embedded_ldap,Embedded LDAP Configuration>>.
...
====== Configuring the Credentials to the Principal Resolver
...
Set up general purpose certificates.
...
Sources can be configured to accept SSL.
