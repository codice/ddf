...
.Other Plugins
<<_policy_plugin,Policy Plugins>>:: used to build policy information for requests.

<<_access_plugin,Access Plugins>>:: allows or denies access to the Catalog operation or response.
