...
(To get a list of supported schemas, send a <<{integrating-prefix}get_capabilities,Get Capabilities>> request to the CSW endpoint.)
...
To find a valid `source-id` , send a <<{integrating-prefix}get_capabilities,Get Capabilities>> request.
