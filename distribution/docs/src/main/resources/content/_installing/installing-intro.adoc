...
Please consult the https://lucene.apache.org/solr/guide/6_6/installing-solr.html[Solr System Requirements] for guidance if the system will also be hosting a local catalog.
====
