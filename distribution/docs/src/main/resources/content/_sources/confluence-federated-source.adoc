...
[IMPORTANT]
====
If an additional attribute is not part of the Confluence metacard type or <<_attribute_injection_definition,injected>>, the attribute will not be added to the metacard.
====
