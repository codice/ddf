...
See <<{application-prefix}Wfs_v1_0_0_Federated_Source,WFS v.1.0 Federated Source configurations>> or <<{application-prefix}Wfs_v1_0_0_Connected_Source,WFS v1.0 Connected Source configurations>> for all possible configurations.a
