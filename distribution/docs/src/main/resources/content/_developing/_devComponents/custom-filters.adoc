...
String property = Core.MODIFIED ; // modified date of a metacard
...
Filter filter =
    filterFactory.and(
       filterFactory.like(filterFactory.property(Core.METADATA), "mission" ,
wildcardChar, singleChar, escapeChar, isCaseSensitive),
       filterFactory.like(filterFactory.property(Core.METADATA), "planning" ,
wildcardChar, singleChar, escapeChar, isCaseSensitive)
    );
