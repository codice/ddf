...
.. Disable the *Limit RelayStates to 80 Bytes* option to allow interoperability with non SAML-compliant Service Providers that send RelayStates larger than 80 bytes.
