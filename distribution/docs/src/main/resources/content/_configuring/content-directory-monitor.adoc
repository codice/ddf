...
[IMPORTANT]
====
If an overriden attribute is not part of the <<_metacard_type, metacard type>> or <<_attribute_injection_definition,injected>> the attribute will not be added to the metacard.
====
