...
${branding} includes a <<_configuring_included_idp,Identity Provider(IdP)>>, but can also be configured to support an <<_connecting_to_an_external_idp,external IdP>> or <<_configuring_without_an_idp,no IdP>> at all.
