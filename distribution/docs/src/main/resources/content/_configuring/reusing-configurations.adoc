...
* The import process will restore all applications, features, and/or bundles to the same state (i.e. installed, uninstalled, started, stopped, ...) they were in originally. It is therefore not required to go through the standard installation process after unzipping the ${branding} distribution.
