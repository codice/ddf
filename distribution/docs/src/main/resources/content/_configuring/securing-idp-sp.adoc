...
. Under *Authentication Types*, set the _IDP authentication type_ as necessary. Note that it should _only_ be used on context paths that will be accessed by users via web browsers.
For example:
- `/search=IDP`
