:title: Configuring Map for ${catalog-ui} Using Map Layers UI
...
Equivalent addition, editing, and deleting of a layer can be found <<_configuring_map_for_intrigue_using_catalog_ui_search,
