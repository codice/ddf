...
This can be changed during <<{managing-prefix}completing_installation_from_the_admin_console,Initial Configuration>> or later by editing the `${home_directory}/etc/system.properties` file.
