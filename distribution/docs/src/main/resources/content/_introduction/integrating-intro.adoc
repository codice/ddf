...
Federation with ${branding} is primarily accomplished through <<_endpoints,Endpoints>> accessible through http(s) requests and responses.
...
If you would like to set up a test or demo installation to use while developing an external client, see the <<_quick_start_tutorial,Quick Start Tutorial>> for demo instructions.
