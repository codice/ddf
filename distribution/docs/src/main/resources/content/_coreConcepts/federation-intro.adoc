...
Federation provides the capability to extend the ${branding} enterprise to include <<_connecting_to_sources,Remote Sources>>, which may include other instances of ${branding}. 
