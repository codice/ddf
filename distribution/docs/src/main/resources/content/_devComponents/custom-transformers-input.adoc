...
. Create an OSGi descriptor file to communicate with the OSGi Service Registry (described in the <<_osgi_basics,Working with OSGi>> section). Export the service to the OSGi Registry and declare service properties.
+
