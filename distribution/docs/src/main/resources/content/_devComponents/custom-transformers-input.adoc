...
The `org.codice.ddf.platform.serviceflag.BootServiceFlag` service with a service property of `id=inputTransformerServiceFlag` is used to indicate certain Input Transformers are ready in the system.
