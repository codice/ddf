...
Viewing will require ${branding}-administrator privileges, if <<_hiding_errors_or_warnings_from_queries, Catalog Federation Strategy>> is configured to filter invalid metacards.
