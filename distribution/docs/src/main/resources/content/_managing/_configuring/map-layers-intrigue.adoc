:title: Configuring Map Layers for ${catalog-search-ui}
...
See <<{reference-prefix}org.codice.ddf.catalog.ui,Catalog Search UI Configurations>> for examples of map layer configurations.
