...
.. http://artifacts.codice.org/content/groups/public/org/locationtech/jts/jts-core/${jts.solr.version}/jts-core-${jts.solr.version}.jar[jts-core-${jts.solr.version}.jar] {external-link}
...
. Copy `jts-core-${jts.solr.version}.jar` to: `<SOLR_INSTALL_DIR>/server/solr-webapp/webapp/WEB-INF/lib/`.
