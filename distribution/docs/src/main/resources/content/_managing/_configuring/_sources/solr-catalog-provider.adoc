...
.. http://artifacts.codice.org/content/groups/public/org/locationtech/jts/jts-core/1.15.0/jts-core-1.15.0.jar
...
. Copy `jts-core-1.15.0.jar` to: `<SOLR_INSTALL_DIR>/server/solr-webapp/webapp/WEB-INF/lib/`.
