...
See <<{application-prefix}Wfs_v2_0_0_Federated_Source,WFS v.2.0 Federated source configurations>> or <<{application-prefix}Wfs_v2_0_0_Connected_Source,WFS v2.0 Connected source configurations>> for all possible configurations.
