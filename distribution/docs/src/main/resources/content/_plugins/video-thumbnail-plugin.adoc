...
See <<{application-prefix}org.codice.ddf.catalog.content.plugin.video.VideoThumbnailPlugin,Video Thumbnail Plugin configurations>> for all possible configurations.
