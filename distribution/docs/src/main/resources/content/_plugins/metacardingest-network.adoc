...
See <<{application-prefix}org.codice.ddf.catalog.plugin.metacard.MetacardIngestNetworkPlugin,Metacard Ingest Network Plugin configurations>> for all possible configurations.
