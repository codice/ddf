...
See <<{application-prefix}org.codice.ddf.catalog.plugin.expiration.ExpirationDatePlugin,Expiration Date Plugin configurations>> for all possible configurations.
