...
The Catalog Components consist of <<_endpoints,Endpoints>>, <<_types_of_plugins,Plugins>>, <<_catalog_framework_reference,Catalog Frameworks>>, <<_introduction_to_federation_and_sources,Sources>>, and <<_catalog_providers,Catalog Providers>>.
