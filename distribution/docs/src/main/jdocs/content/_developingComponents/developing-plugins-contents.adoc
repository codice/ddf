...
|Before a federated query has been executed.
...
|<<_experimental_interfaces,Experimental >>Before an item is created in the content repository.

|<<_post_create_storage_plugins,Post-Create Storage>>
|ddf.catalog.content.plugin.PostCreateStoragePlugin
|<<_experimental_interfaces,Experimental >>After an item is created in the content repository.

|<<_pre_update_storage_plugins,Pre-Update Storage>>
|ddf.catalog.content.plugin.PreUpdateStoragePlugin
|<<_experimental_interfaces,Experimental >>Before an item is updated in the content repository.

|<<_post_update_storage_plugins,Post-Update Storage>>
|ddf.catalog.content.plugin.PostUpdateStoragePlugin
|<<_experimental_interfaces,Experimental >>After an item is updated in the content repository.
