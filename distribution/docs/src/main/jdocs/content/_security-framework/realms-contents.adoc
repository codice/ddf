...
${branding} uses takes from <<https://shiro.apache.org,Apache Shiro>> the concept of <<https://shiro.apache.org/realm.html,Realms>> for Authentication and Authorization.
...
[WARNING]
====
An update was made to the SAML Assertion Handler to pass SAML assertions through headers instead of through cookies.
