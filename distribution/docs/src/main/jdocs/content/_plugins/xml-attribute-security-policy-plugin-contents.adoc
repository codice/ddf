...
:plugintypes: policy
:summary: Find security attributes contained in a metacard.
...
The XML Attribute Security Policy Plugin is installed by default with a standard installation in the ${app-name} application.
