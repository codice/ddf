...
The *Metacard Attribute Security Policy Plugin* pulls attributes directly off of a metacard and combine these attributes into a security field for the metacard.
...
include::{adoc-include}/_tables/org.codice.ddf.catalog.security.policy.metacard.MetacardAttributeSecurityPolicyPlugin-table-contents.adoc[]
