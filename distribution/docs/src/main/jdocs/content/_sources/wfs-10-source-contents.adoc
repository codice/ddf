...
include::{adoc-include}/_tables/Wfs_v1_0_0_Federated_Source-table-contents.adoc[]

include::{adoc-include}/_tables/Wfs_v1_0_0_Connected_Source-table-contents.adoc[]
