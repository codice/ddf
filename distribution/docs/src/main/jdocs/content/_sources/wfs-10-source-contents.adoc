...
See <<Wfs_v1_0_0_Federated_Source,WFS v.1.0 Federated source>> or <<Wfs_v1_0_0_Connected_Source,WFS v1.0 Connected source>> configurations for all possible configurations.
