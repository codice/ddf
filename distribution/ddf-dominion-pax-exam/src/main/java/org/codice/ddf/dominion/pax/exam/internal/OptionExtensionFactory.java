...
import org.codice.ddf.dominion.pax.exam.options.extensions.InstallExtension;
import org.codice.dominion.options.Option;

/** Factory implementation for DDF's kernel option extensions. */
public class OptionExtensionFactory implements Option.Factory {
  ...
  static {
    final Map<Class<? extends Annotation>, Option.Extension> map = new HashMap<>(4);

    map.put(Install.class, new InstallExtension());
