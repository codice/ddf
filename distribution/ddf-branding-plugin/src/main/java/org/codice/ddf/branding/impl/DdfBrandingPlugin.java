...
public class DdfBrandingPlugin implements BrandingPlugin {
  ...
  public void init() {
    try {
      ...
      productURL =
          propertiesConfiguration.getString("branding.product.url", "http://codice.org/ddf");
      ...
      LOGGER.info("Unable to read properties file properties {} Message {}", brandingPropertiesFilePath, e.getMessage());
      productName = "DDF";
