...
public class DdfBrandingPluginTest {
  ...
  public void testInit() {
    ...
    assertThat(
        ddfBrandingPlugin.getProductName(),
  ...
  public void testProductImage() throws IOException {
    ddfBrandingPlugin.init();
    assertThat(
        ddfBrandingPlugin.getBase64ProductImage(),
        is(
            equalTo(
                Base64.getEncoder()
                    .encodeToString(
                        IOUtils.toByteArray(
                            DdfBrandingPluginTest.class.getResourceAsStream(productImage))))));
  }
  ...
  public void testVendorImage() throws IOException {
    ddfBrandingPlugin.init();
    assertThat(
        ddfBrandingPlugin.getBase64VendorImage(),
        is(
            equalTo(
                Base64.getEncoder()
                    .encodeToString(
                        IOUtils.toByteArray(
                            DdfBrandingPluginTest.class.getResourceAsStream(vendorImage))))));
  }
  ...
  public void testFavIcon() throws IOException {
    ddfBrandingPlugin.init();
    assertThat(
        ddfBrandingPlugin.getBase64FavIcon(),
        is(
            equalTo(
                Base64.getEncoder()
                    .encodeToString(
                        IOUtils.toByteArray(
                            DdfBrandingPluginTest.class.getResourceAsStream(favIcon))))));
  }
}
