        ...
        is(
            equalTo(
                Base64.getEncoder()
                    .encodeToString(
                        IOUtils.toByteArray(
                            TestDdfBrandingPlugin.class.getResourceAsStream(productImage))))));
  }
        ...
        is(
            equalTo(
                Base64.getEncoder()
                    .encodeToString(
                        IOUtils.toByteArray(
                            TestDdfBrandingPlugin.class.getResourceAsStream(vendorImage))))));
  }
        ...
        is(
            equalTo(
                Base64.getEncoder()
                    .encodeToString(
                        IOUtils.toByteArray(
                            TestDdfBrandingPlugin.class.getResourceAsStream(favIcon))))));
  }
}
